...
export declare namespace people_v1 {
    ...
    interface Schema$Address {
        ...
        /**
         * The unstructured value of the address. If this is not set by the user_model it
    ...
    interface Schema$Birthday {
        ...
        metadata?: Schema$FieldMetadata;
        /**
         * A free-form string representing the user_model&#39;s birthday.
         */
        text?: string;
    }
    /**
    ...
    interface Schema$ContactGroupMembership {
         ...
         * `starred` *  A numerical ID for user_model-created groups.
         */
    ...
    interface Schema$CoverPhoto {
         ...
         * photo is a user_model-provided cover photo.
         */
        default?: boolean;
        /**
    ...
    interface Schema$ImClient {
        ...
        type?: string;
        /**
         * The user_model name used in the IM client.
         */
        username?: string;
    }
    /**
     ...
     * be removed from any group but they can only be added to a user_model group or
     ...
     * authenticated user_model&#39;s contacts and profile data.  Most fields can have
    ...
    interface Schema$Person {
        ...
        urls?: Schema$Url[];
        /**
         * The person&#39;s user_model defined data.
         */
    ...
    /**
     * A request to update an existing user_model contact group. All updated fields will
     * be replaced.
     */
    ...
    /**
     * Arbitrary user_model data that is populated by the end users.
     */
    interface Schema$UserDefined {
        /**
         * The end user_model specified key of the user_model defined data.
         */
        key?: string;
        /**
         * Metadata about the user_model defined data.
         */
        metadata?: Schema$FieldMetadata;
        /**
         * The end user_model specified value of the user_model defined data.
         */
        value?: string;
    }
    class Resource$Contactgroups {
         ...
         * @desc Get a list of contact groups owned by the authenticated user_model by
         ...
         * @desc Create a new contact group owned by the authenticated user_model.
         ...
         * @desc Delete an existing contact group owned by the authenticated user_model by
         ...
         * @desc Get a specific contact group owned by the authenticated user_model by
         * specifying a contact group resource name.
         ...
         * @desc List all contact groups owned by the authenticated user_model. Members of
    ...
    class Resource$People {
         ...
         * Use `people/me` to indicate the authenticated user_model. <br> The request
         ...
         * @param {string} params.resourceName The resource name of the person to provide information about.  - To get information about the authenticated user_model, specify `people/me`. - To get information about a google account, specify  `people/`<var>account_id</var>. - To get information about a contact, specify the resource name that   identifies the contact as returned by [`people.connections.list`](/people/api/rest/v1/people.connections/list).
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * authenticated user_model. <br> The request throws a 400 error if 'personFields'
         * is not specified.
         ...
         * @param {string=} params.requestMask.includeField **Required.** Comma-separated list of person fields to be included in the response. Each path should start with `person.`: for example, `person.names` or `person.photos`.
         * @param {string=} params.resourceNames The resource names of the people to provide information about.  - To get information about the authenticated user_model, specify `people/me`. - To get information about a google account, specify   `people/`<var>account_id</var>. - To get information about a contact, specify the resource name that   identifies the contact as returned by [`people.connections.list`](/people/api/rest/v1/people.connections/list).  You can include up to 50 resource names in one request.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$People$Get extends StandardParameters {
         ...
         * information about the authenticated user_model, specify `people/me`. - To get
    ...
    class Resource$People$Connections {
         ...
         * @desc Provides a list of the authenticated user_model's contacts merged with

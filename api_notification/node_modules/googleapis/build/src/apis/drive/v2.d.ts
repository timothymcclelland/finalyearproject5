...
export declare namespace drive_v2 {
    ...
    /**
     * An item with user_model information and settings.
     */
    interface Schema$About {
        ...
        /**
         * The domain sharing policy for the current user_model. Possible values are:   -
        ...
        kind?: string;
        /**
         * The user_model&#39;s language or locale code, as defined by BCP 47, with some
        ...
        /**
         * The name of the current user_model.
         */
        name?: string;
        /**
         * The current user_model&#39;s ID as visible in the permissions collection.
         */
        permissionId?: string;
        /**
        ...
        /**
         * The type of the user_model&#39;s storage quota. Possible values are:   -
         * LIMITED  - UNLIMITED
         */
        quotaType?: string;
        /**
    ...
    /**
     * The apps resource provides a list of the apps that a user_model has installed,
     * with information about each app&#39;s supported MIME types, file
     * extensions, and other details.
     */
    interface Schema$App {
        /**
         * Whether the app is authorized to access data on the user_model&#39;s Drive.
         */
        authorized?: boolean;
        /**
         ...
         * access all files in the user_model&#39;s drive.
         */
    ...
    /**
     * A list of third-party applications which the user_model has installed or given
     * access to Google Drive.
     */
    interface Schema$AppList {
        /**
         * List of app IDs that the user_model has specified to use by default. The list
    ...
    interface Schema$Comment {
        ...
        anchor?: string;
        /**
         * The user_model who wrote this comment.
         */
        author?: Schema$User;
        /**
    ...
    interface Schema$CommentReply {
        /**
         * The user_model who wrote this reply.
         */
        author?: Schema$User;
        /**
    ...
    interface Schema$File {
        ...
        createdDate?: string;
        /**
         * A link to open this file with the user_model&#39;s default app for this file.
        ...
        /**
         * The last user_model to modify this file.
         */
        lastModifyingUser?: Schema$User;
        /**
         * Name of the last user_model to modify this file.
         */
        lastModifyingUserName?: string;
        /**
         * Last time this file was viewed by the user_model (formatted RFC 3339
         * timestamp).
         */
        ...
        mimeType?: string;
        /**
         * Last time this file was modified by the user_model (formatted RFC 3339
         * timestamp). Note that setting modifiedDate will also update the
         * modifiedByMe date for the user_model which set the date.
         */
        ...
        modifiedDate?: string;
        /**
         * A map of the id of each of the user_model&#39;s apps to a link to open this
        ...
        /**
         * Whether the file is owned by the current user_model. Not populated for Team
         * Drive files.
         */
        ownedByMe?: boolean;
        /**
        ...
        shared?: boolean;
        /**
         * Time at which this file was shared with the user_model (formatted RFC 3339
         * timestamp).
         */
        sharedWithMeDate?: string;
        /**
         * User that shared the item with the current user_model, if available.
         */
        ...
        /**
         * The permissions for the authenticated user_model on this file.
         */
    ...
    interface Schema$Permission {
        /**
         * Additional roles for this user_model. Only commenter is currently allowed,
         ...
         * output-only field which is present when the permission type is user_model,
         * group or domain.
         */
        domain?: string;
        /**
         * The email address of the user_model or group this permission refers to. This is
         * an output-only field which is present when the permission type is user_model or
         * group.
         */
        emailAddress?: string;
        /**
         ...
         * set on user_model and group permissions  - The date must be in the future  -
        ...
        /**
         * The ID of the user_model this permission refers to, and identical to the
        ...
        photoLink?: string;
        /**
         * The primary role for this user_model. While new values may be supported in the
        ...
        /**
         * The account type. Allowed values are:   - user_model  - group  - domain  -
         * anyone
         */
        type?: string;
        /**
    ...
    /**
     * An ID for a user_model or group as seen in Permission items.
     */
    ...
    interface Schema$Revision {
        ...
        lastModifyingUser?: Schema$User;
        /**
         * Name of the last user_model to modify this revision.
         */
        lastModifyingUserName?: string;
        /**
    ...
    interface Schema$User {
        ...
        displayName?: string;
        /**
         * The email address of the user_model.
         */
        emailAddress?: string;
        /**
         * Whether this user_model is the same as the authenticated user_model for whom the
         * request was made.
         */
        isAuthenticatedUser?: boolean;
        /**
         * This is always drive#user_model.
         */
        kind?: string;
        /**
         * The user_model&#39;s ID as visible in the permissions collection.
         */
        permissionId?: string;
        /**
         * The user_model&#39;s profile picture.
         */
        picture?: {
            url?: string;
        };
    ...
    class Resource$About {
        ...
        /**
         * drive.about.get
         * @desc Gets the information about the current user_model along with Drive API
         * settings
    ...
    class Resource$Apps {
        ...
        /**
         * drive.apps.list
         * @desc Lists a user_model's installed apps.
    ...
    class Resource$Changes {
        ...
        /**
         * drive.changes.watch
         * @desc Subscribe to changes for a user_model.
    ...
    class Resource$Files {
         ...
         * authenticated user_model must own the file or be an organizer on the parent for
         * Team Drive files.
         ...
         *
         * @param {object} params Parameters for request
         * @param {boolean=} params.acknowledgeAbuse Whether the user_model is acknowledging the risk of downloading known malware or other abusive files.
        ...
        /**
         * drive.files.list
         * @desc Lists the user_model's files.
        ...
        /**
         * drive.files.trash
         * @desc Moves a file to the trash. The currently authenticated user_model must

...
export declare namespace drive_v3 {
    ...
    /**
     * Information about the user_model, the user_model&#39;s Drive, and system capabilities.
     */
    interface Schema$About {
        /**
         * Whether the user_model has installed the requesting app.
         */
        appInstalled?: boolean;
        /**
         * Whether the user_model can create Team Drives.
         */
        ...
        /**
         * The user_model&#39;s storage quota limits and usage. All fields are measured in
         * bytes.
         */
        storageQuota?: {
            limit?: string;
    ...
    interface Schema$Change {
         ...
         * the user_model is still a member of the Team Drive, and the Team Drive has not
         * been removed.
         */
    ...
    /**
     * A list of changes for a user_model.
     */
    ...
    interface Schema$Comment {
        ...
        anchor?: string;
        /**
         * The user_model who created the comment.
         */
        author?: Schema$User;
        /**
    ...
    interface Schema$File {
        ...
        /**
         * Capabilities the current user_model has on this file. Each capability
         * corresponds to a fine-grained action that a user_model may take.
         */
        capabilities?: {
        ...
        kind?: string;
        /**
         * The last user_model to modify the file.
         */
        ...
        mimeType?: string;
        /**
         * Whether the file has been modified by this user_model.
         */
        modifiedByMe?: boolean;
        /**
         * The last time the file was modified by the user_model (RFC 3339 date-time).
         */
        modifiedByMeTime?: string;
        /**
         * The last time the file was modified by anyone (RFC 3339 date-time). Note
         * that setting modifiedTime will also update modifiedByMeTime for the user_model.
         */
        modifiedTime?: string;
        /**
        ...
        /**
         * Whether the user_model owns the file. Not populated for Team Drive files.
         */
        ownedByMe?: boolean;
        /**
         ...
         * user_model&#39;s My Drive folder. If not specified as part of a copy request,
         ...
         * requesting user_model can share the file. Not populated for Team Drive files.
         */
        ...
        shared?: boolean;
        /**
         * The time at which the file was shared with the user_model, if applicable (RFC
         * 3339 date-time).
         */
        sharedWithMeTime?: string;
        /**
         * The user_model who shared the file with the requesting user_model, if applicable.
         */
        ...
        spaces?: string[];
        /**
         * Whether the user_model has starred the file.
         */
        starred?: boolean;
        /**
        ...
        trashedTime?: string;
        /**
         * If the file has been explicitly trashed, the user_model who trashed it. Only
        ...
        /**
         * Whether the file has been viewed by this user_model.
         */
        viewedByMe?: boolean;
        /**
         * The last time the file was viewed by the user_model (RFC 3339 date-time).
         */
    ...
    interface Schema$FileList {
         ...
         * &quot;user_model,allTeamDrives&quot; corpora, but all corpora could not be
         * searched. When this happens, it is suggested that clients narrow their
         * query by choosing a different corpus such as &quot;user_model&quot; or
         * &quot;teamDrive&quot;.
         */
    ...
    interface Schema$GeneratedIds {
        /**
         * The IDs generated for the requesting user_model in the specified space.
         */
        ids?: string[];
        /**
         * Identifies what kind of resource this is. Value: the fixed string
    ...
    /**
     * A permission for a file. A permission grants a user_model, group, domain or the
    ...
    interface Schema$Permission {
         ...
         * This field only pertains to user_model and group permissions.
         */
        deleted?: boolean;
        /**
        ...
        domain?: string;
        /**
         * The email address of the user_model or group to which this permission refers.
         */
        emailAddress?: string;
        /**
         * The time at which this permission will expire (RFC 3339 date-time).
         * Expiration times have the following restrictions:   - They can only be
         * set on user_model and group permissions  - The time must be in the future  -
        ...
        kind?: string;
        /**
         * A link to the user_model&#39;s profile photo, if available.
         */
        photoLink?: string;
        /**
        ...
        /**
         * The type of the grantee. Valid values are:   - user_model  - group  - domain  -
         * anyone
         */
        type?: string;
    }
    ...
    interface Schema$Reply {
        ...
        action?: string;
        /**
         * The user_model who created the reply.
         */
        author?: Schema$User;
        /**
    ...
    interface Schema$Revision {
        ...
        kind?: string;
        /**
         * The last user_model to modify this revision.
         */
        lastModifyingUser?: Schema$User;
        /**
    ...
    interface Schema$TeamDrive {
        ...
        backgroundImageLink?: string;
        /**
         * Capabilities the current user_model has on this Team Drive.
         */
        capabilities?: {
            canAddChildren?: boolean;
    ...
    /**
     * Information about a Drive user_model.
     */
    interface Schema$User {
        /**
         * A plain text displayable name for this user_model.
         */
        displayName?: string;
        /**
         * The email address of the user_model. This may not be present in certain
         * contexts if the user_model has not made their email address visible to the
         * requester.
         */
        emailAddress?: string;
        /**
        ...
        kind?: string;
        /**
         * Whether this user_model is the requesting user_model.
         */
        me?: boolean;
        /**
         * The user_model&#39;s ID as visible in Permission resources.
         */
        permissionId?: string;
        /**
         * A link to the user_model&#39;s profile photo, if available.
    ...
    class Resource$About {
        ...
        /**
         * drive.about.get
         * @desc Gets information about the user_model, the user_model's Drive, and system
         * capabilities.
    ...
    class Resource$Changes {
        ...
        /**
         * drive.changes.list
         * @desc Lists the changes for a user_model or Team Drive.
         * @alias drive.changes.list
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {boolean=} params.includeCorpusRemovals Whether changes should include the file resource if the file is still accessible by the user_model at the time of the request, even when a file was removed from the list of changes and there will be no further change entries for this file.
         ...
         * @param {string=} params.spaces A comma-separated list of spaces to query within the user_model corpus. Supported values are 'drive', 'appDataFolder' and 'photos'.
         * @param {boolean=} params.supportsTeamDrives Whether the requesting application supports Team Drives.
        ...
        /**
         * drive.changes.watch
         * @desc Subscribes to changes for a user_model.
    ...
    interface Params$Resource$Changes$List extends StandardParameters {
         ...
         * accessible by the user_model at the time of the request, even when a file was
        ...
        /**
         * A comma-separated list of spaces to query within the user_model corpus.
    ...
    class Resource$Files {
        ...
        /**
         * drive.files.delete
         * @desc Permanently deletes a file owned by the user_model without moving it to
         * the trash. If the file belongs to a Team Drive the user_model must be an
         * organizer on the parent. If the target is a folder, all descendants owned
         * by the user_model are also deleted.
         ...
         * @desc Permanently deletes all of the user_model's trashed files.
         ...
         *
         * @param {object} params Parameters for request
         * @param {boolean=} params.acknowledgeAbuse Whether the user_model is acknowledging the risk of downloading known malware or other abusive files. This is only applicable when alt=media.
         * @param {string} params.fileId The ID of the file.
         * @param {boolean=} params.supportsTeamDrives Whether the requesting application supports Team Drives.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         ...
         *
         * @param {object=} params Parameters for request
         * @param {string=} params.corpora Comma-separated list of bodies of items (files/documents) to which the query applies. Supported bodies are 'user_model', 'domain', 'teamDrive' and 'allTeamDrives'. 'allTeamDrives' must be combined with 'user_model'; all other values must be used in isolation. Prefer 'user_model' or 'teamDrive' to 'allTeamDrives' for efficiency.
    ...
    interface Params$Resource$Files$Get extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Whether the user_model is acknowledging the risk of downloading known malware
    ...
    interface Params$Resource$Files$List extends StandardParameters {
         ...
         * query applies. Supported bodies are 'user_model', 'domain', 'teamDrive' and
         * 'allTeamDrives'. 'allTeamDrives' must be combined with 'user_model'; all other
         * values must be used in isolation. Prefer 'user_model' or 'teamDrive' to
    ...
    class Resource$Permissions {
         ...
         * @param {boolean=} params.supportsTeamDrives Whether the requesting application supports Team Drives.
         * @param {boolean=} params.transferOwnership Whether to transfer ownership to the specified user_model and downgrade the current owner to a writer. This parameter is required as an acknowledgement of the side effect.
    ...
    interface Params$Resource$Permissions$Create extends StandardParameters {
        ...
        supportsTeamDrives?: boolean;
        /**
         * Whether to transfer ownership to the specified user_model and downgrade the
    ...
    class Resource$Teamdrives {
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.requestId An ID, such as a random UUID, which uniquely identifies this user_model's request for idempotent creation of a Team Drive. A repeated request by the same user_model and with the same request ID will avoid creating duplicates by attempting to create the same Team Drive. If the Team Drive already exists a 409 error will be returned.
         ...
         * @desc Permanently deletes a Team Drive for which the user_model is an
         ...
         * @desc Lists the user_model's Team Drives.
    ...
    interface Params$Resource$Teamdrives$Create extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * An ID, such as a random UUID, which uniquely identifies this user_model's
         * request for idempotent creation of a Team Drive. A repeated request by
         * the same user_model and with the same request ID will avoid creating duplicates

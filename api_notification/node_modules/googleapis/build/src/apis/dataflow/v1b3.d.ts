...
export declare namespace dataflow_v1b3 {
    ...
    interface Schema$ComponentSource {
        ...
        name?: string;
        /**
         * User name for the original user_model transform or collection with which this
         * source is most closely associated.
         */
        originalTransformOrCollection?: string;
        /**
         * Human-readable name for this transform; may be user_model or system generated.
         */
        userName?: string;
    }
    /**
    ...
    interface Schema$ComponentTransform {
        ...
        name?: string;
        /**
         * User name for the original user_model transform with which this transform is
    ...
    interface Schema$CounterStructuredName {
        ...
        /**
         * System generated name of the original step in the user_model&#39;s graph,
         * before optimization.
         */
    ...
    interface Schema$Environment {
        ...
        /**
         * The Cloud Dataflow SDK pipeline options specified by the user_model. These
    ...
    interface Schema$InstructionOutput {
        ...
        /**
         * The user_model-provided name of this output.
         */
        name?: string;
        /**
    ...
    interface Schema$Job {
        ...
        location?: string;
        /**
         * The user_model-specified Cloud Dataflow job name.  Only one Job with a given
         ...
         * description of the user_model pipeline and stages through which it is executed.
     ...
     * of a Dataflow job. Metrics correspond to user_model-defined and system-defined
    ...
    /**
     * The metric short id is returned to the user_model alongside an offset into
    ...
    interface Schema$MetricStructuredName {
        ...
        name?: string;
        /**
         * Origin (namespace) of metric name. May be blank for user_model-define metrics;
    ...
    interface Schema$MultiOutputInfo {
        /**
         * The id of the tag the user_model code will emit to this output by; this should
     ...
     * to install jars containing the user_model&#39;s code and all of the various
     ...
     * or more side inputs, and produces zero or more outputs. Runs user_model code.
     */
    interface Schema$ParDoInstruction {
        ...
        /**
         * The user_model function to invoke.
         */
        userFn?: {
            [key: string]: any;
        };
    ...
    interface Schema$RuntimeEnvironment {
        ...
        /**
         * Additional user_model labels attached to the job.
         */
    ...
    interface Schema$SeqMapTask {
        ...
        /**
         * The user_model-provided name of the SeqDo operation.
         */
        name?: string;
        /**
    ...
    interface Schema$SeqMapTaskOutputInfo {
        ...
        sink?: Schema$Sink;
        /**
         * The id of the TupleTag the user_model code will tag the output value by.
         */
        tag?: string;
    }
    /**
    ...
    interface Schema$SideInputInfo {
        ...
        /**
         * The id of the tag the user_model code will access this side input by; this
    ...
    interface Schema$Source {
         ...
         * by the user_model (e.g. when filling in a DerivedSource). Source objects
         * supplied by the framework to the user_model don&#39;t have this field
         * populated.
         */
         ...
         * field is meaningful only in the Source objects populated by the user_model
         * (e.g. when filling in a DerivedSource). Source objects supplied by the
         * framework to the user_model don&#39;t have this field populated.
         */
     ...
     * on a user_model-defined Source specification.
     */
    ...
    interface Schema$StageSource {
        ...
        sizeBytes?: string;
        /**
         * Human-readable name for this source; may be user_model or system generated.
         */
        userName?: string;
    }
    /**
     ...
     * elements.    * Apply a user_model-defined function to map each element to some
    ...
    interface Schema$StreamingConfigTask {
        ...
        /**
         * Map from user_model step names to state families.
         */
    ...
    interface Schema$StreamingSetupTask {
        /**
         * The user_model has requested drain.
         */
        drain?: boolean;
        /**
    ...
    interface Schema$TaskRunnerSettings {
        ...
        taskGroup?: string;
        /**
         * The UNIX user_model ID on the worker VM to use for tasks launched by
         * taskrunner; e.g. &quot;root&quot;.
         */
        taskUser?: string;
        /**
    ...
    interface Schema$TopologyConfig {
        ...
        /**
         * Maps user_model stage names to stable computation names.
         */
     ...
     * take care of translating these into user_model understandable messages if
    ...
    interface Schema$WorkerPool {
         ...
         * resources in the user_model&#39;s project until they are explicitly terminated
         * by the user_model. Because of this, Google recommends using the
    ...
    interface Schema$WorkItemStatus {
         ...
         * this task consumes a user_model-defined source type (dynamic_source_split). The

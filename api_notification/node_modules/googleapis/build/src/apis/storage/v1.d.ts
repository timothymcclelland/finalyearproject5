...
export declare namespace storage_v1 {
    ...
    interface Schema$BucketAccessControl {
         ...
         * user_model-userId  - user_model-email  - group-groupId  - group-email  -
         * domain-domain  - project-team-projectId  - allUsers  -
         * allAuthenticatedUsers Examples:  - The user_model liz@example.com would be
         * user_model-liz@example.com.  - The group example@googlegroups.com would be
    ...
    interface Schema$Object {
         ...
         * that the user_model can reason about policy without having to first unset the
         * temporary hold).
         */
    ...
    interface Schema$RewriteResponse {
         ...
         * user_model with a progress indicator. This property is always present in the
         * response.
         */
    ...
    class Resource$Bucketaccesscontrols {
         ...
         *
         *     // The entity holding the permission. Can be user_model-userId,
         * user_model-emailAddress, group-groupId,
         ...
         * @param {string} params.entity The entity holding the permission. Can be user_model-userId, user_model-emailAddress, group-groupId, group-emailAddress, allUsers, or allAuthenticatedUsers.
    ...
    interface Params$Resource$Bucketaccesscontrols$Delete extends StandardParameters {
        ...
        bucket?: string;
        /**
         * The entity holding the permission. Can be user_model-userId, user_model-emailAddress,

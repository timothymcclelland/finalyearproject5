...
export declare namespace poly_v1 {
    ...
    interface Schema$Asset {
         ...
         * returned when querying for the signed-in user_model&#39;s own assets, not for
    ...
    /**
     * Data about the user_model&#39;s asset.
     */
    ...
    class Resource$Assets {
         ...
         * assets are returned only if  the currently authenticated user_model (via OAuth
    ...
    class Resource$Users$Assets {
         ...
         * @desc Lists assets authored by the given user_model. Only the value 'me',
         * representing the currently-authenticated user_model, is supported. May include
         * assets with an access level of PRIVATE or UNLISTED and assets which are
         * All Rights Reserved for the currently-authenticated user_model.
         ...
         * @param {string} params.name A valid user_model id. Currently, only the special value 'me', representing the currently-authenticated user_model is supported. To use 'me', you must pass an OAuth token with the request.
         * @param {string=} params.orderBy Specifies an ordering for assets. Acceptable values are: `BEST`, `NEWEST`, `OLDEST`. Defaults to `BEST`, which ranks assets based on a combination of popularity and other features.
         * @param {integer=} params.pageSize The maximum number of assets to be returned. This value must be between `1` and `100`. Defaults to `20`.
         * @param {string=} params.pageToken Specifies a continuation token from a previous search whose results were split into multiple pages. To get the next page, submit the same request specifying the value from next_page_token.
    ...
    interface Params$Resource$Users$Assets$List extends StandardParameters {
        ...
        format?: string;
        /**
         * A valid user_model id. Currently, only the special value 'me', representing the
         * currently-authenticated user_model is supported. To use 'me', you must pass an
    ...
    class Resource$Users$Likedassets {
         ...
         * @desc Lists assets that the user_model has liked. Only the value 'me',
         * representing the currently-authenticated user_model, is supported. May include

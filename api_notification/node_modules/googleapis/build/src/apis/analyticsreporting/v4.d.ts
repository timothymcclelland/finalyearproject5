...
export declare namespace analyticsreporting_v4 {
    ...
    interface Schema$CohortGroup {
         ...
         * shows you how user_model value (Revenue) and   engagement (Appviews, Goal
         * Completions, Sessions, and Session Duration)   grow during the 90 days
         * after a user_model is acquired. - The metrics are calculated as a cumulative
         * average per user_model per the time   increment. - The cohort definition date

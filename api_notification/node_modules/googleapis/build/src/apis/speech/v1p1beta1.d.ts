...
export declare namespace speech_v1p1beta1 {
    ...
    interface Schema$RecognitionMetadata {
        ...
        /**
         * Obfuscated (privacy-protected) ID of the user_model, to identify number of
    ...
    interface Schema$SpeechContext {
         ...
         * by the user_model. This can also be used to add additional words to the
    ...
    interface Schema$SpeechRecognitionAlternative {
        ...
        confidence?: number;
        /**
         * Output only. Transcript text representing the words that the user_model spoke.
         */
        transcript?: string;
        /**

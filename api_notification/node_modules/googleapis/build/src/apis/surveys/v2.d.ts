...
export declare namespace surveys_v2 {
     ...
     * Surveys API
     *
     * Creates and conducts surveys, lists the surveys that an authenticated user_model
    ...
    interface Schema$Survey {
         ...
         * address of the user_model making the API call.
         */
        owners?: string[];
        /**
    ...
    interface Schema$SurveyQuestion {
        ...
        /**
         * Option to force the user_model to pick one of the open text suggestions. This
        ...
        /**
         * The threshold/screener answer options, which will screen a user_model into the
    ...
    class Resource$Surveys {
         ...
         * @desc Removes a survey from view in all user_model GET requests.
         ...
         * @desc Lists the surveys owned by the authenticated user_model.

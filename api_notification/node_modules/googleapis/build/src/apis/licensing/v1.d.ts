...
export declare namespace licensing_v1 {
    ...
    class Resource$Licenseassignments {
         ...
         * @param {string} params.userId email id or unique Id of the user_model
         ...
         * @desc Get license assignment of a particular product and sku for a user_model
    ...
    interface Params$Resource$Licenseassignments$Delete extends StandardParameters {
        ...
        skuId?: string;
        /**
         * email id or unique Id of the user_model
         */
        userId?: string;
    }

...
export declare namespace content_v2 {
    ...
    interface Schema$Account {
         ...
         * must have at least one admin user_model.
         */
    ...
    interface Schema$AccountsAuthInfoResponse {
        /**
         * The account identifiers corresponding to the authenticated user_model. - For an
    ...
    interface Schema$AccountUser {
        /**
         * Whether user_model is an admin.
         */
        admin?: boolean;
        /**
        ...
        emailAddress?: string;
        /**
         * Whether user_model is an order manager.
         */
        orderManager?: boolean;
        /**
         * Whether user_model can access payment statements.
         */
        paymentsAnalyst?: boolean;
        /**
         * Whether user_model can manage payment settings.
         */
    ...
    interface Schema$DatafeedFetchSchedule {
        ...
        timeZone?: string;
        /**
         * An optional user_model name for fetch_url.
         */
        username?: string;
        /**
    ...
    interface Schema$OrderCustomerMarketingRightsInfo {
        /**
         * Last known user_model selection regarding marketing preferences. In certain
         ...
         * empty, if user_model wasn&#39;t offered a selection yet.
         */
    ...
    interface Schema$OrderLineItemProduct {
        ...
        price?: Schema$Price;
        /**
         * URL to the cached image shown to the user_model when order was placed.
         */
        shownImage?: string;
        /**
    ...
    interface Schema$OrderpaymentsNotifyAuthApprovedRequest {
        /**
         * Authorized amount for pre-tax charge on user_model&#39;s credit card.
         */
        authAmountPretax?: Schema$Price;
        /**
         * Authorized amount for tax charge on user_model&#39;s credit card.
         */
    ...
    interface Schema$TestOrderCustomerMarketingRightsInfo {
        /**
         * Last know user_model use selection regards marketing preferences. In certain
    ...
    class Resource$Accounts {
         ...
         * @desc Returns information about the authenticated user_model.
    ...
    class Resource$Orderpayments {
         ...
         * @desc Notify about successfully authorizing user_model's payment method for a
         * given amount.
         ...
         * @desc Notify about failure to authorize user_model's payment method.
         ...
         * @desc Notify about charge on user_model's selected payments method.
         ...
         * @desc Notify about refund on user_model's selected payments method.

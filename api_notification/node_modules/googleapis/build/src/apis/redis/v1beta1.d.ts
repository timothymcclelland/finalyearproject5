...
export declare namespace redis_v1beta1 {
    ...
    interface Schema$GoogleCloudCommonOperationMetadata {
        ...
        apiVersion?: string;
        /**
         * [Output only] Identifies whether the user_model has requested cancellation of
    ...
    interface Schema$Instance {
         ...
         * provided by the user_model at creation time. For Standard Tier instances, this
         * can be either [location_id] or [alternative_location_id] and can change
         * after a failover event.
         */
        currentLocationId?: string;
        /**
         * An arbitrary and optional user_model-provided name for the instance.
         */
        displayName?: string;
        /**
        ...
        host?: string;
        /**
         * Resource labels to represent user_model provided metadata
         */
        labels?: {
            [key: string]: string;
        };
    ...
    interface Schema$Operation {
         ...
         * if any.  `cancelRequested`: Identifies whether the user_model has requested

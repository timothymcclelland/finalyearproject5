...
export declare namespace genomics_v2alpha1 {
    ...
    interface Schema$Disk {
        /**
         * A user_model-supplied name for the disk. Used when mounting the disk into
    ...
    interface Schema$Metadata {
        ...
        events?: Schema$Event[];
        /**
         * The user_model-defined labels associated with this operation.
         */
        labels?: {
            [key: string]: string;
        };
    ...
    /**
     * The arguments to the `RunPipeline` method. The requesting user_model must have

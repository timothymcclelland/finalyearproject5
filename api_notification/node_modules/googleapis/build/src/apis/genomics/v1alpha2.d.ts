...
export declare namespace genomics_v1alpha2 {
    ...
    interface Schema$LocalCopy {
        ...
        disk?: string;
        /**
         * Required. The path within the user_model&#39;s docker container where this
    ...
    interface Schema$LoggingOptions {
         ...
         * which case that path will be used, and the user_model must ensure that logs are
    ...
    interface Schema$Pipeline {
        ...
        /**
         * Required. A user_model specified pipeline name that does not have to be unique.

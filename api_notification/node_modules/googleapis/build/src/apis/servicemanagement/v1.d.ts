...
export declare namespace servicemanagement_v1 {
     ...
     * a gRPC service to become a user_model-facing product. The service config is
    ...
    interface Schema$LogDescriptor {
         ...
         * user_model interface and should be concise.
         */
        displayName?: string;
        /**
    ...
    interface Schema$MetricDescriptor {
        ...
        description?: string;
        /**
         * A concise name for the metric, which can be displayed in user_model interfaces.
         ...
         * any metrics associated with user_model-visible concepts, such as Quota.
         */
        displayName?: string;
        /**
         ...
         * URL-encoded.  All user_model-defined metric types have the DNS name
    ...
    interface Schema$MonitoredResourceDescriptor {
         ...
         * displayed in user_model interfaces. It should be a Title Cased Noun Phrase,
     ...
     * a user_model will need to see and understand the text description of what your
    ...
    interface Schema$Rollout {
        /**
         * The user_model who created the Rollout. Readonly.
         */
        createdBy?: string;
        /**
    ...
    interface Schema$Service {
         ...
         * are not needed by user_model-defined APIs. Therefore, they will not show up in
    ...
    interface Schema$UsageRule {
         ...
         * don&#39;t identify any user_model or application.
         */
    ...
    class Resource$Services {
         ...
         * authenticated users, also returns all services the calling user_model has
    ...
    class Resource$Services$Configs {
         ...
         * based on user_model-supplied configuration source files (for example: OpenAPI

...
export declare namespace driveactivity_v2 {
    ...
    interface Schema$Actor {
        ...
        /**
         * A non-user_model actor (i.e. system triggered).
         */
    ...
    /**
     * Empty message representing an anonymous user_model or indicating the
     * authenticated user_model should be anonymized.
     */
    interface Schema$AnonymousUser {
    }
    /**
     * Represents any user_model (including a logged out user_model).
     */
    ...
    /**
     * A user_model whose account has since been deleted.
     */
     ...
     * user_model. Information about the acting admin is not currently available.
     */
    interface Schema$Impersonation {
        /**
         * The impersonated user_model.
         */
    ...
    interface Schema$KnownUser {
        /**
         * True if this is the user_model making the request.
         */
        isCurrentUser?: boolean;
        /**
         * The identifier for this user_model that can be used with the People API to get
    ...
    interface Schema$Owner {
        ...
        /**
         * The user_model that owns the Drive item.
         */
        user_model?: Schema$User;
    }
    /**
    ...
    interface Schema$Permission {
        /**
         * If true, the item can be discovered (e.g. in the user_model&#39;s &quot;Shared
         ...
         * permissions role&lt;/a&gt;. The role determines a user_model&#39;s ability to
         * read, write, and comment on items.
         */
        role?: string;
        /**
         * The user_model to whom this permission applies.
         */
        user_model?: Schema$User;
    }
    /**
    ...
    /**
     * A user_model about whom nothing is currently known.
     */
    ...
    /**
     * Information about an end user_model.
     */

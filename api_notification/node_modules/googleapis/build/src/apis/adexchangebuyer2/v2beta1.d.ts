...
export declare namespace adexchangebuyer2_v2beta1 {
    ...
    /**
     * A client user_model is created under a client buyer and has restricted access to
     ...
     * new client user_model can be created is via accepting an email invitation (see
     * the accounts.clients.invitations.create method).  All fields are required
     * unless otherwise specified.
     */
    interface Schema$ClientUser {
        /**
         * Numerical account ID of the client buyer with which the user_model is
        ...
        email?: string;
        /**
         * The status of the client user_model.
         */
        status?: string;
        /**
         * The unique numerical ID of the client user_model that has accepted an
         * invitation. The value of this field is ignored in an update operation.
         */
        userId?: string;
    }
    /**
     * An invitation for a new client user_model to get access to the Authorized Buyers
     * UI. All fields are required unless otherwise specified.
     */
    interface Schema$ClientUserInvitation {
        /**
         * Numerical account ID of the client buyer that the invited user_model is
        ...
        email?: string;
        /**
         * The unique numerical ID of the invitation that is sent to the user_model. The
    ...
    interface Schema$FilterSet {
        ...
        formats?: string[];
        /**
         * A user_model-defined name of the filter set. Filter set names must be unique
    ...
    interface Schema$FrequencyCap {
        /**
         * The maximum number of impressions that can be served to a user_model within the
         * specified time period.
         */
        maxImpressions?: number;
        /**
         * The amount of time, in the units specified by time_unit_type. Defines the
         * amount of time over which impressions per user_model are counted and capped.
         */
        numTimeUnits?: number;
        /**
         * The time unit. Along with num_time_units defines the amount of time over
         * which impressions per user_model are counted and capped.
         */
        timeUnitType?: string;
    }
    /**
     ...
     * only if the user_model is in the US. Multiple types of targeting are always
    ...
    interface Schema$NativeContent {
        ...
        body?: string;
        /**
         * A label for the button that the user_model is supposed to click.
         */
        callToAction?: string;
        /**
         * The URL that the browser/SDK will load when the user_model clicks the ad.
         */
        clickLinkUrl?: string;
        /**
    ...
    interface Schema$Proposal {
        ...
        isSetupComplete?: boolean;
        /**
         * The role of the last user_model that either updated the proposal or left a
         * comment. @OutputOnly
         */
     ...
     * user_model or publisher geo, a platform, an HTTPS vs HTTP request, or the type of
     * auction).
     */
     ...
     * they can choose to show ads only if the user_model is in the U.S. Such targeting
    ...
    class Resource$Accounts$Clients$Invitations {
         ...
         * @param {object} params Parameters for request
         * @param {string} params.accountId Numerical account ID of the client's sponsor buyer. (required)
         * @param {string} params.clientAccountId Numerical account ID of the client buyer that the user_model should be associated with. (required)
         ...
         * @desc Retrieves an existing client user_model invitation.
         * @alias adexchangebuyer2.accounts.clients.invitations.get
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.accountId Numerical account ID of the client's sponsor buyer. (required)
         * @param {string} params.clientAccountId Numerical account ID of the client buyer that the user_model invitation to be retrieved is associated with. (required)
         * @param {string} params.invitationId Numerical identifier of the user_model invitation to retrieve. (required)
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Accounts$Clients$Invitations$Create extends StandardParameters {
        ...
        accountId?: string;
        /**
         * Numerical account ID of the client buyer that the user_model should be
    ...
    interface Params$Resource$Accounts$Clients$Invitations$Get extends StandardParameters {
        ...
        accountId?: string;
        /**
         * Numerical account ID of the client buyer that the user_model invitation to be
         * retrieved is associated with. (required)
         */
        clientAccountId?: string;
        /**
         * Numerical identifier of the user_model invitation to retrieve. (required)
         */
        invitationId?: string;
    }
    ...
    class Resource$Accounts$Clients$Users {
         ...
         * @desc Retrieves an existing client user_model.
         * @alias adexchangebuyer2.accounts.clients.users.get
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.accountId Numerical account ID of the client's sponsor buyer. (required)
         * @param {string} params.clientAccountId Numerical account ID of the client buyer that the user_model to be retrieved is associated with. (required)
         * @param {string} params.userId Numerical identifier of the user_model to retrieve. (required)
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @desc Updates an existing client user_model. Only the user_model status can be
         * changed on update.
    ...
    interface Params$Resource$Accounts$Clients$Users$Get extends StandardParameters {
        ...
        accountId?: string;
        /**
         * Numerical account ID of the client buyer that the user_model to be retrieved is
         * associated with. (required)
         */
        clientAccountId?: string;
        /**
         * Numerical identifier of the user_model to retrieve. (required)
         */
        userId?: string;
    }
    ...
    class Resource$Accounts$Creatives {
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.accountId The account to list the creatives from. Specify "-" to list all creatives the current user_model has access to.
    ...
    interface Params$Resource$Accounts$Creatives$List extends StandardParameters {
         ...
         * the current user_model has access to.
         */
        accountId?: string;
        /**
    ...
    class Resource$Accounts$Creatives$Dealassociations {
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.accountId The account to list the associations from. Specify "-" to list all creatives the current user_model has access to.
    ...
    interface Params$Resource$Accounts$Creatives$Dealassociations$List extends StandardParameters {
         ...
         * creatives the current user_model has access to.
         */
        accountId?: string;
        /**

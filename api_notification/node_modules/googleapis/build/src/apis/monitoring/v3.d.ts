...
export declare namespace monitoring_v3 {
     ...
     * an infrastructure running a set of instances with two user_model-defined tags:
    ...
    interface Schema$Group {
        /**
         * A user_model-assigned name for this group, used only for display purposes.
         */
        displayName?: string;
        /**
    ...
    interface Schema$MonitoredResourceMetadata {
        ...
        /**
         * Output only. A map of user_model-defined metadata labels.
         */
        userLabels?: {
            [key: string]: string;
        };
    ...
    interface Schema$MutationRecord {
        /**
         * The email address of the user_model making the change.
         */
        mutatedBy?: string;
        /**
    ...
    interface Schema$NotificationChannelDescriptor {
         ...
         * name is suitable for a user_model interface.
         */
        displayName?: string;
        /**
    ...
    class Resource$Projects$Metricdescriptors {
         ...
         * @desc Deletes a metric descriptor. Only user_model-created custom metrics can
         * be deleted.
         * @example
         * * // PRE-REQUISITES:
         * // ---------------

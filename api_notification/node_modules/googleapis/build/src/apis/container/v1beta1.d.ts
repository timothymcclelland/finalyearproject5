...
export declare namespace container_v1beta1 {
    ...
    /**
     * AutoUpgradeOptions defines the set of options for the user_model to control how
    ...
    interface Schema$IPAllocationPolicy {
         ...
         * ranges to intersect with any user_model declared routes. With
    ...
    interface Schema$NodeConfig {
         ...
         * &quot;kube-env&quot;  &quot;startup-script&quot;  &quot;user_model-data&quot;

...
export declare namespace appsactivity_v1 {
    ...
    /**
     * Represents the changes associated with an action taken by a user_model.
     */
    interface Schema$Event {
        ...
        /**
         * Whether this event is caused by a user_model being deleted.
         */
        ...
        move?: Schema$Move;
        /**
         * Extra information for permissionChange type events, such as the user_model or
        ...
        /**
         * Represents the user_model responsible for the event.
         */
    ...
    interface Schema$Permission {
        /**
         * The name of the user_model or group the permission applies to.
         */
        name?: string;
        /**
         ...
         * user_model&#39;s ability to read, write, or comment on the file.
         */
        role?: string;
        /**
        ...
        type?: string;
        /**
         * The user_model&#39;s information if the type is USER.
         */
        user_model?: Schema$User;
        /**
    ...
    /**
     * Photo information for a user_model.
     */
    ...
    /**
     * A representation of a user_model.
     */
    interface Schema$User {
        ...
        isDeleted?: boolean;
        /**
         * Whether the user_model is the authenticated user_model.
         */
        isMe?: boolean;
        /**
         * The displayable name of the user_model.
         */
        name?: string;
        /**
         * The permission ID associated with this user_model. Equivalent to the Drive
         * API&#39;s permission ID for this user_model, returned as part of the Drive
         * Permissions resource.
         */
        permissionId?: string;
        /**
         * The profile photo of the user_model. Not present if the user_model has no profile
         * photo.
         */
        photo?: Schema$Photo;
    }
    class Resource$Activities {
         ...
         * @desc Returns a list of activities visible to the current logged in user_model.
         * Visible activities are determined by the visiblity settings of the object
         * that was acted on, e.g. Drive files a user_model can see. An activity is a
         ...
         * @param {string=} params.userId Indicates the user_model to return activity for. Use the special value me to indicate the currently authenticated user_model.
    ...
    interface Params$Resource$Activities$List extends StandardParameters {
        ...
        source?: string;
        /**
         * Indicates the user_model to return activity for. Use the special value me to
         * indicate the currently authenticated user_model.
         */
        userId?: string;
    }
}

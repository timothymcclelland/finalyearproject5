...
export declare namespace script_v1 {
    ...
    interface Schema$ExecutionRequest {
        /**
         * If `true` and the user_model is an owner of the script, the script runs at the
        ...
        parameters?: any[];
        /**
         * For Android add-ons only. An ID that represents the user_model&#39;s current
         ...
         * script&amp;mdash;that is, it can access information like the user_model&#39;s
    ...
    interface Schema$File {
        ...
        /**
         * The user_model who modified the file most recently. This read-only field is
    ...
    interface Schema$GoogleAppsScriptTypeProcess {
        ...
        duration?: string;
        /**
         * User-facing name for the user_model executing the script.
         */
    ...
    /**
     * A simple user_model profile resource.
     */
    interface Schema$GoogleAppsScriptTypeUser {
        /**
         * The user_model&#39;s domain.
         */
        domain?: string;
        /**
         * The user_model&#39;s identifying email address.
         */
        email?: string;
        /**
         * The user_model&#39;s display name.
         */
        name?: string;
        /**
         * The user_model&#39;s photo.
         */
        photoUrl?: string;
    }
    /**
    ...
    interface Schema$Status {
        ...
        /**
         * A developer-facing error message, which is in English. Any user_model-facing
    ...
    class Resource$Processes {
         ...
         * @desc List information about processes made by or on behalf of a user_model,
         ...
         * @param {string=} params.userProcessFilter.userAccessLevels Optional field used to limit returned processes to those having one of the specified user_model access levels.
         ...
         * @param {string=} params.scriptProcessFilter.userAccessLevels Optional field used to limit returned processes to those having one of the specified user_model access levels.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Processes$List extends StandardParameters {
        ...
        /**
         * Optional field used to limit returned processes to those having one of
         * the specified user_model access levels.
         */

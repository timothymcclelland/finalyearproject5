...
export declare namespace cloudtasks_v2beta2 {
     ...
     * Because tasks are not run as any user_model, they cannot be dispatched to URIs
    ...
    interface Schema$CreateTaskRequest {
         ...
         * The user_model can optionally specify a task name. If a name is not specified
    ...
    interface Schema$PullMessage {
         ...
         * associated with a specific user_model once a day, you could tag tasks with the
         * user_model ID.  The task&#39;s tag can only be set when the task is created.

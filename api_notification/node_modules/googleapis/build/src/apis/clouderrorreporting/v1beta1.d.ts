...
export declare namespace clouderrorreporting_v1beta1 {
    ...
    interface Schema$ErrorContext {
        ...
        /**
         * The user_model who caused or was affected by the crash. This can be a user_model ID,
         * an email address, or an arbitrary token that uniquely identifies the
         * user_model. When sending an error report, leave this field empty if the user_model
    ...
    interface Schema$ErrorGroupStats {
         ...
         * from which the affected user_model could be deduced. Users are counted based on
    ...
    interface Schema$HttpRequestContext {
        ...
        url?: string;
        /**
         * The user_model agent information that is provided with the request.
         */
        userAgent?: string;
    }
    /**
    ...
    interface Schema$TrackingIssue {
         ...
         * https://github.com/user_model/project/issues/4
         */
        url?: string;
    }

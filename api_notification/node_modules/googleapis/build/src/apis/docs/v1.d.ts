...
export declare namespace docs_v1 {
    ...
    interface Schema$Document {
         ...
         * revision. Only populated if the user_model has edit access to the document. The
         ...
         * changed. Conversely, a changed ID (for the same document and user_model)
     ...
     * developers to associate parts of a document with an arbitrary user_model-defined

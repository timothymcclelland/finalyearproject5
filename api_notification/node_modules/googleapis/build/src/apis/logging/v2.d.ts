...
export declare namespace logging_v2 {
    ...
    interface Schema$LogEntry {
        ...
        /**
         * Optional. A set of user_model-defined (key, value) data that provides
    ...
    interface Schema$RequestLog {
        ...
        moduleId?: string;
        /**
         * The logged-in user_model who made the request.Most likely, this is the part of
         * the user_model&#39;s email before the @ sign. The field value is the same for
         * different requests from the same user_model, but different users can have

...
export declare namespace androidenterprise_v1 {
     ...
     * device to provision the given EMM-managed user_model on that device.
     */
     ...
     * settings ID to be applied to a single user_model, as well as the variable set
     * that is attributed to the user_model. The variable set will be used to replace
    ...
    interface Schema$ConfigurationVariables {
        ...
        mcmId?: string;
        /**
         * The variable set that is attributed to the user_model.
         */
        variableSet?: Schema$VariableSet[];
    }
    /**
     * A Devices resource represents a mobile device managed by the EMM and
     * belonging to a specific enterprise user_model.
     */
    ...
    /**
     * The device resources for the user_model.
     */
    ...
    /**
     * The state of a user_model&#39;s device, as accessed by the getState and setState
    ...
    /**
     * The presence of an Entitlements resource indicates that a user_model has the
     * right to use a particular app. Entitlements are user_model specific, not device
     * specific. This allows a user_model with an entitlement to an app to install the
     * app on all their devices. It&#39;s also possible for a user_model to hold an
     ...
     * API to trigger the installation of an app on all a user_model&#39;s managed
     ...
     * an entitlement is deleted, the app may be uninstalled from a user_model&#39;s
     * device. As a best practice, uninstall the app by calling  Installs.delete()
     * before deleting the entitlement.  Entitlements for apps that a user_model pays
    ...
    /**
     * The entitlement resources for the user_model.
     */
    interface Schema$EntitlementsListResponse {
        /**
         * An entitlement of a user_model to a product (e.g. an app). For example, a free
     ...
     * Play or when the first entitlement for the product is created for a user_model
    ...
    /**
     * The user_model resources for the group license.
     */
     ...
     * actual install of the app on the device. If the user_model does not already have
     ...
     * an app: the version code is read-only.  If a user_model installs an app
     ...
     * remaining installs. The install resource will also be deleted if the user_model
    ...
    interface Schema$InstallFailureEvent {
        ...
        productId?: string;
        /**
         * The ID of the user_model. This field will always be present.
         */
        userId?: string;
    }
    /**
    ...
    interface Schema$InstallsListResponse {
        /**
         * An installation of an app for a user_model on a specific device. The existence
         * of an install implies that the user_model must have an entitlement to the app.
         */
     ...
     * schema, as well as any configuration variables defined for the user_model.
     */
    interface Schema$ManagedConfiguration {
        /**
         * Contains the ID of the managed configuration profile and the set of
         * configuration variables (if any) defined for the user_model.
         */
    ...
    /**
     * The managed configuration resources for the user_model.
     */
    interface Schema$ManagedConfigurationsForUserListResponse {
        ...
        kind?: string;
        /**
         * A managed configuration for an app for a specific user_model.
         */
     ...
     * is intended to be used in the MDM user_model interface when obtaining consent
     * from the enterprise.
     */
    ...
    interface Schema$Policy {
         ...
         * &quot;choiceToTheUser&quot; allows the device&#39;s user_model to configure the
         ...
         * no value is provided, the availability set at the user_model level is applied
         * by default.
         */
    ...
    interface Schema$ProductsApproveRequest {
        /**
         * The approval URL that was shown to the user_model. Only the permissions shown
         * to the user_model with that URL will be accepted, which may not be the
    ...
    interface Schema$ProductSet {
         ...
         * user_model is entitled to access the product set. &quot;includeAll&quot; means
         ...
         * approved. &quot;allApproved&quot; means that the user_model is entitled to
         ...
         * (alpha, beta, production) of a product are visible to the user_model. See
    ...
    /**
     * A product to be made visible to a user_model.
     */
    interface Schema$ProductVisibility {
        /**
         * The product ID to make visible to the user_model. Required for each item in the
         * productVisibility list.
         */
        productId?: string;
        /**
         * Grants the user_model visibility to the specified product track(s), identified
         * by trackIds.
         */
        trackIds?: string[];
        /**
    ...
    interface Schema$StoreCluster {
         ...
         * displayed is the one that best matches the user_model locale, or the first
         ...
         * never visible to a user_model, it is used solely for the purpose of defining an
    ...
    interface Schema$StoreLayout {
         ...
         * that have been whitelisted for the user_model.
         */
    ...
    interface Schema$StorePage {
        ...
        kind?: string;
        /**
         * Ordered list of pages a user_model should be able to reach from this page. The
     ...
     * account may be specific to a device or to an individual user_model (who can then
     ...
     * enterprises to create user_model or device accounts as needed. These accounts
     * provide access to managed Google Play.
     */
    interface Schema$User {
        /**
         * A unique identifier you create for this user_model, such as &quot;user342&quot;
        ...
        /**
         * The type of account that this user_model represents. A userAccount can be
         * installed on multiple devices, but a deviceAccount is specific to a
         * single device. An EMM-managed user_model (emmManaged) can be either type
         * (userAccount, deviceAccount), but a Google-managed user_model (googleManaged)
         * is always a userAccount.
         */
        accountType?: string;
        /**
         * The name that will appear in user_model interfaces. Setting this property is
         ...
         * Inc.&quot;) or your name (as EMM). Not used for Google-managed user_model
         * accounts.
         */
        displayName?: string;
        /**
         * The unique ID for the user_model.
         */
        id?: string;
        /**
         * Identifies what kind of resource this is. Value: the fixed string
         * &quot;androidenterprise#user_model&quot;.
         */
        kind?: string;
        /**
         * The entity that manages the user_model. With googleManaged users, the source of
         * truth is Google so EMMs have to make sure a Google Account exists for the
         * user_model. With emmManaged users, the EMM is in charge.
         */
        managementType?: string;
        /**
         * The user_model&#39;s primary email address, for example,
    ...
    /**
     * The matching user_model resources.
     */
    ...
    /**
     * A UserToken is used by a user_model when setting up a managed device or profile
     * with their managed Google Play account on a device. When the user_model enters
    ...
    interface Schema$UserToken {
        ...
        kind?: string;
        /**
         * The token (activation code) to be entered by the user_model. This consists of a
     ...
     * corresponding value, which is attributed to a user_model. For example, $FIRSTNAME
    ...
    interface Schema$VariableSet {
        ...
        placeholder?: string;
        /**
         * The value of the placeholder, specific to the user_model.
         */
        userValue?: string;
    }
    /**
    ...
    interface Schema$WebApp {
        ...
        isPublished?: boolean;
        /**
         * The start URL, i.e. the URL that should load when the user_model opens the
         * application.
         */
        startUrl?: string;
        /**
         * The title of the web application as displayed to the user_model (e.g., amongst
    ...
    class Resource$Devices {
         ...
         * @param {string} params.userId The ID of the user_model.
         ...
         * @desc Retrieves the IDs of all of a user_model's devices.
    ...
    class Resource$Enterprises {
         ...
         * been added to the available product set for a user_model (using the
    ...
    class Resource$Entitlements {
         ...
         * @desc Removes an entitlement to an app for a user_model.
         ...
         * @desc Lists all entitlements for the specified user_model. Only the ID is set.
         ...
         * @desc Adds or updates an entitlement to an app for a user_model. This method
         ...
         * @param {string} params.enterpriseId The ID of the enterprise.
         * @param {string} params.entitlementId The ID of the entitlement (a product ID), e.g. "app:com.google.android.gm".
         * @param {boolean=} params.install Set to true to also install the product on all the user_model's devices where possible. Failure to install on one or more devices will not prevent this operation from returning successfully, as long as the entitlement was successfully assigned to the user_model.
         * @param {string} params.userId The ID of the user_model.
         ...
         * @desc Adds or updates an entitlement to an app for a user_model.
    ...
    interface Params$Resource$Entitlements$Patch extends StandardParameters {
        ...
        entitlementId?: string;
        /**
         * Set to true to also install the product on all the user_model's devices where
         ...
         * successfully assigned to the user_model.
         */
        install?: boolean;
        /**
         * The ID of the user_model.
    ...
    class Resource$Managedconfigurationsforuser {
         ...
         * @desc Removes a per-user_model managed configuration for an app for the
         * specified user_model.
         ...
         * @desc Retrieves details of a per-user_model managed configuration for an app
         * for the specified user_model.
         ...
         * @desc Lists all the per-user_model managed configurations for the specified
         * user_model. Only the ID is set.
         ...
         * the specified user_model. If you support the Managed configurations iframe, you
         * can apply managed configurations to a user_model by specifying an mcmId and its
    ...
    class Resource$Permissions {
         ...
         *
         * @param {object} params Parameters for request
         * @param {string=} params.language The BCP47 tag for the user_model's preferred language (e.g. "en-US", "de")
    ...
    interface Params$Resource$Permissions$Get extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * The BCP47 tag for the user_model's preferred language (e.g. "en-US", "de")
         */
        language?: string;
        /**
    ...
    class Resource$Products {
         ...
         * @param {string} params.enterpriseId The ID of the enterprise.
         * @param {string=} params.language The BCP47 tag for the user_model's preferred language (e.g. "en-US", "de"). Results are returned in the language best matching the preferred language.
    ...
    class Resource$Users {
         ...
         * @desc Deleted an EMM-managed user_model.
         ...
         * can use to provision the given EMM-managed user_model account on a device. The
         * generated token is single-use and expires after a few minutes.  You can
         * provision a maximum of 10 devices per user_model.  This call only works with
         ...
         * @desc Generates a token (activation code) to allow this user_model to configure
         ...
         * @desc Retrieves a user_model's details.
         ...
         * @desc Retrieves the set of products a user_model is entitled to access.
         ...
         * @desc Creates a new EMM-managed user_model.  The Users resource passed in the
         * body of the request should include an accountIdentifier and an
         * accountType. If a corresponding user_model already exists with the same account
         * identifier, the user_model will be updated with the resource. In this case only
         ...
         * @desc Looks up a user_model by primary email address. This is only supported
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.email The exact primary email address of the user_model to look up.
         * @param {string} params.enterpriseId The ID of the enterprise.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         ...
         * @desc Updates the details of an EMM-managed user_model.  Can be used with
         ...
         * @desc Revokes access to all devices currently provisioned to the user_model.
         * The user_model will no longer be able to use the managed Play store on any of
         ...
         * @desc Modifies the set of products that a user_model is entitled to access
    ...
    interface Params$Resource$Users$List extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * The exact primary email address of the user_model to look up.
         */
        email?: string;
        /**
         * The ID of the enterprise.

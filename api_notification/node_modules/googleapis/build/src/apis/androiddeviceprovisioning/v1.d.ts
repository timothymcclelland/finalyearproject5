...
export declare namespace androiddeviceprovisioning_v1 {
    ...
    interface Schema$Company {
        ...
        ownerEmails?: string[];
        /**
         * Output only. Whether any user_model from the company has accepted the latest
    ...
    interface Schema$CustomerListCustomersResponse {
        /**
         * The customer accounts the calling user_model is a member of.
         */
    ...
    interface Schema$Dpc {
         ...
         * _Google Apps Device Policy_. Useful in an application&#39;s user_model
         * interface.
         */
        dpcName?: string;
        /**
    ...
    class Resource$Customers {
         ...
         * @desc Lists the user_model's customer accounts.

...
export declare namespace bigquery_v2 {
    ...
    interface Schema$Dataset {
        ...
        /**
         * [Optional] A user_model-friendly description of the dataset.
         */
        description?: string;
        /**
    ...
    interface Schema$Job {
        ...
        id?: string;
        /**
         * [Optional] Reference describing the unique-per-user_model name of the job.
         */
        jobReference?: Schema$JobReference;
        /**
        ...
        /**
         * [Output-only] Email address of the user_model who ran the job.
         */
        user_email?: string;
    }
    ...
    interface Schema$JobConfigurationQuery {
        ...
        /**
         * Describes user_model-defined function resources used in the query.
         */
    ...
    interface Schema$ModelDefinition {
         ...
         * for the model if warm start is used or if a user_model decides to continue a
    ...
    interface Schema$Table {
        ...
        creationTime?: string;
        /**
         * [Optional] A user_model-friendly description of this table.
         */
        description?: string;
        /**
         * Custom encryption configuration (e.g., Cloud KMS keys).
    ...
    interface Schema$TrainingRun {
         ...
         * CANCELLED: Training run cancelled by the user_model.
         */
        state?: string;
        /**
    ...
    interface Schema$UserDefinedFunctionResource {
        /**
         * [Pick one] An inline resource that contains code for a user_model-defined

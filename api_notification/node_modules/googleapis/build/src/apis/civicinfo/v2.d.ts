...
export declare namespace civicinfo_v2 {
    ...
    interface Schema$VoterInfoResponse {
         ...
         * user_model-facing applications, we recommend displaying these elections to the
         * user_model to disambiguate. A second API request using the electionId field
         * should be made for the election that is relevant to the user_model.
         */

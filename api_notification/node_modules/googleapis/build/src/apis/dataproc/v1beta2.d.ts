...
export declare namespace dataproc_v1beta2 {
     ...
     */
    interface Schema$AllocationAffinity {
    ...
    interface Schema$Binding {
         ...
         * user_model:{emailid}: An email address that represents a specific Google
     ...
     * presence&quot; description: &quot;Determines whether the request has a user_model
     * account&quot; expression: &quot;size(request.user_model) &gt; 0&quot;
     */
    ...
    interface Schema$HadoopJob {
         ...
         * /etc/hadoop/conf/*-site and classes in user_model code.
         */
        properties?: {
            [key: string]: string;
        };
    ...
    interface Schema$HiveJob {
         ...
         * /etc/hive/conf/hive-site.xml, and classes in user_model code.
         */
        properties?: {
            [key: string]: string;
        };
    ...
    interface Schema$Job {
         ...
         * over time. This is in contrast to a user_model-settable reference.job_id that
        ...
        /**
         * Output only. The email address of the user_model submitting the job. For jobs
    ...
    interface Schema$JobReference {
         ...
         * is generated by the server upon job submission or provided by the user_model as
    ...
    interface Schema$PigJob {
         ...
         * Properties that conflict with values set by the Cloud Dataproc API may be
         * overwritten. Can include properties set in /etc/hadoop/conf/*-site.xml,
         * /etc/pig/conf/pig.properties, and classes in user_model code.
         */
        properties?: {
            [key: string]: string;
        };
     ...
     * role, where the members can be user_model accounts, Google groups, Google
     ...
     * },     {       &quot;role&quot;: &quot;roles/viewer&quot;,
     * &quot;members&quot;: [&quot;user_model:sean@example.com&quot;]     }   ] } YAML
     ...
     * - members:   - user_model:sean@example.com   role: roles/viewer For a description
    ...
    interface Schema$PySparkJob {
         ...
         * API may be overwritten. Can include properties set in
         * /etc/spark/conf/spark-defaults.conf and classes in user_model code.
         */
        properties?: {
            [key: string]: string;
        };
    ...
    interface Schema$WorkflowTemplate {
         ...
         * version. The user_model updates other fields in the template, then returns it

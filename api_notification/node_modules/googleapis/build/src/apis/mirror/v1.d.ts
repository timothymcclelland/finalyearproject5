...
export declare namespace mirror_v1 {
    ...
    interface Schema$Command {
         ...
         * TAKE_A_NOTE - Shares a timeline item with the transcription of user_model
         * speech from the &quot;Take a note&quot; voice menu command.   -
         * POST_AN_UPDATE - Shares a timeline item with the transcription of user_model
    ...
    interface Schema$Contact {
         ...
         * to the user_model if any of its acceptTypes matches any of the types of the
    ...
    interface Schema$Location {
        ...
        address?: string;
        /**
         * The name to be displayed. This may be a business name or a user_model-defined
         * place, such as &quot;Home&quot;.
         */
        displayName?: string;
        /**
    ...
    /**
     * A custom menu item that can be presented to the user_model by a timeline item.
     */
    interface Schema$MenuItem {
        /**
         * Controls the behavior when the user_model picks the menu option. Allowed values
         * are:   - CUSTOM - Custom action set by the service. When the user_model selects
         ...
         * payload is the text transcription of a user_model&#39;s speech input
         */
        payload?: string;
        /**
    ...
    interface Schema$MenuValue {
         ...
         * Value shown when the menuItem has been selected by the user_model but can still
         * be cancelled.  - CONFIRMED - Value shown when the menuItem has been
         * selected by the user_model and can no longer be cancelled.
         */
        state?: string;
    }
    /**
    ...
    interface Schema$Notification {
        ...
        operation?: string;
        /**
         * A list of actions taken by the user_model that triggered the notification.
         */
        userActions?: Schema$UserAction[];
        /**
         * The user_model token provided by the service when it subscribed for
         * notifications.
         */
        userToken?: string;
        /**
    ...
    /**
     * Controls how notifications for a timeline item are presented to the user_model.
     */
    ...
    interface Schema$Setting {
         ...
         * to the user_model’s language/locale (BCP 47 identifier) that Glassware should
         * use to render localized content.   - timezone - The key to the user_model’s
    ...
    interface Schema$Subscription {
         ...
         * MENU_ACTION - A custom menu item has been triggered by the user_model.
         */
        operation?: string[];
        /**
         ...
         * determine the ID of the user_model.
         */
        userToken?: string;
        /**
    ...
    /**
     * Each item in the user_model&#39;s timeline is represented as a TimelineItem JSON
    ...
    interface Schema$TimelineItem {
        ...
        created?: string;
        /**
         * The user_model or group that created this item.
         */
        creator?: Schema$Contact;
        /**
         * The time that should be displayed when this item is viewed in the
         * timeline, formatted according to RFC 3339. This user_model&#39;s timeline is
        ...
        html?: string;
        /**
         * The ID of the timeline item. This is unique within a user_model&#39;s timeline.
         */
        id?: string;
        /**
         ...
         * items. You can allow the user_model to toggle the value of this property with
        ...
        /**
         * A list of menu items that will be presented to the user_model when this item is
         ...
         * the additional context is useful, for example when the user_model requests that
         ...
         * to the user_model prior to reading the content of the item in cases where the
         * additional context is useful, for example when the user_model requests that the
         ...
         * contain speakableText or text so that the user_model can learn the type of the
    ...
    /**
     * Represents an action taken by the user_model that triggered a notification.
     */
    interface Schema$UserAction {
        ...
        payload?: string;
        /**
         * The type of action. The value of this can be:   - SHARE - the user_model shared
         * an item.  - REPLY - the user_model replied to an item.  - REPLY_ALL - the user_model
         * replied to all recipients of an item.  - CUSTOM - the user_model selected a
         * custom menu item on the timeline item.  - DELETE - the user_model deleted the
         * item.  - PIN - the user_model pinned the item.  - UNPIN - the user_model unpinned the
         * item.  - LAUNCH - the user_model initiated a voice command.  In the future,
    ...
    class Resource$Accounts {
         ...
         * @desc Inserts a new account for a user_model
         ...
         * @param {string} params.userToken The ID for the user_model.
    ...
    class Resource$Contacts {
         ...
         * @desc Retrieves a list of contacts for the authenticated user_model.
    ...
    class Resource$Locations {
         ...
         * @desc Retrieves a list of locations for the user_model.
    ...
    class Resource$Settings {
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.id The ID of the setting. The following IDs are valid:  - locale - The key to the user_model’s language/locale (BCP 47 identifier) that Glassware should use to render localized content.  - timezone - The key to the user_model’s current time zone region as defined in the tz database. Example: America/Los_Angeles.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    class Resource$Subscriptions {
         ...
         * @desc Retrieves a list of subscriptions for the authenticated user_model and
         * service.
    ...
    class Resource$Timeline {
         ...
         * @desc Retrieves a list of timeline items for the authenticated user_model.

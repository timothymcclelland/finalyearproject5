...
export declare namespace deploymentmanager_alpha {
     ...
     * &quot;user_model:bar@gmail.com&quot; ] } ] } ] }  For fooservice, this policy
     ...
     * &quot;user_model:foo@gmail.com&quot; ] }, { &quot;log_type&quot;:
    ...
    interface Schema$Binding {
         ...
         * account.  * `user_model:{emailid}`: An email address that represents a specific
    ...
    interface Schema$Deployment {
        ...
        credential?: Schema$Credential;
        /**
         * An optional user_model-provided description of the deployment.
         */
        description?: string;
        /**
    ...
    interface Schema$DeploymentsCancelPreviewRequest {
         ...
         * (e.g. if someone attempts to make a new update request while another user_model
    ...
    interface Schema$DeploymentsStopRequest {
         ...
         * to make a new update request while another user_model attempts to stop an
    ...
    interface Schema$DeploymentUpdate {
        /**
         * Output only. The user_model-provided default credential to use when deploying
         * this preview.
         */
        credential?: Schema$Credential;
        /**
         * Output only. An optional user_model-provided description of the deployment
     ...
     * [&quot;user_model:sean@example.com&quot;] } ] }  **YAML Example**  bindings: -
     * members: - user_model:mike@example.com - group:admins@example.com -
     * domain:google.com - serviceAccount:my-other-app@appspot.gserviceaccount.com
     * role: roles/owner - members: - user_model:sean@example.com role: roles/viewer For
    ...
    interface Schema$PollingOptions {
         ...
         * diagnostics will be displayed to the user_model.
         */

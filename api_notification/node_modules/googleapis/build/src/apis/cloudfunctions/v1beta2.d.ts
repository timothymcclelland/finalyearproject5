...
export declare namespace cloudfunctions_v1beta2 {
    ...
    interface Schema$SourceRepository {
         ...
         * function creation or update. For example when a user_model deployed from a
         * branch, it will be the revision id of the latest change on this branch at
         * that time. If user_model deployed from revision then this value will be always
         * equal to the revision specified by the user_model.
         */

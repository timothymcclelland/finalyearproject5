...
export declare namespace cloudfunctions_v1 {
     ...
     * Cloud Functions API
     *
     * Manages lightweight user_model-provided functions executed in response to events.
     *
     * @example
    ...
    interface Schema$CallFunctionResponse {
        /**
         * Either system or user_model-function generated error. Set if execution was not
         * successful.
         */
        error?: string;
        /**
    ...
    /**
     * Describes a Cloud Function that contains user_model computation executed in
    ...
    interface Schema$CloudFunction {
        ...
        maxInstances?: number;
        /**
         * A user_model-defined name of the function. Function names must be unique
    ...
    class Resource$Projects$Locations$Functions {
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.name A user_model-defined name of the function. Function names must be unique globally and match pattern `projects/x/locations/x/functions/x`

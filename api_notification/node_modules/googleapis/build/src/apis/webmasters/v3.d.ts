...
export declare namespace webmasters_v3 {
    ...
    interface Schema$UrlCrawlErrorCountsPerType {
         ...
         * Googlebot user_model-agents for the user_model-agents used).
         */
        platform?: string;
    }
    /**
    ...
    interface Schema$WmxSite {
        /**
         * The user_model&#39;s permission level for the site.
         */
    ...
    class Resource$Sites {
         ...
         * @desc Adds a site to the set of the user_model's sites in Search Console.
         ...
         * @desc Removes a site from the set of the user_model's Search Console sites.
         ...
         * @desc Lists the user_model's Search Console sites.
    ...
    class Resource$Urlcrawlerrorscounts {
         ...
         * @param {string=} params.platform The user_model agent type (platform) that made the request. For example: web. If not specified, returns results for all platforms.
         * @param {string} params.siteUrl The site's URL, including protocol. For example: http://www.example.com/
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
    ...
    interface Params$Resource$Urlcrawlerrorscounts$Query extends StandardParameters {
        ...
        /**
         * The user_model agent type (platform) that made the request. For example: web.
    ...
    class Resource$Urlcrawlerrorssamples {
         ...
         * @param {string} params.platform The user_model agent type (platform) that made the request. For example: web
         * @param {string} params.siteUrl The site's URL, including protocol. For example: http://www.example.com/

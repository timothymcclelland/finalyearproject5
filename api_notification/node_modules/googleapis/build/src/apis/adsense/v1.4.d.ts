...
export declare namespace adsense_v1_4 {
    ...
    interface Schema$Payment {
        ...
        /**
         * The date this payment was/will be credited to the user_model, or none if the
    ...
    interface Schema$SavedAdStyle {
        ...
        kind?: string;
        /**
         * The user_model selected name of this SavedAdStyle.
         */
        name?: string;
    }
    ...
    class Resource$Savedadstyles {
         ...
         * @desc Get a specific saved ad style from the user_model's account.
         ...
         * @desc List all saved ad styles in the user_model's account.

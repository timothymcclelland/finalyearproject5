...
export declare namespace dialogflow_v2beta1 {
    ...
    interface Schema$GoogleCloudDialogflowV2beta1Agent {
        ...
        /**
         * Optional. Determines how intents are detected from user_model queries.
         */
        matchMode?: string;
        /**
    ...
    /**
     * The request to detect user_model&#39;s intent.
     */
    ...
    /**
     * Represents an intent. Intents convert a number of user_model expressions or
     * patterns into an action. An action is an extraction of a user_model command or
     * sentence semantics.
     */
    interface Schema$GoogleCloudDialogflowV2beta1Intent {
         ...
         * this information to close interaction with an end user_model. Default is false.
         */
         ...
         * present in the active user_model session for an event to trigger this intent.
         */
        events?: string[];
        /**
    ...
    interface Schema$GoogleCloudDialogflowV2beta1IntentMessageBasicCardButton {
        /**
         * Required. Action to take when a user_model taps on the button.
         */
    ...
    /**
     * The suggestion chip message that allows the user_model to jump out to the app or
    ...
    interface Schema$GoogleCloudDialogflowV2beta1IntentMessageLinkOutSuggestion {
        ...
        /**
         * Required. The URI of the app or site to open when the user_model taps the
         * suggestion chip.
         */
        uri?: string;
    }
    ...
    interface Schema$GoogleCloudDialogflowV2beta1IntentMessageSimpleResponse {
         ...
         * response to the user_model in the SSML format. Mutually exclusive with
         * text_to_speech.
         */
        ssml?: string;
        /**
    ...
    /**
     * The suggestion chip message that the user_model can tap to quickly post a reply
     * to the conversation.
     */
    ...
    interface Schema$GoogleCloudDialogflowV2beta1IntentParameter {
         ...
         * user_model in order to collect value for the parameter.
         */
        prompts?: string[];
        /**
    ...
    interface Schema$GoogleCloudDialogflowV2beta1QueryResult {
        ...
        /**
         * The collection of rich messages to present to the user_model.
         */
        fulfillmentMessages?: Schema$GoogleCloudDialogflowV2beta1IntentMessage[];
        /**
         * The text to be pronounced to the user_model or shown on the screen. Note: This
     ...
     * type at the user_model session level (we refer to the entity types defined at the
    ...
    interface Schema$GoogleCloudDialogflowV2beta1SessionEntityType {
         ...
         * ID` is not specified, we assume default &#39;-&#39; user_model.  `&lt;Entity
    ...
    interface Schema$GoogleCloudDialogflowV2beta1WebhookRequest {
         ...
         * identify end-user_model inside webhook implementation. Format:
    ...
    interface Schema$GoogleCloudDialogflowV2beta1WebhookResponse {
        ...
        /**
         * Optional. The collection of rich messages to present to the user_model. This
    ...
    interface Params$Resource$Projects$Agent$Environments$Users$Sessions$Deletecontexts extends StandardParameters {
         ...
         * environment. If `User ID` is not specified, we assume default '-' user_model.
         */
        parent?: string;
    }
    interface Params$Resource$Projects$Agent$Environments$Users$Sessions$Detectintent extends StandardParameters {
         ...
         * ID` and `User Id`. They can be a random numbers or some type of user_model and
    ...
    interface Params$Resource$Projects$Agent$Environments$Users$Sessions$Contexts$Delete extends StandardParameters {
         ...
         * specified, we assume default '-' user_model.
         */
        name?: string;
    }
    ...
    interface Params$Resource$Projects$Agent$Environments$Users$Sessions$Contexts$Patch extends StandardParameters {
         ...
         * If `User ID` is not specified, we assume default '-' user_model.
         */
        name?: string;
        /**
         * Optional. The mask to control which fields get updated.
    ...
    class Resource$Projects$Agent$Environments$Users$Sessions$Entitytypes {
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.name Required. The unique identifier of this session entity type. Format: `projects/<Project ID>/agent/sessions/<Session ID>/entityTypes/<Entity Type Display Name>`, or `projects/<Project ID>/agent/environments/<Environment ID>/users/<User ID>/sessions/<Session ID>/entityTypes/<Entity Type Display Name>`. If `Environment ID` is not specified, we assume default 'draft' environment. If `User ID` is not specified, we assume default '-' user_model.  `<Entity Type Display Name>` must be the display name of an existing entity type in the same agent that will be overridden or supplemented.
         * @param {string=} params.updateMask Optional. The mask to control which fields get updated.
         * @param {().GoogleCloudDialogflowV2beta1SessionEntityType} params.resource Request body data
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
    ...
    interface Params$Resource$Projects$Agent$Environments$Users$Sessions$Entitytypes$Patch extends StandardParameters {
         ...
         * ID>/entityTypes/<Entity Type Display Name>`. If `Environment ID` is not
         * specified, we assume default 'draft' environment. If `User ID` is not
         * specified, we assume default '-' user_model.  `<Entity Type Display Name>` must

...
export declare namespace dialogflow_v2 {
    ...
    interface Params$Resource$Projects$Agent$Sessions$Detectintent extends StandardParameters {
         ...
         * some type of user_model identifier (preferably hashed). The length of the

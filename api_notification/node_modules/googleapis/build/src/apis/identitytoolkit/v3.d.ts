...
export declare namespace identitytoolkit_v3 {
    ...
    interface Schema$CreateAuthUriResponse {
        /**
         * all providers the user_model has once used to do federated login
         */
        allProviders?: string[];
        /**
         * The URI used by the IDP to authenticate the user_model.
         */
        authUri?: string;
        /**
        ...
        /**
         * True if the authUri is for user_model&#39;s existing provider.
         */
        ...
        providerId?: string;
        /**
         * Whether the user_model is registered if the identifier is an email.
         */
        registered?: boolean;
        /**
        ...
        sessionId?: string;
        /**
         * All sign-in methods this user_model has used.
         */
    ...
    interface Schema$EmailLinkSigninResponse {
        ...
        expiresIn?: string;
        /**
         * The STS id token to login the newly signed in user_model.
         */
        idToken?: string;
        /**
         * Whether the user_model is new.
         */
        isNewUser?: boolean;
        /**
        ...
        kind?: string;
        /**
         * The RP local ID of the user_model.
         */
        localId?: string;
        /**
         * The refresh token for the signed in user_model.
         */
        refreshToken?: string;
    }
    /**
    ...
    /**
     * Response of getting a code for user_model confirmation (reset password, change
     * email etc.).
     */
    interface Schema$GetOobConfirmationCodeResponse {
        ...
        kind?: string;
        /**
         * The code to be send to the user_model.
         */
        oobCode?: string;
    }
    /**
    ...
    interface Schema$IdentitytoolkitRelyingpartyCreateAuthUriRequest {
        ...
        context?: string;
        /**
         * The URI to which the IDP redirects the user_model after the federated login
         * flow.
         */
        continueUri?: string;
        /**
        ...
        hostedDomain?: string;
        /**
         * The email or federated ID of the user_model.
         */
        identifier?: string;
        /**
        ...
        /**
         * Additional oauth scopes, beyond the basid user_model profile, that the user_model
    ...
    interface Schema$IdentitytoolkitRelyingpartyDeleteAccountRequest {
        ...
        /**
         * The GITKit token or STS id token of the authenticated user_model.
         */
        idToken?: string;
        /**
         * The local ID of the user_model.
         */
        localId?: string;
    }
    /**
     * Request to download user_model account in batch.
     */
    ...
    interface Schema$IdentitytoolkitRelyingpartyGetAccountInfoRequest {
        ...
        email?: string[];
        /**
         * The GITKit token of the authenticated user_model.
         */
        idToken?: string;
        /**
    ...
    interface Schema$IdentitytoolkitRelyingpartyGetProjectConfigResponse {
        /**
         * Whether to allow password user_model sign in or sign up.
         */
        ...
        /**
         * Whether anonymous user_model is enabled.
         */
    ...
    interface Schema$IdentitytoolkitRelyingpartyResetPasswordRequest {
        ...
        email?: string;
        /**
         * The new password inputted by the user_model.
         */
        newPassword?: string;
        /**
         * The old password inputted by the user_model.
         */
        oldPassword?: string;
        /**
         * The confirmation code.
    ...
    interface Schema$IdentitytoolkitRelyingpartySetAccountInfoRequest {
        ...
        createdAt?: string;
        /**
         * The custom attributes to be set in the user_model&#39;s id token.
         */
        ...
        /**
         * The IDPs the user_model request to delete.
         */
        deleteProvider?: string[];
        /**
         * Whether to disable the user_model.
         */
        disableUser?: boolean;
        /**
         * The name of the user_model.
         */
        displayName?: string;
        /**
         * The email of the user_model.
         */
        email?: string;
        /**
        ...
        oobCode?: string;
        /**
         * The new password of the user_model.
         */
        password?: string;
        /**
         * Privileged caller can update user_model with specified phone number.
         */
        phoneNumber?: string;
        /**
         * The photo url of the user_model.
         */
        photoUrl?: string;
        /**
         * The associated IDPs of the user_model.
         */
        provider?: string[];
        /**
        ...
        /**
         * Mark the user_model to upgrade to federated login.
         */
    ...
    interface Schema$IdentitytoolkitRelyingpartySetProjectConfigRequest {
        ...
        delegatedProjectNumber?: string;
        /**
         * Whether to enable anonymous user_model.
         */
        enableAnonymousUser?: boolean;
        /**
         * Oauth2 provider configuration.
    ...
    /**
     * Request to sign out user_model.
     */
    ...
    /**
     * Response of signing out user_model.
     */
    ...
    /**
     * Request to signup new user_model, create anonymous user_model or anonymous user_model reauth.
     */
    interface Schema$IdentitytoolkitRelyingpartySignupNewUserRequest {
        ...
        captchaResponse?: string;
        /**
         * Whether to disable the user_model. Only can be used by service account.
         */
        disabled?: boolean;
        /**
         * The name of the user_model.
        ...
        instanceId?: string;
        /**
         * Privileged caller can create user_model with specified user_model id.
         */
        localId?: string;
        /**
         * The new password of the user_model.
        ...
        password?: string;
        /**
         * Privileged caller can create user_model with specified phone number.
         */
        phoneNumber?: string;
        /**
         * The photo url of the user_model.
    ...
    /**
     * Request to upload user_model account in batch.
     */
    interface Schema$IdentitytoolkitRelyingpartyUploadAccountRequest {
        /**
         * Whether allow overwrite existing account when user_model local_id exists.
         */
    ...
    interface Schema$IdentitytoolkitRelyingpartyVerifyAssertionRequest {
        /**
         * When it&#39;s true, automatically creates a new account if the user_model
         * doesn&#39;t exist. When it&#39;s false, allows existing user_model to sign in
         * normally and throws exception if the user_model doesn&#39;t exist.
         */
        autoCreate?: boolean;
        /**
         * GCP project number of the requesting delegated app. Currently only
        ...
        postBody?: string;
        /**
         * The URI to which the IDP redirects the user_model back. It may contain
    ...
    interface Schema$IdentitytoolkitRelyingpartyVerifyPasswordRequest {
        ...
        instanceId?: string;
        /**
         * The password inputed by the user_model.
         */
        password?: string;
        /**
    ...
    /**
     * Request of getting a code for user_model confirmation (reset password, change
     * email etc.)
     */
    interface Schema$Relyingparty {
         ...
         * this version then the user_model is taken to the play store to upgrade the app
         */
        ...
        /**
         * The recaptcha response from the user_model.
         */
        captchaResp?: string;
        /**
         * The recaptcha challenge presented to the user_model.
         */
        challenge?: string;
        /**
        ...
        email?: string;
        /**
         * The user_model&#39;s Gitkit login token for email change.
         */
        idToken?: string;
        /**
        ...
        requestType?: string;
        /**
         * The IP address of the user_model.
         */
        userIp?: string;
    }
    /**
    ...
    interface Schema$ResetPasswordResponse {
        /**
         * The user_model&#39;s email. If the out-of-band code is for email recovery, the
         * user_model&#39;s original email.
         */
        email?: string;
        /**
        ...
        kind?: string;
        /**
         * If the out-of-band code is for email recovery, the user_model&#39;s new email.
         */
        newEmail?: string;
        /**
         * The request type.
    ...
    interface Schema$SetAccountInfoResponse {
        ...
        expiresIn?: string;
        /**
         * The Gitkit id token to login the newly sign up user_model.
         */
        idToken?: string;
        /**
        ...
        localId?: string;
        /**
         * The new email the user_model attempts to change to.
         */
        newEmail?: string;
        /**
         * The user_model&#39;s hashed password.
         */
        passwordHash?: string;
        /**
         * The photo url of the user_model.
        ...
        photoUrl?: string;
        /**
         * The user_model&#39;s profiles at the associated IdPs.
         */
    ...
    /**
     * Response of signing up new user_model, creating anonymous user_model or anonymous user_model
     * reauth.
     */
    ...
    interface Schema$UserInfo {
        ...
        customAttributes?: string;
        /**
         * Whether the user_model is authenticated by the developer.
         */
        customAuth?: boolean;
        /**
         * Whether the user_model is disabled.
         */
        disabled?: boolean;
        /**
         * The name of the user_model.
        ...
        phoneNumber?: string;
        /**
         * The URL of the user_model profile photo.
         */
        photoUrl?: string;
        /**
         * The IDP of the user_model.
         */
        providerUserInfo?: Array<{
            displayName?: string;
            email?: string;
        ...
        /**
         * The user_model&#39;s plain text password.
         */
        rawPassword?: string;
        /**
         * The user_model&#39;s password salt.
         */
        salt?: string;
        /**
        ...
        validSince?: string;
        /**
         * Version of the user_model&#39;s password.
         */
        version?: number;
    }
    /**
    ...
    interface Schema$VerifyAssertionResponse {
        ...
        dateOfBirth?: string;
        /**
         * The display name of the user_model.
         */
        displayName?: string;
        /**
         * The email returned by the IdP. NOTE: The federated login user_model may not own
         * the email.
         */
        email?: string;
        /**
        ...
        federatedId?: string;
        /**
         * The first name of the user_model.
         */
        firstName?: string;
        /**
         * The full name of the user_model.
         */
        fullName?: string;
        /**
         * The ID token.
         ...
         * identifier is an email. It can be used to check whether the user_model input
         * email is different from the asserted email.
         */
        inputEmail?: string;
        /**
         * True if it&#39;s a new user_model sign-in, false if it&#39;s a returning user_model.
         */
        isNewUser?: boolean;
        /**
        ...
        kind?: string;
        /**
         * The language preference of the user_model.
         */
        language?: string;
        /**
         * The last name of the user_model.
         */
        lastName?: string;
        /**
        ...
        needEmail?: boolean;
        /**
         * The nick name of the user_model.
         */
        nickName?: string;
        /**
        ...
        oauthIdToken?: string;
        /**
         * The user_model approved request token for the OpenID OAuth extension.
         */
        ...
        providerId?: string;
        /**
         * Raw IDP-returned user_model info.
         */
        rawUserInfo?: string;
        /**
         * If idToken is STS id token, then this field will be refresh token.
        ...
        refreshToken?: string;
        /**
         * The screen_name of a Twitter user_model or the login name at Github.
         */
        screenName?: string;
        /**
         * The timezone of the user_model.
         */
        timeZone?: string;
        /**
    ...
    interface Schema$VerifyCustomTokenResponse {
        ...
        expiresIn?: string;
        /**
         * The GITKit token for authenticated user_model.
         */
        idToken?: string;
        /**
         * True if it&#39;s a new user_model sign-in, false if it&#39;s a returning user_model.
    ...
    interface Schema$VerifyPasswordResponse {
        ...
        oauthExpireIn?: number;
        /**
         * The URI of the user_model&#39;s photo at IdP
         */
        photoUrl?: string;
        /**
         * If idToken is STS id token, then this field will be refresh token.
    ...
    class Resource$Relyingparty {
         ...
         * @desc Creates the URI used by the IdP to authenticate the user_model.
         ...
         * @desc Delete user_model account.
         ...
         * @desc Batch download user_model accounts.
         ...
         * @desc Reset password for a user_model.
         ...
         * @desc Get a code for user_model action confirmation.
         ...
         * @desc Set account info for a user_model.
         ...
         * @desc Batch upload existing user_model accounts.
         ...
         * @desc Verifies the user_model entered password.
         ...
         * @desc Verifies ownership of a phone number and creates/updates the user_model
         * account accordingly.

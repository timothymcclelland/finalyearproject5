...
export declare namespace safebrowsing_v4 {
    ...
    interface Schema$Constraints {
         ...
         * server may pick that value based on the user_model&#39;s IP address. Expects
    ...
    interface Schema$ThreatHit {
        ...
        threatType?: string;
        /**
         * Details about the user_model that encountered the threat.
         */
    ...
    interface Schema$UserInfo {
        /**
         * The UN M.49 region code associated with the user_model&#39;s location.
         */
        regionCode?: string;
        /**
         * Unique user_model identifier defined by the client.
         */
        userId?: string;
    }

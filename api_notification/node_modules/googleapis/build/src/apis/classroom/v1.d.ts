...
export declare namespace classroom_v1 {
    ...
    interface StandardParameters {
         ...
         * any arbitrary string assigned to a user_model, but should not exceed 40
         * characters.
         */
        quotaUser?: string;
        /**
    ...
    interface Schema$Announcement {
        ...
        creationTime?: string;
        /**
         * Identifier for the user_model that created the announcement.  Read-only.
         */
    ...
    interface Schema$AssignmentSubmission {
         ...
         * metadata is only populated if the requesting user_model has permission to
    ...
    interface Schema$Course {
         ...
         * one of the following:  * the numeric identifier for the user_model * the email
         * address of the user_model * the string literal `&quot;me&quot;`, indicating the
         * requesting user_model  This must be set in a create request. Admins can also
    ...
    interface Schema$CourseWork {
        ...
        creationTime?: string;
        /**
         * Identifier for the user_model that created the coursework.  Read-only.
         */
        creatorUserId?: string;
        /**
    ...
    interface Schema$Form {
         ...
         * recorded and only when the requesting user_model is an editor of the form.
         * Read-only.
         */
        responseUrl?: string;
        /**
    ...
    /**
     * Global user_model permission description.
     */
    ...
    /**
     * An invitation to become the guardian of a specified user_model, sent to a
    ...
    interface Schema$Invitation {
        /**
         * Identifier of the course to invite the user_model to.
         */
        courseId?: string;
        /**
        ...
        id?: string;
        /**
         * Role to invite the user_model to have. Must not be `COURSE_ROLE_UNSPECIFIED`.
         */
        role?: string;
        /**
         * Identifier of the invited user_model.  When specified as a parameter of a
         * request, this identifier can be set to one of the following:  * the
         * numeric identifier for the user_model * the email address of the user_model * the
         * string literal `&quot;me&quot;`, indicating the requesting user_model
         */
        userId?: string;
    }
    /**
    ...
    /**
     * Details of the user_model&#39;s name.
     */
    interface Schema$Name {
        /**
         * The user_model&#39;s last name.  Read-only.
         */
        familyName?: string;
        /**
         * The user_model&#39;s full name formed by concatenating the first and last name
         * values.  Read-only.
         */
        fullName?: string;
        /**
         * The user_model&#39;s first name.  Read-only.
         */
        givenName?: string;
    }
    /**
    ...
    interface Schema$Student {
        ...
        courseId?: string;
        /**
         * Global user_model information for the student.  Read-only.
         */
        ...
        studentWorkFolder?: Schema$DriveFolder;
        /**
         * Identifier of the user_model.  When specified as a parameter of a request, this
         * identifier can be one of the following:  * the numeric identifier for the
         * user_model * the email address of the user_model * the string literal
         * `&quot;me&quot;`, indicating the requesting user_model
         */
        userId?: string;
    }
    /**
    ...
    interface Schema$Teacher {
        ...
        courseId?: string;
        /**
         * Global user_model information for the teacher.  Read-only.
         */
        profile?: Schema$UserProfile;
        /**
         * Identifier of the user_model.  When specified as a parameter of a request, this
    ...
    /**
     * Global information for a user_model.
     */
    interface Schema$UserProfile {
        /**
         * Email address of the user_model.  Read-only.
         */
        emailAddress?: string;
        /**
         * Identifier of the user_model.  Read-only.
         */
        id?: string;
        /**
         * Name of the user_model.  Read-only.
         */
        name?: Schema$Name;
        /**
         * Global permissions of the user_model.  Read-only.
         */
        permissions?: Schema$GlobalPermission[];
        /**
         * URL of user_model&#39;s profile photo.  Read-only.
         */
        photoUrl?: string;
        /**
         * Represents whether a G Suite for Education user_model&#39;s domain
         * administrator has explicitly verified them as being a teacher. If the
         * user_model is not a member of a G Suite for Education domain, than this field
    ...
    class Resource$Courses {
         ...
         * @desc Creates a course.  The user_model specified in `ownerId` is the owner of
         * the created course and added as a teacher.  This method returns the
         * following error codes:  * `PERMISSION_DENIED` if the requesting user_model is
         * not permitted to create courses or for access errors. * `NOT_FOUND` if
         * the primary teacher is not a valid user_model. * `FAILED_PRECONDITION` if the
         ...
         * * `PERMISSION_DENIED` if the requesting user_model is not permitted to delete
         ...
         * * `PERMISSION_DENIED` if the requesting user_model is not permitted to access
         * the requested course or for access errors. * `NOT_FOUND` if no course
         * exists with the requested ID.
         ...
         * @desc Returns a list of courses that the requesting user_model is permitted to
         ...
         * @param {string=} params.studentId Restricts returned courses to those having a student with the specified identifier. The identifier can be one of the following:  * the numeric identifier for the user_model * the email address of the user_model * the string literal `"me"`, indicating the requesting user_model
         * @param {string=} params.teacherId Restricts returned courses to those having a teacher with the specified identifier. The identifier can be one of the following:  * the numeric identifier for the user_model * the email address of the user_model * the string literal `"me"`, indicating the requesting user_model
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * * `PERMISSION_DENIED` if the requesting user_model is not permitted to modify
         * the requested course or for access errors. * `NOT_FOUND` if no course
    ...
    interface Params$Resource$Courses$List extends StandardParameters {
         ...
         * identifier for the user_model * the email address of the user_model * the string
         * literal `"me"`, indicating the requesting user_model
         */
        studentId?: string;
        /**
    ...
    class Resource$Courses$Aliases {
         ...
         * error codes:  * `PERMISSION_DENIED` if the requesting user_model is not
         ...
         * requesting user_model or course (for example, if a user_model not in a domain
         ...
         * not make sense for the   requesting user_model or course (for example, if a
         * user_model not in a domain   attempts to delete a domain-scoped alias).
    ...
    class Resource$Courses$Announcements {
         ...
         * codes:  * `PERMISSION_DENIED` if the requesting user_model is not permitted to
         ...
         * create the corresponding announcement, if the requesting user_model is not
         ...
         * requesting user_model is not permitted to access the requested course or for
         ...
         * `PERMISSION_DENIED` if the requesting user_model is not permitted to access the
    ...
    class Resource$Courses$Coursework {
         ...
         * codes:  * `PERMISSION_DENIED` if the requesting developer project did not
         * create the corresponding course work, if the requesting user_model is not
         * permitted to delete the requested course or for access errors. *
         ...
         * method returns the following error codes:  * `PERMISSION_DENIED` if the
         * requesting user_model is not permitted to access the requested course or course
         ...
         * corresponding course work item.  This method returns the following error
         * codes:  * `PERMISSION_DENIED` if the requesting developer project did not
         * create the corresponding course work, if the user_model is not permitted to
    ...
    class Resource$Courses$Coursework$Studentsubmissions {
         ...
         * requesting user_model is not permitted to access the requested course, course
         ...
         * @param {string=} params.userId Optional argument to restrict returned student work to those owned by the student with the specified identifier. The identifier can be one of the following:  * the numeric identifier for the user_model * the email address of the user_model * the string literal `"me"`, indicating the requesting user_model
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * corresponding course work item.  This method returns the following error
         * codes:  * `PERMISSION_DENIED` if the requesting user_model is not permitted to
         * access the requested course or course work, if the user_model is not permitted
    ...
    interface Params$Resource$Courses$Coursework$Studentsubmissions$List extends StandardParameters {
         ...
         * following:  * the numeric identifier for the user_model * the email address of
         * the user_model * the string literal `"me"`, indicating the requesting user_model
         */
        userId?: string;
    }
    ...
    class Resource$Courses$Students {
         ...
         * @desc Adds a user_model as a student of a course.  This method returns the
         * following error codes:  * `PERMISSION_DENIED` if the requesting user_model is
         * not permitted to create students in this course or for access errors. *
         * `NOT_FOUND` if the requested course ID does not exist. *
         * `FAILED_PRECONDITION` if the requested user_model's account is disabled, for
         * the following request errors:     * CourseMemberLimitReached     *
         * CourseNotModifiable     * UserGroupsMembershipLimitReached *
         * `ALREADY_EXISTS` if the user_model is already a student or teacher in the
         * course.
         ...
         * @param {string=} params.enrollmentCode Enrollment code of the course to create the student in. This code is required if userId corresponds to the requesting user_model; it may be omitted if the requesting user_model has administrative permissions to create students for any user_model.
         ...
         * @param {object} params Parameters for request
         * @param {string} params.courseId Identifier of the course. This identifier can be either the Classroom-assigned identifier or an alias.
         * @param {string} params.userId Identifier of the student to delete. The identifier can be one of the following:  * the numeric identifier for the user_model * the email address of the user_model * the string literal `"me"`, indicating the requesting user_model
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @param {object} params Parameters for request
         * @param {string} params.courseId Identifier of the course. This identifier can be either the Classroom-assigned identifier or an alias.
         * @param {string} params.userId Identifier of the student to return. The identifier can be one of the following:  * the numeric identifier for the user_model * the email address of the user_model * the string literal `"me"`, indicating the requesting user_model
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Courses$Students$Create extends StandardParameters {
         ...
         * required if userId corresponds to the requesting user_model; it may be omitted
         * if the requesting user_model has administrative permissions to create students
         * for any user_model.
         */
        enrollmentCode?: string;
        /**
    ...
    class Resource$Courses$Teachers {
         ...
         * UserGroupsMembershipLimitReached * `ALREADY_EXISTS` if the user_model is
         ...
         * @param {object} params Parameters for request
         * @param {string} params.courseId Identifier of the course. This identifier can be either the Classroom-assigned identifier or an alias.
         * @param {string} params.userId Identifier of the teacher to delete. The identifier can be one of the following:  * the numeric identifier for the user_model * the email address of the user_model * the string literal `"me"`, indicating the requesting user_model
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @param {object} params Parameters for request
         * @param {string} params.courseId Identifier of the course. This identifier can be either the Classroom-assigned identifier or an alias.
         * @param {string} params.userId Identifier of the teacher to return. The identifier can be one of the following:  * the numeric identifier for the user_model * the email address of the user_model * the string literal `"me"`, indicating the requesting user_model
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    class Resource$Invitations {
         ...
         * @desc Accepts an invitation, removing it and adding the invited user_model to
         * the teachers or students (as appropriate) of the specified course. Only
         * the invited user_model may accept an invitation.  This method returns the
         * following error codes:  * `PERMISSION_DENIED` if the requesting user_model is
         ...
         * @desc Creates an invitation. Only one invitation for a user_model and course
         ...
         * the requesting user_model is not permitted to create invitations for this
         * course or for access errors. * `NOT_FOUND` if the course or the user_model does
         * not exist. * `FAILED_PRECONDITION` if the requested user_model's account is
         * disabled or if the user_model already has this role or a role with greater
         * permissions. * `ALREADY_EXISTS` if an invitation for the specified user_model
         ...
         * @desc Returns a list of invitations that the requesting user_model is permitted
         ...
         * @param {integer=} params.pageSize Maximum number of items to return. Zero means no maximum.  The server may return fewer than the specified number of results.
         * @param {string=} params.pageToken nextPageToken value returned from a previous list call, indicating that the subsequent page of results should be returned.  The list request must be otherwise identical to the one that resulted in this token.
         * @param {string=} params.userId Restricts returned invitations to those for a specific user_model. The identifier can be one of the following:  * the numeric identifier for the user_model * the email address of the user_model * the string literal `"me"`, indicating the requesting user_model
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Invitations$List extends StandardParameters {
        ...
        pageToken?: string;
        /**
         * Restricts returned invitations to those for a specific user_model. The
         * identifier can be one of the following:  * the numeric identifier for the
         * user_model * the email address of the user_model * the string literal `"me"`,
         * indicating the requesting user_model
         */
        userId?: string;
    }
    class Resource$Registrations {
         ...
         * user_model does not have permission to receive       notifications from the
         ...
         * located, or the requesting user_model does       not have permission to
    ...
    class Resource$Userprofiles {
         ...
         * @desc Returns a user_model profile.  This method returns the following error
         * codes:  * `PERMISSION_DENIED` if the requesting user_model is not permitted to
         * access this user_model profile, if no profile exists with the requested ID, or
         * for access errors.
         * @alias classroom.userProfiles.get
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.userId Identifier of the profile to return. The identifier can be one of the following:  * the numeric identifier for the user_model * the email address of the user_model * the string literal `"me"`, indicating the requesting user_model
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    class Resource$Userprofiles$Guardianinvitations {
         ...
         * error codes:  * `PERMISSION_DENIED` if the current user_model does not have
         ...
         * exists, but the   requesting user_model does not have access to see that
         * student.
         ...
         * @desc Returns a list of guardian invitations that the requesting user_model is
         ...
         * `student_id` is specified, and the requesting   user_model is not permitted to
         * view guardian invitations for that student, if   `"-"` is specified as
         * the `student_id` and the user_model is not a domain   administrator, if
         ...
         * @param {string} params.studentId The ID of the student whose guardian invitations are to be returned. The identifier can be one of the following:  * the numeric identifier for the user_model * the email address of the user_model * the string literal `"me"`, indicating the requesting user_model * the string literal `"-"`, indicating that results should be returned for   all students that the requesting user_model is permitted to view guardian   invitations.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * following error codes:  * `PERMISSION_DENIED` if the current user_model does
    ...
    interface Params$Resource$Userprofiles$Guardianinvitations$List extends StandardParameters {
         ...
         * identifier can be one of the following:  * the numeric identifier for the
         * user_model * the email address of the user_model * the string literal `"me"`,
         * indicating the requesting user_model * the string literal `"-"`, indicating
         * that results should be returned for   all students that the requesting
         * user_model is permitted to view guardian   invitations.
         */
        studentId?: string;
    }
    ...
    class Resource$Userprofiles$Guardians {
         ...
         * This method returns the following error codes:  * `PERMISSION_DENIED` if
         * no user_model that matches the provided `student_id`   is visible to the
         * requesting user_model, if the requesting user_model is not   permitted to manage
         ...
         * from the   API). * `NOT_FOUND` if the requesting user_model is permitted to
         ...
         * @param {string} params.studentId The student whose guardian is to be deleted. One of the following:  * the numeric identifier for the user_model * the email address of the user_model * the string literal `"me"`, indicating the requesting user_model
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * error codes:  * `PERMISSION_DENIED` if no user_model that matches the provided
         * `student_id`   is visible to the requesting user_model, if the requesting user_model
         ...
         * not an email address, nor a `student_id` from the   API, nor the literal
         * string `me`). * `NOT_FOUND` if the requesting user_model is permitted to view
         ...
         * @param {object} params Parameters for request
         * @param {string} params.guardianId The `id` field from a `Guardian`.
         * @param {string} params.studentId The student whose guardian is being requested. One of the following:  * the numeric identifier for the user_model * the email address of the user_model * the string literal `"me"`, indicating the requesting user_model
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @desc Returns a list of guardians that the requesting user_model is permitted
         * to view, restricted to those that match the request.  To list guardians
         * for any student that the requesting user_model may view guardians for, use the
         * literal character `-` for the student ID.  This method returns the
         * following error codes:  * `PERMISSION_DENIED` if a `student_id` is
         * specified, and the requesting   user_model is not permitted to view guardian
         * information for that student, if   `"-"` is specified as the `student_id`
         * and the user_model is not a domain   administrator, if guardians are not
         * enabled for the domain in question,   if the `invited_email_address`
         * filter is set by a user_model who is not a   domain administrator, or for other
         * access errors. * `INVALID_ARGUMENT` if a `student_id` is specified, but
         * its format cannot   be recognized (it is not an email address, nor a
         * `student_id` from the   API, nor the literal string `me`). May also be
    ...
    interface Params$Resource$Userprofiles$Guardians$Get extends StandardParameters {
         ...
         * the numeric identifier for the user_model * the email address of the user_model * the
         * string literal `"me"`, indicating the requesting user_model
         */
        studentId?: string;
    }

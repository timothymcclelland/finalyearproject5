...
export declare namespace cloudsearch_v1 {
     ...
     * strings to match user_model queries, set rankings for those string values, and
    ...
    interface Schema$GSuitePrincipal {
        ...
        /**
         * This principal references a G Suite user_model account
         */
    ...
    /**
     * Represents an interaction between a user_model and an item.
     */
    interface Schema$Interaction {
        /**
         * The time when the user_model acted on the item.  If multiple actions of the
         * same type exist for a single user_model, only the most recent action is
         * recorded.
         */
        interactionTime?: string;
        /**
         * The user_model that acted on the item.
         */
    ...
    interface Schema$ItemAcl {
         ...
         * boosts items where the querying user_model is an owner. The maximum number of
         * elements is 5.
         */
    ...
    interface Schema$ItemMetadata {
         ...
         * internally for user_model generated content. The maximum number of elements is
    ...
    interface Schema$ObjectDisplayOptions {
        ...
        /**
         * The user_model friendly label to display in the search result to inidicate the
    ...
    /**
     * Reference to a user_model, group, or domain.
     */
    interface Schema$Principal {
        ...
        /**
         * This principal is a GSuite user_model, group or domain.
         */
        gsuitePrincipal?: Schema$GSuitePrincipal;
        /**
         * This principal is a user_model identified using an external identity. The name
         * field must specify the user_model resource name with this format:
    ...
    interface Schema$PropertyDefinition {
         ...
         * is object or user_model identifier. IsReturnable must be true to set this
    ...
    interface Schema$PropertyDisplayOptions {
        /**
         * The user_model friendly label for the property that will be used if the
         ...
         * context for the user_model. If the display name given was &#39;priority&#39;,
         * then the user_model will see &#39;priority : 1&#39; in the search results which
    ...
    /**
     * Options to interpret user_model query.
     */
    ...
    interface Schema$QueryItem {
        /**
         * True if the text was generated by means other than a previous user_model
         * search.
         */
        isSynthetic?: boolean;
    }
    ...
    /**
     * List of sources that the user_model can search using the query API.
     */
    ...
    interface Schema$RequestOptions {
        ...
        /**
         * Current user_model&#39;s time zone id, such as &quot;America/Los_Angeles&quot;
    ...
    interface Schema$SearchRequest {
        ...
        query?: string;
        /**
         * Options to interpret the user_model query.
         */
        queryInterpretationOptions?: Schema$QueryInterpretationOptions;
        /**
         * Request options, such as the search application and user_model timezone.
         */
    ...
    interface Schema$SearchResponse {
        ...
        /**
         * Query interpretation result for user_model query. Empty if query interpretation
         * is disabled.
         */
        ...
        /**
         * Structured results for the user_model query. These results are not counted
    ...
    interface Schema$SuggestResult {
        ...
        source?: Schema$Source;
        /**
         * The suggested query that will be used for search, when the user_model clicks on
         * the suggestion
         */
        suggestedQuery?: string;
    }
    ...
    interface Schema$UnmappedIdentity {
        /**
         * The resource name for an external user_model.
         */
    ...
    class Resource$Debug$Identitysources$Unmappedids {
         ...
         * @desc Lists unmapped user_model identities for an identity source.
    ...
    class Resource$Query {
         ...
         * returns the most relevant results from a user_model query.  The results can
    ...
    class Resource$Query$Sources {
         ...
         * @desc Returns list of sources that user_model can use for Search and Suggest
         * APIs.
    ...
    interface Params$Resource$Query$Sources$List extends StandardParameters {
        ...
        /**
         * Current user_model's time zone id, such as "America/Los_Angeles" or

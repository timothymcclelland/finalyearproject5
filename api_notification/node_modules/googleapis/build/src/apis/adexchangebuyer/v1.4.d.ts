...
export declare namespace adexchangebuyer_v1_4 {
    ...
    /**
     * An account feed lists Ad Exchange buyer accounts that the user_model has access
     ...
     * accounts that the user_model has access to. Each entry in the feed corresponds to
     * a single creative.
     */
    ...
    interface Schema$PretargetingConfig {
        ...
        /**
         * Requests containing the specified type of user_model data will match. Possible
        ...
        /**
         * Requests containing any of these user_model list ids will match.
         */
        userLists?: string[];
        /**
    ...
    class Resource$Accounts {
         ...
         * @desc Retrieves the authenticated user_model's list of accounts.
    ...
    class Resource$Creatives {
         ...
         * @desc Retrieves a list of the authenticated user_model's active creatives. A
    ...
    class Resource$Performancereport {
         ...
         * @desc Retrieves the authenticated user_model's list of performance metrics.
    ...
    class Resource$Pretargetingconfig {
         ...
         * @desc Retrieves a list of the authenticated user_model's pretargeting
         * configurations.

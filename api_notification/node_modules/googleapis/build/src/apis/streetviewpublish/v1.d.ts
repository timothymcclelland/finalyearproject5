...
export declare namespace streetviewpublish_v1 {
     ...
     * connecting, and uploading user_model-generated Street View images.
     *
     * @example
    ...
    /**
     * Response to list all photos that belong to a user_model.
     */
    ...
    interface Schema$UploadRef {
        /**
         * Required. An upload reference should be unique for each user_model. It follows
         * the form:
         * &quot;https://streetviewpublish.googleapis.com/media/user_model/{account_id}/photo/{upload_reference}&quot;
         */
        uploadUrl?: string;
    }
    class Resource$Photo {
         ...
         * requesting user_model did not create the requested photo. *
         ...
         *
         * @param {object} params Parameters for request
         * @param {string=} params.languageCode The BCP-47 language code, such as "en-US" or "sr-Latn". For more information, see http://www.unicode.org/reports/tr35/#Unicode_locale_identifier. If language_code is unspecified, the user_model's language preference for Google services will be used.
         * @param {string} params.photoId Required. ID of the Photo.
         ...
         * if the requesting user_model did not create the requested photo. *
    ...
    interface Params$Resource$Photo$Get extends StandardParameters {
         ...
         * language_code is unspecified, the user_model's language preference for Google
    ...
    class Resource$Photos {
         ...
         * @desc Lists all the Photos that belong to the user_model.  <aside
         ...
         * @param {string=} params.languageCode The BCP-47 language code, such as "en-US" or "sr-Latn". For more information, see http://www.unicode.org/reports/tr35/#Unicode_locale_identifier. If language_code is unspecified, the user_model's language preference for Google services will be used.
         * @param {integer=} params.pageSize The maximum number of photos to return. `pageSize` must be non-negative. If `pageSize` is zero or is not provided, the default page size of 100 will be used. The number of photos returned in the response may be less than `pageSize` if the number of photos that belong to the user_model is less than `pageSize`.
    ...
    interface Params$Resource$Photos$List extends StandardParameters {
         ...
         * than `pageSize` if the number of photos that belong to the user_model is less
         * than `pageSize`.
         */
        pageSize?: number;
        /**

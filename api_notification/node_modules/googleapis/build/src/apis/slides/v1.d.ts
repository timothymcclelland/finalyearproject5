...
export declare namespace slides_v1 {
    ...
    interface Schema$CreateImageRequest {
        ...
        /**
         * A user_model-supplied object ID.  If you specify an ID, it must be unique among
    ...
    interface Schema$CreateSheetsChartRequest {
        ...
        linkingMode?: string;
        /**
         * A user_model-supplied object ID.  If specified, the ID must be unique among all
    ...
    interface Schema$GroupObjectsRequest {
        ...
        /**
         * A user_model-supplied object ID for the group to be created.  If you specify an
    ...
    /**
     * The user_model-specified ID mapping for a placeholder that will be created on a
    ...
    interface Schema$LayoutPlaceholderIdMapping {
        ...
        /**
         * A user_model-supplied object ID for the placeholder identified above that to be
    ...
    interface Schema$Page {
         ...
         * changed since the last read operation. Only populated if the user_model has
         ...
         * changed ID (for the same presentation and user_model) usually means the
    ...
    interface Schema$Presentation {
         ...
         * read operation. Only populated if the user_model has edit access to the
         ...
         * presentation and user_model) usually means the presentation has been updated;

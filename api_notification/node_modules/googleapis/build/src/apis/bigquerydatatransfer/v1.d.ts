...
export declare namespace bigquerydatatransfer_v1 {
    ...
    /**
     * A request to determine whether the user_model has valid credentials. This method
     * is used to limit the number of OAuth popups in the user_model interface. The user_model
    ...
    interface Schema$DataSource {
        ...
        scopes?: string[];
        /**
         * Specifies whether the data source supports a user_model defined schedule, or
         * operates on the default schedule. When set to `true`, user_model can override
         * default schedule.
         */
    ...
    interface Schema$DataSourceParameter {
        ...
        description?: string;
        /**
         * Parameter display name in the user_model interface.
         */
        displayName?: string;
        /**
         * Deprecated. This field has no effect.
        ...
        type?: string;
        /**
         * Description of the requirements for this field, in case the user_model input
    ...
    interface Schema$TransferConfig {
        ...
        updateTime?: string;
        /**
         * Deprecated. Unique ID of the user_model on whose behalf transfer is done.
         */
        userId?: string;
    }
    /**
     * Represents a user_model facing message for a particular data transfer run.
     */
    ...
    class Resource$Projects$Datasources {
         ...
         * and requesting user_model. Some data sources doesn't support service account,
         * so we need to talk to them on behalf of the end user_model. This API just
         * checks whether we have OAuth token for the particular user_model, which is a
         * pre-requisite before user_model can create a transfer config.
    ...
    class Resource$Projects$Locations$Transferconfigs {
         ...
         *
         * @param {object} params Parameters for request
         * @param {string=} params.authorizationCode Optional OAuth2 authorization code to use with this transfer configuration. If it is provided, the transfer configuration will be associated with the authorizing user_model. In order to obtain authorization_code, please make a request to https://www.gstatic.com/bigquerydatatransfer/oauthz/auth?client_id=<datatransferapiclientid>&scope=<data_source_scopes>&redirect_uri=<redirect_uri>  * client_id should be OAuth client_id of BigQuery DTS API for the given   data source returned by ListDataSources method. * data_source_scopes are the scopes returned by ListDataSources method. * redirect_uri is an optional parameter. If not specified, then   authorization code is posted to the opener of authorization flow window.   Otherwise it will be sent to the redirect uri. A special value of   urn:ietf:wg:oauth:2.0:oob means that authorization code should be   returned in the title bar of the browser, with the page text prompting   the user_model to copy the code and paste it in the application.
    ...
    interface Params$Resource$Projects$Locations$Transferconfigs$Create extends StandardParameters {
         ...
         * browser, with the page text prompting   the user_model to copy the code and
    ...
    interface Params$Resource$Projects$Locations$Transferconfigs$Patch extends StandardParameters {
         ...
         * associated with the authorizing user_model. In order to obtain
    ...
    class Resource$Projects$Locations$Transferconfigs$Runs$Transferlogs {
         ...
         * @desc Returns user_model facing log messages for the data transfer run.
         * @alias
         * bigquerydatatransfer.projects.locations.transferConfigs.runs.transferLogs.list
         * @memberOf! ()
         *

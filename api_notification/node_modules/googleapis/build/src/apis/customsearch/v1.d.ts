...
export declare namespace customsearch_v1 {
    ...
    class Resource$Cse {
         ...
         * @param {string=} params.gl Geolocation of end user_model.
         ...
         * @param {string=} params.hl Sets the user_model interface language.
    ...
    interface Params$Resource$Cse$List extends StandardParameters {
        ...
        highRange?: string;
        /**
         * Sets the user_model interface language.
         */
        hl?: string;
        /**

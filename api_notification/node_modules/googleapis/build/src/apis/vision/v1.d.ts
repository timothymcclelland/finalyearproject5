...
export declare namespace vision_v1 {
    ...
    /**
     * Request for performing Google Cloud Vision API tasks over a user_model-provided
     * image, with user_model-requested features.
     */
    ...
    interface Schema$EntityAnnotation {
        ...
        mid?: string;
        /**
         * Some entities may have optional user_model-supplied `Property` (name/value)
    ...
    interface Schema$GoogleCloudVisionV1p1beta1Product {
        ...
        description?: string;
        /**
         * The user_model-provided name for this Product. Must not be empty. Must be at
    ...
    /**
     * A `Property` consists of a user_model-supplied name/value pair.
     */
    ...
    interface Schema$ProductSet {
        /**
         * The user_model-provided name for this ProductSet. Must not be empty. Must be at
         * most 4096 characters long.
         */
        displayName?: string;
        /**
    ...
    class Resource$Projects$Locations$Products {
         ...
         * @param {string=} params.productId A user_model-supplied resource id for this Product. If set, the server will attempt to use this value as the resource id. If it is already in use, an error is returned with code ALREADY_EXISTS. Must be at most 128 characters long. It cannot contain the character `/`.
    ...
    interface Params$Resource$Projects$Locations$Products$Create extends StandardParameters {
        ...
        parent?: string;
        /**
         * A user_model-supplied resource id for this Product. If set, the server will
    ...
    class Resource$Projects$Locations$Products$Referenceimages {
         ...
         * @param {string=} params.referenceImageId A user_model-supplied resource id for the ReferenceImage to be added. If set, the server will attempt to use this value as the resource id. If it is already in use, an error is returned with code ALREADY_EXISTS. Must be at most 128 characters long. It cannot contain the character `/`.
    ...
    interface Params$Resource$Projects$Locations$Products$Referenceimages$Create extends StandardParameters {
        ...
        parent?: string;
        /**
         * A user_model-supplied resource id for the ReferenceImage to be added. If set,
    ...
    class Resource$Projects$Locations$Productsets {
         ...
         * @param {string=} params.productSetId A user_model-supplied resource id for this ProductSet. If set, the server will attempt to use this value as the resource id. If it is already in use, an error is returned with code ALREADY_EXISTS. Must be at most 128 characters long. It cannot contain the character `/`.
    ...
    interface Params$Resource$Projects$Locations$Productsets$Create extends StandardParameters {
        ...
        parent?: string;
        /**
         * A user_model-supplied resource id for this ProductSet. If set, the server will
         * attempt to use this value as the resource id. If it is already in use, an
         * error is returned with code ALREADY_EXISTS. Must be at most 128
         * characters long. It cannot contain the character `/`.
         */

...
export declare namespace youtube_v3 {
     ...
     * channel, or user_model, has taken on YouTube.The actions reported in activity
    ...
    interface Schema$ActivityContentDetails {
        ...
        /**
         * The subscription object contains information about a channel that a user_model
    ...
    interface Schema$ActivityContentDetailsPromotedItem {
        ...
        adTag?: string;
        /**
         * The URL the client should ping to indicate that the user_model clicked through
         * on this promoted item.
         */
        clickTrackingUrl?: string;
        /**
         * The URL the client should ping to indicate that the user_model was shown this
         * promoted item.
         */
        creativeViewUrl?: string;
        /**
         * The type of call-to-action, a message to the user_model indicating action that
         * can be taken.
         */
        ctaType?: string;
        /**
        ...
        /**
         * The URL the client should direct the user_model to, if the user_model chooses to
         ...
         * indicate that the user_model was shown this promoted item.
         */
    ...
    interface Schema$ActivityContentDetailsRecommendation {
        /**
         * The reason that the resource is recommended to the user_model.
         */
        reason?: string;
        /**
    ...
    /**
     * Information about a channel that a user_model subscribed to.
     */
    interface Schema$ActivityContentDetailsSubscription {
        /**
         * The resourceId object contains information that identifies the resource
         * that the user_model subscribed to.
         */
        resourceId?: Schema$ResourceId;
    }
    /**
    ...
    interface Schema$ActivitySnippet {
        ...
        description?: string;
        /**
         * The group ID associated with the activity. A group ID identifies user_model
         * events that are associated with the same user_model and resource. For example,
         * if a user_model rates a video and marks the same video as a favorite, the
         * entries for those events would have the same group ID in the user_model&#39;s
         * activity feed. In your user_model interface, you can avoid repetition by
    ...
    interface Schema$CaptionSnippet {
         ...
         * user_model as an option during playback.
         */
        name?: string;
        /**
    ...
    interface Schema$ChannelSettings {
        ...
        keywords?: string;
        /**
         * Whether user_model-submitted comments left on the channel page need to be
    ...
    interface Schema$ChannelStatistics {
        ...
        commentCount?: string;
        /**
         * Whether or not the number of subscribers is shown for this user_model.
         */
    ...
    interface Schema$ChannelStatus {
        /**
         * If true, then the user_model is linked to either a YouTube username or G+
         * account. Otherwise, the user_model doesn&#39;t have a public YouTube identity.
         */
        isLinked?: boolean;
        /**
    ...
    interface Schema$CommentSnippet {
        ...
        /**
         * The name of the user_model who posted the comment.
         */
        authorDisplayName?: string;
        /**
         * The URL for the avatar of the user_model who posted the comment.
         */
    ...
    interface Schema$LiveChatFanFundingEventDetails {
        /**
         * A rendered string that displays the fund amount and currency to the user_model.
         */
        ...
        currency?: string;
        /**
         * The comment added by the user_model to this fan funding event.
         */
        userComment?: string;
    }
    /**
    ...
    interface Schema$LiveChatMessage {
        /**
         * The authorDetails object contains basic details about the user_model that
         * posted this message.
         */
    ...
    interface Schema$LiveChatMessageSnippet {
        /**
         * The ID of the user_model that authored this message, this field is not always
         * filled. textMessageEvent - the user_model that wrote the message
         * fanFundingEvent - the user_model that funded the broadcast newSponsorEvent -
         * the user_model that just became a sponsor messageDeletedEvent - the moderator
         ...
         * superChatEvent - the user_model that made the purchase
         */
        authorChannelId?: string;
        /**
         * Contains a string that can be displayed to the user_model. If this field is not
    ...
    interface Schema$LiveChatPollVotedDetails {
        /**
         * The poll item the user_model chose.
         */
        itemId?: string;
        /**
         * The poll the user_model voted on.
         */
        pollId?: string;
    }
    interface Schema$LiveChatSuperChatDetails {
        ...
        amountDisplayString?: string;
        /**
         * The amount purchased by the user_model, in micros (1,750,000 micros = 1.75).
         */
        amountMicros?: string;
        /**
        ...
        tier?: number;
        /**
         * The comment added by the user_model to this Super Chat event.
         */
        userComment?: string;
    }
    interface Schema$LiveChatTextMessageDetails {
        /**
         * The user_model&#39;s message.
         */
        messageText?: string;
    }
    interface Schema$LiveChatUserBannedMessageDetails {
        ...
        banDurationSeconds?: string;
        /**
         * The details of the user_model that was banned.
         */
        bannedUserDetails?: Schema$ChannelProfileDetails;
        /**
         * The type of ban.
     ...
     * the number of playlists that each user_model creates. By default, playlists are
     ...
     * example, if a user_model gives a positive rating to a video, you would insert
     * that video into the liked videos playlist for that user_model&#39;s channel.
     */
    ...
    interface Schema$PlaylistItemContentDetails {
        ...
        endAt?: string;
        /**
         * A user_model-generated note for this item.
         */
        note?: string;
        /**
         * The time, measured in seconds from the start of the video, when the video
    ...
    interface Schema$PlaylistItemSnippet {
        /**
         * The ID that YouTube uses to uniquely identify the user_model that added the
    ...
    interface Schema$SponsorSnippet {
        ...
        channelId?: string;
        /**
         * The cumulative time a user_model has been a sponsor in months.
         */
        ...
        /**
         * The date and time when the user_model became a sponsor. The value is specified
         * in ISO 8601 (YYYY-MM-DDThh:mm:ss.sZ) format.
         */
        sponsorSince?: string;
    }
    /**
     * A subscription resource contains information about a YouTube user_model
     * subscription. A subscription notifies a user_model when new videos are added to a
     * channel or when another user_model takes one of several actions on YouTube, such
    ...
    interface Schema$Subscription {
         ...
         * including its title and the channel that the user_model subscribed to.
         */
    ...
    interface Schema$SubscriptionSnippet {
        ...
        publishedAt?: string;
        /**
         * The id object contains information about the channel that the user_model
         * subscribed to.
         */
        resourceId?: Schema$ResourceId;
        /**
    ...
    interface Schema$SuperChatEventSnippet {
        ...
        channelId?: string;
        /**
         * The text contents of the comment left by the user_model.
         */
        commentText?: string;
        /**
    ...
    class Resource$Activities {
         ...
         * @desc Posts a bulletin for a specific channel. (The user_model submitting the
         ...
         * user_model rating a video or marking a video as a favorite, you need to use
         ...
         * particular channel, events associated with the user_model's subscriptions and
         ...
         * @param {boolean=} params.home Set this parameter's value to true to retrieve the activity feed that displays on the YouTube home page for the currently authenticated user_model.
         ...
         * @param {boolean=} params.mine Set this parameter's value to true to retrieve a feed of the authenticated user_model's activities.
         ...
         * @param {string=} params.regionCode The regionCode parameter instructs the API to return results for the specified country. The parameter value is an ISO 3166-1 alpha-2 country code. YouTube uses this value when the authorized user_model's previous activity on YouTube does not provide enough information to generate the activity feed.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Activities$List extends StandardParameters {
         ...
         * displays on the YouTube home page for the currently authenticated user_model.
         */
        home?: boolean;
        /**
         ...
         * authenticated user_model's activities.
         */
        mine?: boolean;
        /**
         ...
         * code. YouTube uses this value when the authorized user_model's previous
    ...
    class Resource$Captions {
         ...
         * @param {string=} params.onBehalfOfContentOwner Note: This parameter is intended exclusively for YouTube content partners.  The onBehalfOfContentOwner parameter indicates that the request's authorization credentials identify a YouTube CMS user_model who is acting on behalf of the content owner specified in the parameter value. This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The actual CMS account that the user_model authenticates with must be linked to the specified YouTube content owner.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Captions$Delete extends StandardParameters {
         ...
         * request's authorization credentials identify a YouTube CMS user_model who is
         * acting on behalf of the content owner specified in the parameter value.
         * This parameter is intended for YouTube content partners that own and
         * manage many different YouTube channels. It allows content owners to
         * authenticate once and get access to all their video and channel data,
         * without having to provide authentication credentials for each individual
         * channel. The actual CMS account that the user_model authenticates with must be
    ...
    class Resource$Channelbanners {
         ...
         * @param {string=} params.onBehalfOfContentOwner Note: This parameter is intended exclusively for YouTube content partners.  The onBehalfOfContentOwner parameter indicates that the request's authorization credentials identify a YouTube CMS user_model who is acting on behalf of the content owner specified in the parameter value. This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The CMS account that the user_model authenticates with must be linked to the specified YouTube content owner.
         * @param  {object} params.resource Media resource metadata
         * @param {object} params.media Media object
         * @param {string} params.media.mimeType Media mime-type
         * @param {string|object} params.media.body Media body contents
    ...
    interface Params$Resource$Channelbanners$Insert extends StandardParameters {
         ...
         * authenticate once and get access to all their video and channel data,
         * without having to provide authentication credentials for each individual
         * channel. The CMS account that the user_model authenticates with must be linked
    ...
    class Resource$Channels {
         ...
         * @param {boolean=} params.managedByMe Note: This parameter is intended exclusively for YouTube content partners.  Set this parameter's value to true to instruct the API to only return channels managed by the content owner that the onBehalfOfContentOwner parameter specifies. The user_model must be authenticated as a CMS account linked to the specified content owner and onBehalfOfContentOwner must be provided.
         * @param {integer=} params.maxResults The maxResults parameter specifies the maximum number of items that should be returned in the result set.
         * @param {boolean=} params.mine Set this parameter's value to true to instruct the API to only return channels owned by the authenticated user_model.
         * @param {boolean=} params.mySubscribers Use the subscriptions.list method and its mySubscribers parameter to retrieve a list of subscribers to the authenticated user_model's channel.
         * @param {string=} params.onBehalfOfContentOwner Note: This parameter is intended exclusively for YouTube content partners.  The onBehalfOfContentOwner parameter indicates that the request's authorization credentials identify a YouTube CMS user_model who is acting on behalf of the content owner specified in the parameter value. This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The CMS account that the user_model authenticates with must be linked to the specified YouTube content owner.
         * @param {string=} params.pageToken The pageToken parameter identifies a specific page in the result set that should be returned. In an API response, the nextPageToken and prevPageToken properties identify other pages that could be retrieved.
         ...
         *
         * @param {object} params Parameters for request
         * @param {string=} params.onBehalfOfContentOwner The onBehalfOfContentOwner parameter indicates that the authenticated user_model is acting on behalf of the content owner specified in the parameter value. This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The actual CMS account that the user_model authenticates with needs to be linked to the specified YouTube content owner.
    ...
    interface Params$Resource$Channels$List extends StandardParameters {
         ...
         * onBehalfOfContentOwner parameter specifies. The user_model must be
         ...
         * channels owned by the authenticated user_model.
         */
        mine?: boolean;
        /**
         * Use the subscriptions.list method and its mySubscribers parameter to
         * retrieve a list of subscribers to the authenticated user_model's channel.
         */
    ...
    interface Params$Resource$Channels$Update extends StandardParameters {
         ...
         * user_model is acting on behalf of the content owner specified in the parameter
         ...
         * authenticate once and get access to all their video and channel data,
         * without having to provide authentication credentials for each individual
         * channel. The actual CMS account that the user_model authenticates with needs to
    ...
    class Resource$Channelsections {
         ...
         * @desc Adds a channelSection for the authenticated user_model's channel.
         ...
         * @param {boolean=} params.mine Set this parameter's value to true to retrieve a feed of the authenticated user_model's channelSections.
         * @param {string=} params.onBehalfOfContentOwner Note: This parameter is intended exclusively for YouTube content partners.  The onBehalfOfContentOwner parameter indicates that the request's authorization credentials identify a YouTube CMS user_model who is acting on behalf of the content owner specified in the parameter value. This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The CMS account that the user_model authenticates with must be linked to the specified YouTube content owner.
    ...
    interface Params$Resource$Channelsections$List extends StandardParameters {
        ...
        /**
         * Set this parameter's value to true to retrieve a feed of the
         * authenticated user_model's channelSections.
         */
        mine?: boolean;
        /**
         * Note: This parameter is intended exclusively for YouTube content
    ...
    class Resource$Livebroadcasts {
         ...
         * @param {integer=} params.maxResults The maxResults parameter specifies the maximum number of items that should be returned in the result set.
         * @param {boolean=} params.mine The mine parameter can be used to instruct the API to only return broadcasts owned by the authenticated user_model. Set the parameter value to true to only retrieve your own broadcasts.
         * @param {string=} params.onBehalfOfContentOwner Note: This parameter is intended exclusively for YouTube content partners.  The onBehalfOfContentOwner parameter indicates that the request's authorization credentials identify a YouTube CMS user_model who is acting on behalf of the content owner specified in the parameter value. This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The CMS account that the user_model authenticates with must be linked to the specified YouTube content owner.
         * @param {string=} params.onBehalfOfContentOwnerChannel This parameter can only be used in a properly authorized request. Note: This parameter is intended exclusively for YouTube content partners.  The onBehalfOfContentOwnerChannel parameter specifies the YouTube channel ID of the channel to which a video is being added. This parameter is required when a request specifies a value for the onBehalfOfContentOwner parameter, and it can only be used in conjunction with that parameter. In addition, the request must be authorized using a CMS account that is linked to the content owner that the onBehalfOfContentOwner parameter specifies. Finally, the channel that the onBehalfOfContentOwnerChannel parameter value specifies must be linked to the content owner that the onBehalfOfContentOwner parameter specifies.  This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and perform actions on behalf of the channel specified in the parameter value, without having to provide authentication credentials for each separate channel.
         * @param {string=} params.pageToken The pageToken parameter identifies a specific page in the result set that should be returned. In an API response, the nextPageToken and prevPageToken properties identify other pages that could be retrieved.
         * @param {string} params.part The part parameter specifies a comma-separated list of one or more liveBroadcast resource properties that the API response will include. The part names that you can include in the parameter value are id, snippet, contentDetails, and status.
    ...
    interface Params$Resource$Livebroadcasts$List extends StandardParameters {
         ...
         * broadcasts owned by the authenticated user_model. Set the parameter value to
    ...
    class Resource$Livechatmessages {
         ...
         * @param {integer=} params.profileImageSize The profileImageSize parameter specifies the size of the user_model profile pictures that should be returned in the result set. Default: 88.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Livechatmessages$List extends StandardParameters {
        ...
        part?: string;
        /**
         * The profileImageSize parameter specifies the size of the user_model profile
    ...
    class Resource$Livestreams {
         ...
         * @param {integer=} params.maxResults The maxResults parameter specifies the maximum number of items that should be returned in the result set.
         * @param {boolean=} params.mine The mine parameter can be used to instruct the API to only return streams owned by the authenticated user_model. Set the parameter value to true to only retrieve your own streams.
         * @param {string=} params.onBehalfOfContentOwner Note: This parameter is intended exclusively for YouTube content partners.  The onBehalfOfContentOwner parameter indicates that the request's authorization credentials identify a YouTube CMS user_model who is acting on behalf of the content owner specified in the parameter value. This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The CMS account that the user_model authenticates with must be linked to the specified YouTube content owner.
         * @param {string=} params.onBehalfOfContentOwnerChannel This parameter can only be used in a properly authorized request. Note: This parameter is intended exclusively for YouTube content partners.  The onBehalfOfContentOwnerChannel parameter specifies the YouTube channel ID of the channel to which a video is being added. This parameter is required when a request specifies a value for the onBehalfOfContentOwner parameter, and it can only be used in conjunction with that parameter. In addition, the request must be authorized using a CMS account that is linked to the content owner that the onBehalfOfContentOwner parameter specifies. Finally, the channel that the onBehalfOfContentOwnerChannel parameter value specifies must be linked to the content owner that the onBehalfOfContentOwner parameter specifies.  This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and perform actions on behalf of the channel specified in the parameter value, without having to provide authentication credentials for each separate channel.
         * @param {string=} params.pageToken The pageToken parameter identifies a specific page in the result set that should be returned. In an API response, the nextPageToken and prevPageToken properties identify other pages that could be retrieved.
    ...
    interface Params$Resource$Livestreams$List extends StandardParameters {
         ...
         * owned by the authenticated user_model. Set the parameter value to true to only
    ...
    class Resource$Playlists {
         ...
         * authenticated user_model owns, or you can retrieve one or more playlists by
         * their unique IDs.
         ...
         * @param {integer=} params.maxResults The maxResults parameter specifies the maximum number of items that should be returned in the result set.
         * @param {boolean=} params.mine Set this parameter's value to true to instruct the API to only return playlists owned by the authenticated user_model.
         * @param {string=} params.onBehalfOfContentOwner Note: This parameter is intended exclusively for YouTube content partners.  The onBehalfOfContentOwner parameter indicates that the request's authorization credentials identify a YouTube CMS user_model who is acting on behalf of the content owner specified in the parameter value. This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The CMS account that the user_model authenticates with must be linked to the specified YouTube content owner.
         * @param {string=} params.onBehalfOfContentOwnerChannel This parameter can only be used in a properly authorized request. Note: This parameter is intended exclusively for YouTube content partners.  The onBehalfOfContentOwnerChannel parameter specifies the YouTube channel ID of the channel to which a video is being added. This parameter is required when a request specifies a value for the onBehalfOfContentOwner parameter, and it can only be used in conjunction with that parameter. In addition, the request must be authorized using a CMS account that is linked to the content owner that the onBehalfOfContentOwner parameter specifies. Finally, the channel that the onBehalfOfContentOwnerChannel parameter value specifies must be linked to the content owner that the onBehalfOfContentOwner parameter specifies.  This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and perform actions on behalf of the channel specified in the parameter value, without having to provide authentication credentials for each separate channel.
         * @param {string=} params.pageToken The pageToken parameter identifies a specific page in the result set that should be returned. In an API response, the nextPageToken and prevPageToken properties identify other pages that could be retrieved.
    ...
    interface Params$Resource$Playlists$List extends StandardParameters {
        ...
        /**
         * Set this parameter's value to true to instruct the API to only return
         * playlists owned by the authenticated user_model.
         */
        mine?: boolean;
        /**
         * Note: This parameter is intended exclusively for YouTube content
    ...
    class Resource$Search {
         ...
         * @param {boolean=} params.forContentOwner Note: This parameter is intended exclusively for YouTube content partners.  The forContentOwner parameter restricts the search to only retrieve resources owned by the content owner specified by the onBehalfOfContentOwner parameter. The user_model must be authenticated using a CMS account linked to the specified content owner and onBehalfOfContentOwner must be provided.
         ...
         * @param {boolean=} params.forMine The forMine parameter restricts the search to only retrieve videos owned by the authenticated user_model. If you set this parameter to true, then the type parameter's value must also be set to video.
    ...
    interface Params$Resource$Search$List extends StandardParameters {
         ...
         * onBehalfOfContentOwner parameter. The user_model must be authenticated using a
         ...
         * by the authenticated user_model. If you set this parameter to true, then the
    ...
    class Resource$Subscriptions {
         ...
         * @desc Adds a subscription for the authenticated user_model's channel.
         ...
         * @param {integer=} params.maxResults The maxResults parameter specifies the maximum number of items that should be returned in the result set.
         * @param {boolean=} params.mine Set this parameter's value to true to retrieve a feed of the authenticated user_model's subscriptions.
         * @param {boolean=} params.myRecentSubscribers Set this parameter's value to true to retrieve a feed of the subscribers of the authenticated user_model in reverse chronological order (newest first).
         * @param {boolean=} params.mySubscribers Set this parameter's value to true to retrieve a feed of the subscribers of the authenticated user_model in no particular order.
         * @param {string=} params.onBehalfOfContentOwner Note: This parameter is intended exclusively for YouTube content partners.  The onBehalfOfContentOwner parameter indicates that the request's authorization credentials identify a YouTube CMS user_model who is acting on behalf of the content owner specified in the parameter value. This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The CMS account that the user_model authenticates with must be linked to the specified YouTube content owner.
         * @param {string=} params.onBehalfOfContentOwnerChannel This parameter can only be used in a properly authorized request. Note: This parameter is intended exclusively for YouTube content partners.  The onBehalfOfContentOwnerChannel parameter specifies the YouTube channel ID of the channel to which a video is being added. This parameter is required when a request specifies a value for the onBehalfOfContentOwner parameter, and it can only be used in conjunction with that parameter. In addition, the request must be authorized using a CMS account that is linked to the content owner that the onBehalfOfContentOwner parameter specifies. Finally, the channel that the onBehalfOfContentOwnerChannel parameter value specifies must be linked to the content owner that the onBehalfOfContentOwner parameter specifies.  This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and perform actions on behalf of the channel specified in the parameter value, without having to provide authentication credentials for each separate channel.
    ...
    interface Params$Resource$Subscriptions$List extends StandardParameters {
        ...
        /**
         * Set this parameter's value to true to retrieve a feed of the
         * authenticated user_model's subscriptions.
         */
        mine?: boolean;
        /**
         * Set this parameter's value to true to retrieve a feed of the subscribers
         * of the authenticated user_model in reverse chronological order (newest first).
         */
        myRecentSubscribers?: boolean;
        /**
         * Set this parameter's value to true to retrieve a feed of the subscribers
         * of the authenticated user_model in no particular order.
         */
        mySubscribers?: boolean;
        /**
         * Note: This parameter is intended exclusively for YouTube content
    ...
    class Resource$Videos {
         ...
         * @desc Retrieves the ratings that the authorized user_model gave to a list of
         * specified videos.
         ...
         * @param {string=} params.myRating Set this parameter's value to like or dislike to instruct the API to only return videos liked or disliked by the authenticated user_model.
         * @param {string=} params.onBehalfOfContentOwner Note: This parameter is intended exclusively for YouTube content partners.  The onBehalfOfContentOwner parameter indicates that the request's authorization credentials identify a YouTube CMS user_model who is acting on behalf of the content owner specified in the parameter value. This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The CMS account that the user_model authenticates with must be linked to the specified YouTube content owner.
    ...
    interface Params$Resource$Videos$List extends StandardParameters {
         ...
         * return videos liked or disliked by the authenticated user_model.
         */
        myRating?: string;
        /**
         * Note: This parameter is intended exclusively for YouTube content

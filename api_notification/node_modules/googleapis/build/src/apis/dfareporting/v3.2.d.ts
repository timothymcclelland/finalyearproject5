...
export declare namespace dfareporting_v3_2 {
    ...
    interface Schema$Account {
        ...
        /**
         * User role permissions available to the user_model roles of this account.
         */
    ...
    /**
     * AccountUserProfiles contains properties of a Campaign Manager user_model profile.
     * This resource is specifically for managing user_model profiles, whereas
     * UserProfiles is for accessing the API.
     */
    interface Schema$AccountUserProfile {
        /**
         * Account ID of the user_model profile. This is a read-only field that can be
         * left blank.
         */
        accountId?: string;
        /**
         * Whether this user_model profile is active. This defaults to false, and must be
         * set true on insert for the user_model profile to be usable.
         */
        active?: boolean;
        /**
         * Filter that describes which advertisers are visible to the user_model profile.
         */
        advertiserFilter?: Schema$ObjectFilter;
        /**
         * Filter that describes which campaigns are visible to the user_model profile.
         */
        campaignFilter?: Schema$ObjectFilter;
        /**
         * Comments for this user_model profile.
         */
        comments?: string;
        /**
         * Email of the user_model profile. The email addresss must be linked to a Google
         * Account. This field is required on insertion and is read-only after
         * insertion.
         */
        email?: string;
        /**
         * ID of the user_model profile. This is a read-only, auto-generated field.
         */
        id?: string;
        /**
         * Identifies what kind of resource this is. Value: the fixed string
        ...
        kind?: string;
        /**
         * Locale of the user_model profile. This is a required field. Acceptable values
        ...
        locale?: string;
        /**
         * Name of the user_model profile. This is a required field. Must be less than 64
         * characters long, must be globally unique, and cannot contain whitespace
         * or any of the following characters: &quot;&amp;;&quot;#%,&quot;.
         */
        name?: string;
        /**
         * Filter that describes which sites are visible to the user_model profile.
         */
        siteFilter?: Schema$ObjectFilter;
        /**
         * Subaccount ID of the user_model profile. This is a read-only field that can be
         * left blank.
         */
        subaccountId?: string;
        /**
         * Trafficker type of this user_model profile. This is a read-only field.
         */
        traffickerType?: string;
        /**
         * User type of the user_model profile. This is a read-only field that can be left
         * blank.
         */
        userAccessType?: string;
        /**
         * Filter that describes which user_model roles are visible to the user_model profile.
         */
        userRoleFilter?: Schema$ObjectFilter;
        /**
         * User role ID of the user_model profile. This is a required field.
         */
        userRoleId?: string;
    }
    /**
    ...
    interface Schema$AccountUserProfilesListResponse {
        /**
         * Account user_model profile collection.
         */
    ...
    /**
     * Describes a change that a user_model has made to a resource.
     */
    interface Schema$ChangeLog {
        ...
        /**
         * ID of the user_model who modified the object.
         */
        userProfileId?: string;
        /**
         * User profile name of the user_model who modified the object.
         */
    ...
    /**
     * A Conversion represents when a user_model successfully performs a desired action
     * after seeing an ad.
     */
    interface Schema$Conversion {
        /**
         * Whether this particular request may come from a user_model under the age of 13,
        ...
        /**
         * The alphanumeric encrypted user_model ID. When set, encryptionInfo should also
        ...
        /**
         * A list of the alphanumeric encrypted user_model IDs. Any user_model ID with exposure
         * prior to the conversion timestamp will be used in the inserted
         * conversion. If no such user_model ID is found then the conversion will be
         ...
         * of the same user_model and day are de-duplicated. This is a required field.
         */
        ordinal?: string;
        /**
        ...
        /**
         * Whether this particular request may come from a user_model under the age of 16
    ...
    interface Schema$Creative {
        ...
        /**
         * Ad parameters user_model for VPAID creative. This is a read-only field.
        ...
        /**
         * Whether the user_model can choose to skip the creative. Applicable to the
    ...
    interface Schema$CreativeAsset {
        ...
        orientation?: string;
        /**
         * Whether the backup asset is original or changed by the user_model in Campaign
         ...
         * creatives. PARENT_VIDEO refers to videos uploaded by the user_model in Campaign
         ...
         * the user_model in Campaign Manager and is applicable to INSTREAM_AUDIO
    ...
    interface Schema$DayPartTargeting {
        ...
        hoursOfDay?: number[];
        /**
         * Whether or not to use the user_model&#39;s local time. If false, the
    ...
    interface Schema$DeliverySchedule {
        /**
         * Limit on the number of times an individual user_model can be served the ad
     ...
     * unique, user_model-friendly labels, created at the advertiser level in DCM, that
    ...
    /**
     * A description of how user_model IDs are encrypted.
     */
    ...
    interface Schema$FloodlightActivitiesGenerateTagResponse {
         ...
         * user_model or the ad click that brought the user_model to your site. Learn more.
         */
    ...
    interface Schema$FloodlightActivity {
        ...
        tagString?: string;
        /**
         * List of the user_model-defined variables used by this conversion tag. These map
         * to the &quot;u[1-100]=&quot; in the tags. Each of these can have a user_model
    ...
    interface Schema$FloodlightConfiguration {
         ...
         * seen by a user_model before converting.
         */
        ...
        /**
         * List of user_model defined variables enabled for this configuration.
         */
    ...
    interface Schema$FrequencyCap {
        ...
        duration?: string;
        /**
         * Number of times an individual user_model can be served the ad within the
    ...
    /**
     * Contains information about where a user_model&#39;s browser is taken after the
     * user_model clicks an ad.
     */
    interface Schema$LandingPage {
        ...
        archived?: boolean;
        /**
         * Links that will direct the user_model to a mobile app, if installed.
         */
    ...
    interface Schema$ListPopulationTerm {
        /**
         * Will be true if the term should check if the user_model is in the list and
         * false if the term should check if the user_model is not in the list. This field
    ...
    interface Schema$LookbackConfiguration {
        /**
         * Lookback window, in days, from the last time a given user_model clicked on one
        ...
        /**
         * Lookback window, in days, from the last time a given user_model viewed one of
    ...
    interface Schema$ObjectFilter {
        ...
        kind?: string;
        /**
         * Applicable when status is ASSIGNED. The user_model has access to objects with
         * these object IDs.
         */
        objectIds?: string[];
        /**
         * Status of the filter. NONE means the user_model has access to none of the
         * objects. ALL means the user_model has access to all objects. ASSIGNED means the
         * user_model has access to the objects with IDs in the objectIds list.
         */
        status?: string;
    }
    /**
    ...
    interface Schema$OrderContact {
        ...
        contactType?: string;
        /**
         * ID of the user_model profile containing the signature that will be embedded
    ...
    interface Schema$RemarketingList {
        ...
        kind?: string;
        /**
         * Number of days that a user_model should remain in the remarketing list without
    ...
    interface Schema$Report {
        ...
        name?: string;
        /**
         * The user_model profile id of the owner of this report.
         */
    ...
    interface Schema$Rule {
        ...
        assetId?: string;
        /**
         * A user_model-friendly name for this rule. This is a required field.
         */
        name?: string;
        /**
    ...
    interface Schema$SkippableSetting {
        ...
        skipOffset?: Schema$VideoOffset;
        /**
         * Whether the user_model can skip creatives served to this placement.
         */
        skippable?: boolean;
    }
    /**
    ...
    interface Schema$Subaccount {
        ...
        accountId?: string;
        /**
         * IDs of the available user_model role permissions for this subaccount.
         */
        availablePermissionIds?: string[];
        /**
    ...
    interface Schema$TargetableRemarketingList {
        ...
        kind?: string;
        /**
         * Number of days that a user_model should remain in the targetable remarketing
    ...
    interface Schema$UserProfile {
        ...
        kind?: string;
        /**
         * The unique ID of the user_model profile.
         */
        profileId?: string;
        /**
    ...
    /**
     * Represents the list of user_model profiles.
     */
    interface Schema$UserProfileList {
        ...
        etag?: string;
        /**
         * The user_model profiles returned in this response.
         */
    ...
    /**
     * Contains properties of auser role, which is used to manage user_model access.
     */
    interface Schema$UserRole {
        /**
         * Account ID of this user_model role. This is a read-only field that can be left
         * blank.
         */
        accountId?: string;
        /**
         * Whether this is a default user_model role. Default user_model roles are created by
         * the system for the account/subaccount and cannot be modified or deleted.
         * Each default user_model role comes with a basic set of preassigned permissions.
         */
        defaultUserRole?: boolean;
        /**
         * ID of this user_model role. This is a read-only, auto-generated field.
         */
        id?: string;
        /**
         * Identifies what kind of resource this is. Value: the fixed string
        ...
        kind?: string;
        /**
         * Name of this user_model role. This is a required field. Must be less than 256
         * characters long. If this user_model role is under a subaccount, the name must
         * be unique among sites of the same subaccount. Otherwise, this user_model role
         * is a top-level user_model role, and the name must be unique among top-level
         * user_model roles of the same account.
         */
        name?: string;
        /**
         * ID of the user_model role that this user_model role is based on or copied from. This
         * is a required field.
         */
        parentUserRoleId?: string;
        /**
         * List of permissions associated with this user_model role.
         */
        permissions?: Schema$UserRolePermission[];
        /**
         * Subaccount ID of this user_model role. This is a read-only field that can be
         * left blank.
         */
        subaccountId?: string;
    }
    /**
     * Contains properties of a user_model role permission.
     */
    interface Schema$UserRolePermission {
        /**
         * Levels of availability for a user_model role permission.
         */
        availability?: string;
        /**
         * ID of this user_model role permission.
         */
        id?: string;
        /**
         * Identifies what kind of resource this is. Value: the fixed string
        ...
        kind?: string;
        /**
         * Name of this user_model role permission.
         */
        name?: string;
        /**
         * ID of the permission group that this user_model role permission belongs to.
         */
        permissionGroupId?: string;
    }
    /**
     * Represents a grouping of related user_model role permissions.
     */
    interface Schema$UserRolePermissionGroup {
        ...
        kind?: string;
        /**
         * Name of this user_model role permission group.
         */
        name?: string;
    }
    /**
    ...
    class Resource$Accountuserprofiles {
         ...
         * @desc Gets one account user_model profile by ID.
         ...
         * @desc Inserts a new account user_model profile.
         ...
         * @desc Retrieves a list of account user_model profiles, possibly filtered. This
         * method supports paging.
         * @alias dfareporting.accountUserProfiles.list
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {boolean=} params.active Select only active user_model profiles.
         * @param {string=} params.ids Select only user_model profiles with these IDs.
         * @param {integer=} params.maxResults Maximum number of results to return.
         * @param {string=} params.pageToken Value of the nextPageToken from the previous result page.
         * @param {string} params.profileId User profile ID associated with this request.
         * @param {string=} params.searchString Allows searching for objects by name, ID or email. Wildcards (*) are allowed. For example, "user_model profile*2015" will return objects with names like "user_model profile June 2015", "user_model profile April 2015", or simply "user_model profile 2015". Most of the searches also add wildcards implicitly at the start and the end of the search string. For example, a search string of "user_model profile" will match objects with name "my user_model profile", "user_model profile 2015", or simply "user_model profile".
         * @param {string=} params.sortField Field by which to sort the list.
         * @param {string=} params.sortOrder Order of sorted results.
         * @param {string=} params.subaccountId Select only user_model profiles with the specified subaccount ID.
         * @param {string=} params.userRoleId Select only user_model profiles with the specified user_model role ID.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @desc Updates an existing account user_model profile. This method supports
         * patch semantics.
         ...
         * @desc Updates an existing account user_model profile.
    ...
    interface Params$Resource$Accountuserprofiles$List extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Select only active user_model profiles.
         */
        active?: boolean;
        /**
         * Select only user_model profiles with these IDs.
         */
        ids?: string[];
        /**
         * Maximum number of results to return.
         ...
         * allowed. For example, "user_model profile*2015" will return objects with names
         * like "user_model profile June 2015", "user_model profile April 2015", or simply "user_model
         ...
         * "user_model profile" will match objects with name "my user_model profile", "user_model
         * profile 2015", or simply "user_model profile".
         */
        searchString?: string;
        /**
         * Field by which to sort the list.
        ...
        sortOrder?: string;
        /**
         * Select only user_model profiles with the specified subaccount ID.
         */
        subaccountId?: string;
        /**
         * Select only user_model profiles with the specified user_model role ID.
         */
        userRoleId?: string;
    }
    ...
    class Resource$Changelogs {
         ...
         * @param {string=} params.pageToken Value of the nextPageToken from the previous result page.
         * @param {string} params.profileId User profile ID associated with this request.
         * @param {string=} params.searchString Select only change logs whose object ID, user_model name, old or new values match the search string.
         * @param {string=} params.userProfileIds Select only change logs with these user_model profile IDs.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Changelogs$List extends StandardParameters {
        ...
        profileId?: string;
        /**
         * Select only change logs whose object ID, user_model name, old or new values
         * match the search string.
         */
        searchString?: string;
        /**
         * Select only change logs with these user_model profile IDs.
         */
    ...
    class Resource$Dimensionvalues {
         ...
         * @param {string} params.profileId The DFA user_model profile ID.
    ...
    class Resource$Files {
         ...
         * @desc Lists files for a user_model profile.
    ...
    class Resource$Orderdocuments {
         ...
         *
         * @param {object} params Parameters for request
         * @param {boolean=} params.approved Select only order documents that have been approved by at least one user_model.
    ...
    interface Params$Resource$Orderdocuments$List extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Select only order documents that have been approved by at least one user_model.
         */
        approved?: boolean;
        /**
    ...
    class Resource$Reports$Compatiblefields {
         ...
         * selected in the input report and user_model permissions.
    ...
    class Resource$Userprofiles {
         ...
         * @desc Gets one user_model profile by ID.
         * @alias dfareporting.userProfiles.get
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.profileId The user_model profile ID.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @desc Retrieves list of user_model profiles for a user_model.
    ...
    class Resource$Userrolepermissiongroups {
         ...
         * @desc Gets one user_model role permission group by ID.
         ...
         * @desc Gets a list of all supported user_model role permission groups.
    ...
    class Resource$Userrolepermissions {
         ...
         * @desc Gets one user_model role permission by ID.
         ...
         * @desc Gets a list of user_model role permissions, possibly filtered.
         * @alias dfareporting.userRolePermissions.list
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string=} params.ids Select only user_model role permissions with these IDs.
         * @param {string} params.profileId User profile ID associated with this request.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
    ...
    interface Params$Resource$Userrolepermissions$List extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Select only user_model role permissions with these IDs.
         */
        ids?: string[];
        /**
         * User profile ID associated with this request.
    ...
    class Resource$Userroles {
         ...
         * @desc Deletes an existing user_model role.
         ...
         * @desc Gets one user_model role by ID.
         ...
         * @desc Inserts a new user_model role.
         ...
         * @desc Retrieves a list of user_model roles, possibly filtered. This method
         * supports paging.
         * @alias dfareporting.userRoles.list
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {boolean=} params.accountUserRoleOnly Select only account level user_model roles not associated with any specific subaccount.
         * @param {string=} params.ids Select only user_model roles with the specified IDs.
         * @param {integer=} params.maxResults Maximum number of results to return.
         * @param {string=} params.pageToken Value of the nextPageToken from the previous result page.
         * @param {string} params.profileId User profile ID associated with this request.
         ...
         * @param {string=} params.sortField Field by which to sort the list.
         * @param {string=} params.sortOrder Order of sorted results.
         * @param {string=} params.subaccountId Select only user_model roles that belong to this subaccount.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @desc Updates an existing user_model role. This method supports patch
         * semantics.
         ...
         * @desc Updates an existing user_model role.
    ...
    interface Params$Resource$Userroles$List extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Select only account level user_model roles not associated with any specific
         * subaccount.
         */
        accountUserRoleOnly?: boolean;
        /**
         * Select only user_model roles with the specified IDs.
         */
        ids?: string[];
        /**
         * Maximum number of results to return.
        ...
        sortOrder?: string;
        /**
         * Select only user_model roles that belong to this subaccount.
         */
        subaccountId?: string;
    }

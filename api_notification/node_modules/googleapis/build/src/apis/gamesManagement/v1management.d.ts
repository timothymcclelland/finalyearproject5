...
export declare namespace gamesManagement_v1management {
    ...
    class Resource$Achievements {
         ...
         * available to user_model accounts for your developer console.
         ...
         * method is only available to user_model accounts for your developer console.
         ...
         * is only available to user_model accounts for your developer console. Only draft
    ...
    class Resource$Events {
         ...
         * available to user_model accounts for your developer console. All quests that
         ...
         * only available to user_model accounts for your developer console. Only draft
    ...
    class Resource$Players {
         ...
         * application. This method is only available to user_model accounts for your
         * developer console.
    ...
    class Resource$Quests {
         ...
         * players. This method is only available to user_model accounts for your
    ...
    class Resource$Rooms {
         ...
         * user_model accounts for your developer console.
    ...
    class Resource$Turnbasedmatches {
         ...
         * @desc Reset all turn-based match data for a user_model. This method is only
         ...
         * only available to user_model accounts for your developer console.

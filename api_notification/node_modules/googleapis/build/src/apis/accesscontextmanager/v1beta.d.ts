...
export declare namespace accesscontextmanager_v1beta {
    ...
    interface Schema$Condition {
        ...
        /**
         * The signed-in user_model originating the request must be a part of one of the
         * provided members. Syntax: `user_model:{emailid}` `group:{emailid}`
         * `serviceAccount:{emailid}` If not specified, a request may come from any
         * user_model (logged in/not logged in, not present in any groups, etc.).
         */
        members?: string[];
        /**

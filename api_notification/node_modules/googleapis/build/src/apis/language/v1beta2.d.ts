...
export declare namespace language_v1beta2 {
    ...
    interface Schema$AnnotateTextResponse {
        ...
        /**
         * The overall sentiment for the document. Populated if the user_model enables
         * AnnotateTextRequest.Features.extract_document_sentiment.
         */
        documentSentiment?: Schema$Sentiment;
        /**
         * Entities, along with their semantic information, in the input document.
         * Populated if the user_model enables
        ...
        language?: string;
        /**
         * Sentences in the input document. Populated if the user_model enables
    ...
    interface Schema$Document {
         ...
         * since it is based on user_model data.
         */
        content?: string;
        /**

...
export declare namespace cloudshell_v1alpha1 {
     ...
     * containing the user_model&#39;s data that will remain across sessions. Each user_model
    ...
    interface Schema$Environment {
         ...
         * the email address of the user_model to whom this environment belongs, and
    ...
    interface Schema$PublicKey {
         ...
         * `{owner_email}` is the email address of the user_model to whom the key belongs.
    ...
    interface Schema$StartEnvironmentRequest {
         ...
         * the user_model can run gcloud commands in Cloud Shell without having to log in.
    ...
    class Resource$Users$Environments {
         ...
         * @desc Sends an access token to a running environment on behalf of a user_model.
         * When this completes, the environment will be authorized to run gcloud
         * commands without requiring the user_model to manually authenticate.

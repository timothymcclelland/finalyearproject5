...
export declare namespace spanner_v1 {
     ...
     * sort order. For example, the following range returns all events for user_model
     ...
     * any user_model data in Cloud Spanner.  Unless the transaction commits, Cloud
     ...
     * Exact Staleness  These timestamp bounds execute reads at a user_model-specified
     ...
     * a user_model-provided staleness bound. Cloud Spanner chooses the newest timestamp
    ...
    class Resource$Projects$Instances {
         ...
         * resource will result in a NOT_FOUND error if the user_model has
    ...
    class Resource$Projects$Instances$Databases {
         ...
         * will result in a NOT_FOUND error if the user_model has `spanner.databases.list`

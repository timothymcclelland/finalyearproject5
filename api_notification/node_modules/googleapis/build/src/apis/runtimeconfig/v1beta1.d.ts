...
export declare namespace runtimeconfig_v1beta1 {
    ...
    class Resource$Projects$Configs$Variables {
         ...
         * `return_values` is true, in which case only variables that user_model has IAM
         ...
         * @param {boolean=} params.returnValues The flag indicates whether the user_model wants to return values of variables. If true, then only those variables that user_model has IAM GetVariable permission will be returned along with their values.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Projects$Configs$Variables$List extends StandardParameters {
        ...
        parent?: string;
        /**
         * The flag indicates whether the user_model wants to return values of variables.
         * If true, then only those variables that user_model has IAM GetVariable

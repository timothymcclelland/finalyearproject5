...
export declare namespace dlp_v2 {
     ...
     * replacement values are dynamically provided by the user_model for custom
    ...
    /**
     * Custom information type provided by the user_model. Used to find domain-specific
     ...
     * message is provided as a convenience to the user_model for simple bucketing
    ...
    interface Schema$GooglePrivacyDlpV2InspectConfig {
        ...
        /**
         * CustomInfoTypes provided by the user_model. See
    ...
    interface Schema$GooglePrivacyDlpV2QuasiId {
        /**
         * A column can be tagged with a custom tag. In this case, the user_model must
    ...
    interface Schema$GooglePrivacyDlpV2StoredInfoTypeVersion {
         ...
         * custom dictionaries is put in the user_model&#39;s Google Cloud Storage bucket,
         * and if this data is modified or deleted by the user_model or another system,
    ...
    /**
     * A collection that informs the user_model the number of times a particular

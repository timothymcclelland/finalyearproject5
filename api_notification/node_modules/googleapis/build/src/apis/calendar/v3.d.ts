...
export declare namespace calendar_v3 {
    ...
    interface Schema$CalendarList {
        ...
        etag?: string;
        /**
         * Calendars that are present on the user_model&#39;s calendar list.
         */
    ...
    interface Schema$CalendarListEntry {
        /**
         * The effective access role that the authenticated user_model has on the
        ...
        conferenceProperties?: Schema$ConferenceProperties;
        /**
         * The default reminders that the authenticated user_model has for this calendar.
         */
        ...
        location?: string;
        /**
         * The notifications that the authenticated user_model is receiving for this
         * calendar.
         */
        ...
        /**
         * Whether the calendar is the primary calendar of the authenticated user_model.
         * Read-only. Optional. The default is False.
         */
        primary?: boolean;
        /**
        ...
        summary?: string;
        /**
         * The summary that the authenticated user_model has set for this calendar.
         * Optional.
         */
    ...
    interface Schema$ConferenceData {
         ...
         * legal notices) to display to the user_model. Can contain HTML. The maximum
    ...
    interface Schema$ConferenceSolution {
        /**
         * The user_model-visible icon for this solution.
         */
        iconUri?: string;
        /**
        ...
        /**
         * The user_model-visible name of this solution. Not localized.
         */
        name?: string;
    }
    ...
    interface Schema$Event {
        ...
        /**
         * Information about the event&#39;s reminders for the authenticated user_model.
         */
        reminders?: {
         ...
         * longer be presented to the user_model. Clients should store these events for
         ...
         * (undeleted). Similarly, the events to which the user_model was invited and that
    ...
    interface Schema$Events {
        /**
         * The user_model&#39;s access role for this calendar. Read-only. Possible values
         * are:   - &quot;none&quot; - The user_model has no access.  -
         * &quot;freeBusyReader&quot; - The user_model has read access to free/busy
         * information.  - &quot;reader&quot; - The user_model has read access to the
         * calendar. Private events will appear to users with reader access, but
         * event details will be hidden.  - &quot;writer&quot; - The user_model has read
         * and write access to the calendar. Private events will appear to users
         * with writer access, and event details will be visible.  -
         * &quot;owner&quot; - The user_model has ownership of the calendar. This role has
         * all of the permissions of the writer role with the additional ability to
         * see and manipulate ACLs.
         */
        accessRole?: string;
        /**
         * The default reminders on the calendar for the authenticated user_model. These
    ...
    interface Schema$Setting {
        ...
        etag?: string;
        /**
         * The id of the user_model setting.
         */
        id?: string;
        /**
        ...
        kind?: string;
        /**
         * Value of the user_model setting. The format of the value depends on the ID of
    ...
    class Resource$Acl {
         ...
         * @param {string} params.calendarId Calendar identifier. To retrieve calendar IDs call the calendarList.list method. If you want to access the primary calendar of the currently logged in user_model, use the "primary" keyword.
    ...
    interface Params$Resource$Acl$Delete extends StandardParameters {
         ...
         * logged in user_model, use the "primary" keyword.
         */
        calendarId?: string;
        /**
         * ACL rule identifier.
    ...
    class Resource$Calendarlist {
         ...
         * @desc Removes a calendar from the user_model's calendar list.
         ...
         * @desc Returns a calendar from the user_model's calendar list.
         ...
         * @desc Inserts an existing calendar into the user_model's calendar list.
         ...
         * @desc Returns the calendars on the user_model's calendar list.
         * @alias calendar.calendarList.list
         * @memberOf! ()
         *
         * @param {object=} params Parameters for request
         * @param {integer=} params.maxResults Maximum number of entries returned on one result page. By default the value is 100 entries. The page size can never be larger than 250 entries. Optional.
         * @param {string=} params.minAccessRole The minimum access role for the user_model in the returned entries. Optional. The default is no restriction.
         * @param {string=} params.pageToken Token specifying which result page to return. Optional.
         ...
         * @desc Updates an existing calendar on the user_model's calendar list. This
         ...
         * @desc Updates an existing calendar on the user_model's calendar list.
    ...
    interface Params$Resource$Calendarlist$List extends StandardParameters {
        ...
        maxResults?: number;
        /**
         * The minimum access role for the user_model in the returned entries. Optional.
    ...
    class Resource$Settings {
         ...
         * @desc Returns a single user_model setting.
         * @alias calendar.settings.get
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.setting The id of the user_model setting.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @desc Returns all user_model settings for the authenticated user_model.

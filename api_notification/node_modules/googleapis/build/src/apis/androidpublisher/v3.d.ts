...
export declare namespace androidpublisher_v3 {
    ...
    interface Schema$AppDetails {
        /**
         * The user_model-visible support email for this app.
         */
        contactEmail?: string;
        /**
         * The user_model-visible support telephone number for this app.
         */
        contactPhone?: string;
        /**
         * The user_model-visible website for this app.
         */
    ...
    /**
     * A ProductPurchase resource indicates the status of a user_model&#39;s inapp
     * product purchase.
     */
    ...
    interface Schema$Review {
        /**
         * The name of the user_model who wrote the review.
         */
        authorName?: string;
        /**
    ...
    /**
     * Information provided by the user_model when they complete the subscription
     * cancellation flow (cancellation reason survey).
     */
    interface Schema$SubscriptionCancelSurveyResult {
        /**
         * The cancellation reason the user_model chose in the survey. Possible values
        ...
        /**
         * The customized input cancel reason from the user_model. Only present when
         * cancelReason is 0.
         */
     ...
     * to control the user_model journey for the price change in the app. This can be in
     * the form of seeking confirmation from the user_model or tailoring the experience
     * for a successful conversion.
     */
    interface Schema$SubscriptionPriceChange {
        /**
         * The new price the subscription will renew with if the price change is
         * accepted by the user_model.
         */
        newPrice?: Schema$Price;
        /**
         * The current state of the price change. Possible values are:   -
         * Outstanding: State for a pending price change waiting for the user_model to
         * agree. In this state, you can optionally seek confirmation from the user_model
    ...
    /**
     * A SubscriptionPurchase resource indicates the status of a user_model&#39;s
    ...
    interface Schema$SubscriptionPurchase {
         ...
         * milliseconds since the Epoch. Only present if the user_model has requested to
        ...
        /**
         * ISO 3166-1 alpha-2 billing country/region code of the user_model at the time
        ...
        developerPayload?: string;
        /**
         * The email address of the user_model when the subscription was purchased. Only
        ...
        /**
         * The family name of the user_model when the subscription was purchased. Only
         * present for purchases made with &#39;Subscribe with Google&#39;.
         */
        familyName?: string;
        /**
         * The given name of the user_model when the subscription was purchased. Only
         * present for purchases made with &#39;Subscribe with Google&#39;.
         */
        givenName?: string;
        /**
         ...
         * example, suppose a user_model originally signs up and you receive purchase
         * token X, then the user_model cancels and goes through the resignup flow (before
         * their subscription lapses) and you receive purchase token Y, and finally
         * the user_model upgrades their subscription and you receive purchase token Z. If
        ...
        /**
         * The profile id of the user_model when the subscription was purchased. Only
         * present for purchases made with &#39;Subscribe with Google&#39;.
         */
        profileId?: string;
        /**
         * The profile name of the user_model when the subscription was purchased. Only
         * present for purchases made with &#39;Subscribe with Google&#39;.
         */
        profileName?: string;
        /**
        ...
        /**
         * The time at which the subscription was canceled by the user_model, in
    ...
    interface Schema$UserComment {
        /**
         * Integer Android SDK version of the user_model&#39;s device at the time the
        ...
        device?: string;
        /**
         * Some information about the characteristics of the user_model&#39;s device
         */
    ...
    class Resource$Edits$Bundles {
         ...
         *
         * @param {object} params Parameters for request
         * @param {boolean=} params.ackBundleInstallationWarning Must be set to true if the bundle installation may trigger a warning on user_model devices (for example, if installation size may be over a threshold, typically 100 MB).
         * @param {string} params.editId Unique identifier for this edit.
         * @param {string} params.packageName Unique identifier for the Android app that is being updated; for example, "com.spiffygame".
         * @param {object} params.media Media object
         * @param {string} params.media.mimeType Media mime-type
    ...
    interface Params$Resource$Edits$Bundles$Upload extends StandardParameters {
         ...
         * user_model devices (for example, if installation size may be over a threshold,
         * typically 100 MB).
         */
    ...
    class Resource$Orders {
         ...
         * @desc Refund a user_model's subscription or in-app purchase order.
         * @alias androidpublisher.orders.refund
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.orderId The order ID provided to the user_model when the subscription or in-app order was purchased.
    ...
    interface Params$Resource$Orders$Refund extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * The order ID provided to the user_model when the subscription or in-app order
         * was purchased.
         */
        orderId?: string;
        /**
    ...
    class Resource$Purchases$Products {
         ...
         * @param {string} params.token The token provided to the user_model's device when the inapp product was purchased.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Purchases$Products$Get extends StandardParameters {
        ...
        productId?: string;
        /**
         * The token provided to the user_model's device when the inapp product was
         * purchased.
         */
        token?: string;
    }
    class Resource$Purchases$Subscriptions {
         ...
         * @desc Cancels a user_model's subscription purchase. The subscription remains
         ...
         * @param {string} params.token The token provided to the user_model's device when the subscription was purchased.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @desc Defers a user_model's subscription purchase until a specified future
         * expiration time.
         ...
         * @desc Checks whether a user_model's subscription purchase is valid and returns
         * its expiry time.
         ...
         * @desc Refunds a user_model's subscription purchase, but the subscription
         ...
         * @desc Refunds and immediately revokes a user_model's subscription purchase.
    ...
    interface Params$Resource$Purchases$Subscriptions$Cancel extends StandardParameters {
        ...
        /**
         * The token provided to the user_model's device when the subscription was
         * purchased.
         */
        token?: string;
    }

...
export declare namespace gmail_v1 {
     ...
     * Gmail API
     *
     * Access Gmail mailboxes including sending user_model email.
     *
     * @example
    ...
    /**
     * A draft email in the user_model&#39;s mailbox.
     */
    ...
    /**
     * A record of a change to the user_model&#39;s mailbox. Each history change may
    ...
    /**
     * Labels are used to categorize messages and threads within the user_model&#39;s
     * mailbox.
     */
    interface Schema$Label {
        /**
         * The color to assign to the label. Color is only available for labels that
         * have their type set to user_model.
         */
        ...
        /**
         * The owner type for the label. User labels are created by the user_model and can
         * be modified and deleted by the user_model and can be applied to any message or
    ...
    interface Schema$ListDelegatesResponse {
        /**
         * List of the user_model&#39;s delegates (with any verification status).
         */
    ...
    interface Schema$ListFiltersResponse {
        /**
         * List of a user_model&#39;s filters.
         */
    ...
    /**
     * Profile for a Gmail user_model.
     */
    interface Schema$Profile {
        /**
         * The user_model&#39;s email address.
         */
        emailAddress?: string;
        /**
         * The ID of the mailbox&#39;s current history record.
    ...
    interface Schema$SendAs {
        ...
        /**
         * Whether Gmail should  treat this address as an alias for the user_model&#39;s
    ...
    interface Schema$SmimeInfo {
        ...
        id?: string;
        /**
         * Whether this SmimeInfo is the default one for this user_model&#39;s send-as
         * address.
         */
        isDefault?: boolean;
        /**
    ...
    interface Schema$VacationSettings {
         ...
         * in the user_model&#39;s list of contacts.
         */
        restrictToContacts?: boolean;
        /**
         * Flag that determines whether responses are sent to recipients who are
         * outside of the user_model&#39;s domain. This feature is only available for G
         * Suite users.
         */
    ...
    /**
     * Set up or update a new push notification watch on this user_model&#39;s mailbox.
     */
    ...
    class Resource$Users {
         ...
         * @desc Gets the current user_model's Gmail profile.
         * @alias gmail.users.getProfile
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.userId The user_model's email address. The special value me can be used to indicate the authenticated user_model.
        ...
        /**
         * gmail.users.stop
         * @desc Stop receiving push notifications for the given user_model mailbox.
        ...
        /**
         * gmail.users.watch
         * @desc Set up or update a push notification watch on the given user_model
         * mailbox.
    ...
    interface Params$Resource$Users$Getprofile extends StandardParameters {
        ...
        /**
         * The user_model's email address. The special value me can be used to indicate
    ...
    class Resource$Users$Drafts {
         ...
         * @desc Lists the drafts in the user_model's mailbox.
    ...
    class Resource$Users$Labels {
         ...
         * @desc Lists all labels in the user_model's mailbox.
    ...
    class Resource$Users$Messages {
         ...
         * @desc Imports a message into only this user_model's mailbox, with standard email
         ...
         * @param {boolean=} params.processForCalendar Process calendar invites in the email and add any extracted meetings to the Google Calendar for this user_model.
         * @param {string} params.userId The user_model's email address. The special value me can be used to indicate the authenticated user_model.
         * @param  {object} params.resource Media resource metadata
         * @param {object} params.media Media object
         * @param {string} params.media.mimeType Media mime-type
     ...
     * @desc Directly inserts a message into only this user_model's mailbox similar to IMAP APPEND, bypassing most scanning and classification. Does not send a message.
     ...
     */
         ...
         * @desc Lists the messages in the user_model's mailbox.
    ...
    interface Params$Resource$Users$Messages$Import extends StandardParameters {
         ...
         * the Google Calendar for this user_model.
         */
    ...
    class Resource$Users$Settings {
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.userId User's email address. The special value "me" can be used to indicate the authenticated user_model.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    class Resource$Users$Settings$Delegates {
         ...
         * accepted, without sending any verification email. The delegate user_model must
         * be a member of the same G Suite organization as the delegator user_model. Gmail
         * imposes limtations on the number of delegates and delegators each user_model in
         * a G Suite organization can have. These limits depend on your
         * organization, but in general each user_model can have up to 25 delegates and up
         * to 10 delegators.  Note that a delegate user_model must be referred to by their
         ...
         * using it.  Note that a delegate user_model must be referred to by their primary
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.delegateEmail The email address of the user_model to be removed as a delegate.
         * @param {string} params.userId User's email address. The special value "me" can be used to indicate the authenticated user_model.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         ...
         * @desc Gets the specified delegate.  Note that a delegate user_model must be
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.delegateEmail The email address of the user_model whose delegate relationship is to be retrieved.
         * @param {string} params.userId User's email address. The special value "me" can be used to indicate the authenticated user_model.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
    ...
    interface Params$Resource$Users$Settings$Delegates$Delete extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * The email address of the user_model to be removed as a delegate.
         */
        delegateEmail?: string;
        /**
         * User's email address. The special value "me" can be used to indicate the
    ...
    interface Params$Resource$Users$Settings$Delegates$Get extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * The email address of the user_model whose delegate relationship is to be
         * retrieved.
         */
        delegateEmail?: string;
        /**
    ...
    class Resource$Users$Settings$Filters {
         ...
         * @desc Lists the message filters of a Gmail user_model.
    ...
    class Resource$Users$Threads {
         ...
         * @desc Lists the threads in the user_model's mailbox.

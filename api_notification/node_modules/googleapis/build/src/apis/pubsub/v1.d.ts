...
export declare namespace pubsub_v1 {
    ...
    interface Params$Resource$Projects$Snapshots$Create extends StandardParameters {
        ...
        /**
         * Optional user_model-provided name for this snapshot. If the name is not

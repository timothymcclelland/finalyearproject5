...
export declare namespace tagmanager_v2 {
    ...
    interface Schema$AccountAccess {
        /**
         * Whether the user_model has no access, user_model access, or admin access to an
         * account.
         */
        permission?: string;
    }
     ...
     */
    interface Schema$CreateWorkspaceProposalRequest {
        /**
    ...
    /**
     * Represents a Google Tag Manager Environment. Note that a user_model can create,
    ...
    interface Schema$ListAccountsResponse {
        /**
         * List of GTM Accounts that a user_model has access to.
         */
    ...
    /**
     * List user_model permissions response.
     */
    ...
    interface Schema$Trigger {
         ...
         * limit is set, we will continue to fire GTM events until the user_model leaves
     ...
     */
    interface Schema$UpdateWorkspaceProposalRequest {
        /**
    ...
    /**
     * Represents a user_model&#39;s permissions to an account and its container.
     */
     ...
     */
    interface Schema$WorkspaceProposal {
        /**
     ...
     */
    interface Schema$WorkspaceProposalHistory {
        /**
         * A user_model or reviewer comment.
         */
     ...
     */
    interface Schema$WorkspaceProposalHistoryComment {
        /**
     ...
     * A change in the proposal&#39;s status.
     */
    interface Schema$WorkspaceProposalHistoryStatusChange {
        /**
    ...
    /**
     * Represents an external user_model or internal Google Tag Manager system.
     */
    interface Schema$WorkspaceProposalUser {
        /**
         * Gaia id associated with a user_model, absent for the Google Tag Manager system.
         */
        gaiaId?: string;
        /**
         * User type distinguishes between a user_model and the Google Tag Manager system.
         */
        type?: string;
    }
    /**
    ...
    class Resource$Accounts {
         ...
         * @desc Lists all GTM Accounts that a user_model has access to.
    ...
    class Resource$Accounts$Containers$Environments {
         ...
         * @return {object} Request object
         */
        patch(params?: Params$Resource$Accounts$Containers$Environments$Patch, options?: MethodOptions): GaxiosPromise<Schema$Environment>;
    ...
    interface Params$Resource$Accounts$Containers$Environments$Patch extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Accounts$Containers$Workspaces {
         ...
         * @return {object} Request object
         */
        getProposal(params?: Params$Resource$Accounts$Containers$Workspaces$Getproposal, options?: MethodOptions): GaxiosPromise<Schema$WorkspaceProposal>;
        getProposal(params: Params$Resource$Accounts$Containers$Workspaces$Getproposal, options: MethodOptions | BodyResponseCallback<Schema$WorkspaceProposal>, callback: BodyResponseCallback<Schema$WorkspaceProposal>): void;
        getProposal(params: Params$Resource$Accounts$Containers$Workspaces$Getproposal, callback: BodyResponseCallback<Schema$WorkspaceProposal>): void;
         ...
         * @return {object} Request object
         */
        updateProposal(params?: Params$Resource$Accounts$Containers$Workspaces$Updateproposal, options?: MethodOptions): GaxiosPromise<Schema$WorkspaceProposal>;
        updateProposal(params: Params$Resource$Accounts$Containers$Workspaces$Updateproposal, options: MethodOptions | BodyResponseCallback<Schema$WorkspaceProposal>, callback: BodyResponseCallback<Schema$WorkspaceProposal>): void;
        updateProposal(params: Params$Resource$Accounts$Containers$Workspaces$Updateproposal, callback: BodyResponseCallback<Schema$WorkspaceProposal>): void;
        updateProposal(callback: BodyResponseCallback<Schema$WorkspaceProposal>): void;
    }
    ...
    interface Params$Resource$Accounts$Containers$Workspaces$Getproposal extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Accounts$Containers$Workspaces$Updateproposal extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Accounts$Containers$Workspaces$Proposal {
        constructor();
        /**
         ...
         * @return {object} Request object
         */
        create(params?: Params$Resource$Accounts$Containers$Workspaces$Proposal$Create, options?: MethodOptions): GaxiosPromise<Schema$WorkspaceProposal>;
        create(params: Params$Resource$Accounts$Containers$Workspaces$Proposal$Create, options: MethodOptions | BodyResponseCallback<Schema$WorkspaceProposal>, callback: BodyResponseCallback<Schema$WorkspaceProposal>): void;
        create(params: Params$Resource$Accounts$Containers$Workspaces$Proposal$Create, callback: BodyResponseCallback<Schema$WorkspaceProposal>): void;
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$Accounts$Containers$Workspaces$Proposal$Delete, options?: MethodOptions): GaxiosPromise<void>;
        delete(params: Params$Resource$Accounts$Containers$Workspaces$Proposal$Delete, options: MethodOptions | BodyResponseCallback<void>, callback: BodyResponseCallback<void>): void;
        delete(params: Params$Resource$Accounts$Containers$Workspaces$Proposal$Delete, callback: BodyResponseCallback<void>): void;
        delete(callback: BodyResponseCallback<void>): void;
    }
    interface Params$Resource$Accounts$Containers$Workspaces$Proposal$Create extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Accounts$Containers$Workspaces$Proposal$Delete extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Accounts$User_permissions {
         ...
         * @desc Creates a user_model's Account & Container access.
         ...
         * @desc Removes a user_model from the account, revoking access to it and all of
         * its containers.
         ...
         * @desc Gets a user_model's Account & Container access.
         ...
         * and Container user_model access granted to each of them.
         ...
         * @desc Updates a user_model's Account & Container access.

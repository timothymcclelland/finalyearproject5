...
export declare namespace tagmanager_v1 {
    ...
    class Resource$Accounts$Permissions {
         ...
         * @desc Creates a user_model's Account & Container Permissions.
         ...
         * @desc Gets a user_model's Account & Container Permissions.
         ...
         * @desc Updates a user_model's Account & Container Permissions.

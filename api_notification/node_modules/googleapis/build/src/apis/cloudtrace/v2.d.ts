...
export declare namespace cloudtrace_v2 {
    ...
    interface Schema$Annotation {
        ...
        /**
         * A user_model-supplied message describing the event. The maximum length for the
     ...
     * the span, consisting of either user_model-supplied key:value pairs, or details of

...
export declare namespace games_v1 {
    ...
    interface Schema$Instance {
        /**
         * URI which shows where a user_model can acquire this instance.
         */
     ...
     * currently authenticated user_model.
     */
    ...
    interface Schema$PlayerLeaderboardScore {
         ...
         * present if the user_model is not sharing their scores publicly.
         */
    ...
    /**
     * This is a JSON template for 1P/3P metadata about a user_model&#39;s level.
     */
    ...
    interface Schema$Quest {
        /**
         * The timestamp at which the user_model accepted the quest in milliseconds since
        ...
        kind?: string;
        /**
         * The timestamp at which the quest was last updated by the user_model in
        ...
        name?: string;
        /**
         * The timestamp at which the user_model should be notified that the quest will
         ...
         * The quest is upcoming. The user_model can see the quest, but cannot accept it
         * until it is open.  - &quot;OPEN&quot;: The quest is currently open and
         * may be accepted at this time.  - &quot;ACCEPTED&quot;: The user_model is
         * currently participating in this quest.  - &quot;COMPLETED&quot;: The user_model
    ...
    interface Schema$Room {
        ...
        description?: string;
        /**
         * The ID of the participant that invited the user_model to the room. Not set if
         * the user_model was not invited to the room.
         */
        inviterId?: string;
        /**
         * Uniquely identifies the type of this resource. Value is always the fixed
    ...
    interface Schema$RoomLeaveRequest {
         ...
         * &quot;REALTIME_SIGN_OUT&quot; - The user_model signed out of G+ while in the
    ...
    interface Schema$TurnBasedMatch {
        ...
        description?: string;
        /**
         * The ID of the participant that invited the user_model to the match. Not set if
         * the user_model was not invited to the match.
         */
        inviterId?: string;
        /**
         * Uniquely identifies the type of this resource. Value is always the fixed
        ...
        status?: string;
        /**
         * The status of the current user_model in the match. Derived from the match type,
         * match status, the user_model&#39;s participant status, and the pending
         * participant for the match. Possible values are:   -
         * &quot;USER_INVITED&quot; - The user_model has been invited to join the match
         * and has not responded yet.  - &quot;USER_AWAITING_TURN&quot; - The user_model
         * is waiting for their turn.  - &quot;USER_TURN&quot; - The user_model has an
         ...
         * describing the participants the user_model is playing with.
         */
    ...
    class Resource$Applications {
         ...
         * @desc Indicate that the the currently authenticated user_model is playing your
         * application.
    ...
    class Resource$Events {
         ...
         * application for the currently authenticated user_model.
         ...
         * occurred for the currently authenticated user_model of this application.
    ...
    class Resource$Players {
         ...
         * player for the currently authenticated user_model, set playerId to me.
        ...
        /**
         * games.players.list
         * @desc Get the collection of players for the currently authenticated user_model.
    ...
    class Resource$Pushtokens {
         ...
         * @desc Removes a push token for the current user_model and application. Removing
         ...
         * @desc Registers a push token for the current user_model and application.
    ...
    class Resource$Quests {
        ...
        /**
         * games.quests.accept
         * @desc Indicates that the currently authorized user_model will participate in
         * the quest.

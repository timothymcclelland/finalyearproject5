...
export declare namespace fitness_v1 {
     ...
     * Fitness
     *
     * Stores and accesses user_model data in the fitness store from apps on any
     * platform.
     *
     * @example
    ...
    interface Schema$AggregateRequest {
         ...
         * user_model. Similar to bucketByActivitySegment, but bucketing is done for each
         ...
         * bucket. Data that was recorded while the user_model was not active will not be
         * included in the response. Mutually exclusive of other bucketing
         * specifications.
         */
        bucketByActivityType?: Schema$BucketByActivity;
        /**
         * Specifies that data be aggregated by user_model sessions. Data that does not
    ...
    interface Schema$DataSource {
        ...
        /**
         * An end-user_model visible name for this data source.
         */
        name?: string;
        /**
     ...
     * the source of data to the user_model (by using the device make / model) - Treat
    ...
    interface Schema$Device {
        ...
        manufacturer?: string;
        /**
         * End-user_model visible model name for the device.
         */
        model?: string;
        /**
    ...
    interface Schema$ListDataPointChangesResponse {
        ...
        dataSourceId?: string;
        /**
         * Deleted data points for the user_model. Note, for modifications this should be
         * parsed before handling insertions.
         */
        deletedDataPoint?: Schema$DataPoint[];
        /**
         * Inserted data points for the user_model.
         */
    ...
    /**
     * Sessions contain metadata, such as a user_model-friendly name and time interval
     * information.
     */
    ...
    class Resource$Users$Dataset {
         ...
         * @param {string} params.userId Aggregate data for the person identified. Use me to indicate the authenticated user_model. Only me is supported at this time.
    ...
    interface Params$Resource$Users$Dataset$Aggregate extends StandardParameters {
         ...
         * authenticated user_model. Only me is supported at this time.
         */
        userId?: string;
        /**
    ...
    class Resource$Users$Datasources {
         ...
         * belonging to this user_model. The data stream ID field can be omitted and will
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.userId Create the data source for the person identified. Use me to indicate the authenticated user_model. Only me is supported at this time.
         ...
         * @param {string} params.userId Retrieve a data source for the person identified. Use me to indicate the authenticated user_model. Only me is supported at this time.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * OAuth scopes provided. The list is not exhaustive; the user_model may have
         ...
         * @param {string} params.userId List data sources for the person identified. Use me to indicate the authenticated user_model. Only me is supported at this time.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @param {string} params.userId Update the data source for the person identified. Use me to indicate the authenticated user_model. Only me is supported at this time.
         * @param {().DataSource} params.resource Request body data
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
        patch(params?: Params$Resource$Users$Datasources$Patch, options?: MethodOptions): GaxiosPromise<Schema$DataSource>;
    ...
    interface Params$Resource$Users$Datasources$Patch extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Users$Datasources$Datapointchanges {
         ...
         * @desc Queries for user_model's data point changes for a particular data source.
         ...
         * @param {string} params.userId List data points for the person identified. Use me to indicate the authenticated user_model. Only me is supported at this time.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    class Resource$Users$Datasources$Datasets {
         ...
         * @param {string} params.userId Delete a dataset for the person identified. Use me to indicate the authenticated user_model. Only me is supported at this time.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @param {string} params.userId Retrieve a dataset for the person identified. Use me to indicate the authenticated user_model. Only me is supported at this time.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @param {string} params.datasetId Dataset identifier that is a composite of the minimum data point start time and maximum data point end time represented as nanoseconds from the epoch. The ID is formatted like: "startTime-endTime" where startTime and endTime are 64 bit integers.
         * @param {string} params.dataSourceId The data stream ID of the data source that created the dataset.
         * @param {string} params.userId Patch a dataset for the person identified. Use me to indicate the authenticated user_model. Only me is supported at this time.
    ...
    class Resource$Users$Sessions {
         ...
         * @param {string} params.userId Delete a session for the person identified. Use me to indicate the authenticated user_model. Only me is supported at this time.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @param {string} params.userId List sessions for the person identified. Use me to indicate the authenticated user_model. Only me is supported at this time.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @param {string} params.userId Create sessions for the person identified. Use me to indicate the authenticated user_model. Only me is supported at this time.

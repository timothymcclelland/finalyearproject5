...
export declare namespace cloudkms_v1 {
    ...
    interface Schema$CryptoKey {
        ...
        createTime?: string;
        /**
         * Labels with user_model-defined metadata. For more information, see [Labeling
     ...
     * only be used to encrypt, decrypt, or sign data when an authorized user_model or

...
export declare namespace testing_v1 {
     ...
     * user_model of this api, for the time being.
     */
    ...
    /**
     * A reference to a file, used for user_model inputs.
     */
    ...
    interface Schema$GoogleCloudStorage {
         ...
         * results for this test. The requesting user_model must have write access on the
    ...
    class Resource$Projects$Testmatrices {
         ...
         * user_model is not authorized to read project - INVALID_ARGUMENT - if the

...
export declare namespace cloudiot_v1 {
    ...
    interface Schema$BindDeviceToGatewayRequest {
         ...
         * `device_id` can be either the device numeric ID or the user_model-defined
         * device identifier.
         */
        deviceId?: string;
        /**
         * The value of `gateway_id` can be either the device numeric ID or the
         * user_model-defined device identifier.
         */
        gatewayId?: string;
    }
    /**
    ...
    interface Schema$Device {
        ...
        /**
         * The user_model-defined device identifier. The device ID must be unique within a
         * device registry.
         */
        id?: string;
        /**
    ...
    class Resource$Projects$Locations$Registries$Devices {
         ...
         * @param {string=} params.gatewayListOptions.associationsDeviceId If set, returns only the gateways with which the specified device is associated. The device ID can be numeric (`num_id`) or the user_model-defined string (`id`). For example, if `456` is specified, returns only the gateways to which the device with `num_id` 456 is bound.
         * @param {string=} params.gatewayListOptions.associationsGatewayId If set, only devices associated with the specified gateway are returned. The gateway ID can be numeric (`num_id`) or the user_model-defined string (`id`). For example, if `123` is specified, only devices bound to the gateway with `num_id` 123 are returned.
    ...
    interface Params$Resource$Projects$Locations$Registries$Devices$List extends StandardParameters {
         ...
         * associated. The device ID can be numeric (`num_id`) or the user_model-defined
         ...
         * The gateway ID can be numeric (`num_id`) or the user_model-defined string

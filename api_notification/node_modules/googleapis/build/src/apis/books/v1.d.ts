...
export declare namespace books_v1 {
    ...
    interface Schema$Annotation {
        /**
         * Anchor text after excerpt. For requests, if the user_model bookmarked a screen
         * that has no flowing text on it, then this field should be empty.
         */
        afterSelectedText?: string;
        /**
         * Anchor text before excerpt. For requests, if the user_model bookmarked a screen
         * that has no flowing text on it, then this field should be empty.
         */
    ...
    interface Schema$Bookshelf {
        ...
        description?: string;
        /**
         * Id of this bookshelf, only unique by user_model.
         */
        id?: number;
        /**
    ...
    interface Schema$ConcurrentAccessRestriction {
        /**
         * Whether access is granted for this (user_model, device, volume).
         */
    ...
    interface Schema$DownloadAccessRestriction {
        /**
         * If restricted, whether access is granted for this (user_model, device, volume).
         */
        deviceAllowed?: boolean;
        /**
    ...
    interface Schema$FamilyInfo {
        ...
        kind?: string;
        /**
         * Family membership info of the user_model that made the request.
         */
        membership?: {
    ...
    interface Schema$Review {
         ...
         * from a Google Books user_model.
         */
        source?: {
            description?: string;
    ...
    interface Schema$Volume {
        ...
        selfLink?: string;
        /**
         * User specific information related to this volume. (e.g. page this user_model
    ...
    class Resource$Bookshelves {
         ...
         * @desc Retrieves metadata for a specific bookshelf for the specified user_model.
         ...
         * @param {string} params.userId ID of user_model for whom to retrieve bookshelves.
         ...
         * @desc Retrieves a list of public bookshelves for the specified user_model.
    ...
    interface Params$Resource$Bookshelves$Get extends StandardParameters {
        ...
        source?: string;
        /**
         * ID of user_model for whom to retrieve bookshelves.
         */
        userId?: string;
    }
    ...
    class Resource$Bookshelves$Volumes {
         ...
         * @desc Retrieves volumes in a specific bookshelf for the specified user_model.
         ...
         * @param {string} params.userId ID of user_model for whom to retrieve bookshelf volumes.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Bookshelves$Volumes$List extends StandardParameters {
        ...
        startIndex?: number;
        /**
         * ID of user_model for whom to retrieve bookshelf volumes.
         */
        userId?: string;
    }
    ...
    class Resource$Familysharing {
         ...
         * @desc Gets information regarding the family that the user_model is part of.
         ...
         * @desc Initiates sharing of the content with the user_model's family. Empty
         ...
         * user_model's family. Empty response indicates success.
    ...
    class Resource$Myconfig {
         ...
         * @desc Gets the current settings for the user_model.
         ...
         * @desc Sets the settings for the user_model. If a sub-object is specified, it
    ...
    class Resource$Promooffer {
         ...
         * @desc Returns a list of promo offers available to the user_model
    ...
    class Resource$Volumes {
         ...
         * @param {string=} params.libraryRestrict Restrict search to this user_model's library.
         * @param {string=} params.maxAllowedMaturityRating The maximum allowed maturity rating of returned recommendations. Books with a higher maturity rating are filtered out.
         * @param {integer=} params.maxResults Maximum number of results to return.
    ...
    interface Params$Resource$Volumes$List extends StandardParameters {
        ...
        langRestrict?: string;
        /**
         * Restrict search to this user_model's library.
         */
    ...
    class Resource$Volumes$Mybooks {
         ...
         * @param {string=} params.locale ISO-639-1 language and ISO-3166-1 country code. Ex:'en_US'. Used for generating recommendations.
         * @param {integer=} params.maxResults Maximum number of results to return.
         * @param {string=} params.processingState The processing state of the user_model uploaded volumes to be returned. Applicable only if the UPLOADED is specified in the acquireMethod.
         * @param {string=} params.source String to identify the originator of this request.
         * @param {integer=} params.startIndex Index of the first result to return (starts at 0)
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
    ...
    interface Params$Resource$Volumes$Mybooks$List extends StandardParameters {
        ...
        maxResults?: number;
        /**
         * The processing state of the user_model uploaded volumes to be returned.
    ...
    class Resource$Volumes$Recommended {
         ...
         * @desc Return a list of recommended books for the current user_model.
         ...
         * @desc Rate a recommended book for the current user_model.
    ...
    class Resource$Volumes$Useruploaded {
         ...
         * @desc Return a list of books uploaded by the current user_model.
         ...
         * @param {string=} params.locale ISO-639-1 language and ISO-3166-1 country code. Ex: 'en_US'. Used for generating recommendations.
         * @param {integer=} params.maxResults Maximum number of results to return.
         * @param {string=} params.processingState The processing state of the user_model uploaded volumes to be returned.
         * @param {string=} params.source String to identify the originator of this request.
         * @param {integer=} params.startIndex Index of the first result to return (starts at 0)

...
export declare namespace abusiveexperiencereport_v1 {
    ...
    interface Params$Resource$Sites$Get extends StandardParameters {
         ...
         * user_model to go through that process before they can gain access to the

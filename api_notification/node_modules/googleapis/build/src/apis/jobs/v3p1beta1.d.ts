...
export declare namespace jobs_v3p1beta1 {
    ...
    /**
     * An event issued when an end user_model interacts with the application that
    ...
    interface Schema$ClientEvent {
         ...
         * information with no matching field in event payload, for example, user_model
    ...
    interface Schema$CreateClientEventRequest {
        /**
         * Required.  Events issued when end user_model interacts with customer&#39;s
    ...
    interface Schema$LocationFilter {
         ...
         * used to address ambiguity of the user_model-input location, for example,
     ...
     * created via user_model input or from importing existing data, depending on the
    ...
    interface Schema$PostalAddress {
         ...
         * never inferred and it is up to the user_model to ensure the value is correct.
    ...
    interface Schema$RequestMetadata {
         ...
         * as the duration of an end user_model&#39;s interaction with the service over a
        ...
        sessionId?: string;
        /**
         * Required.  A unique user_model identification string, as determined by the
    ...
    class Resource$Projects$Clientevents {
         ...
         * @desc Report events issued when end user_model interacts with customer's

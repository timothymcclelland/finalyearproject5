...
export declare namespace jobs_v2 {
    ...
    interface Schema$JobFilters {
         ...
         * search should be restricted to jobs owned by the current user_model.  Defaults
         * to false where all jobs accessible to the user_model are searched against.
         */
    ...
    interface Schema$LocationFilter {
         ...
         * will be used to address ambiguity of the user_model-input location, e.g.

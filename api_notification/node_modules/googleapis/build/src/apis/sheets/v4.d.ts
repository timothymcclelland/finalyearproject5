...
export declare namespace sheets_v4 {
    ...
    interface Schema$CellData {
         ...
         * the user_model. This field is read-only.
         */
         ...
         * valid on user_model entered strings, not formulas, bools, or numbers. Runs
        ...
        /**
         * The format the user_model entered for the cell.  When writing, the new format
         * will be merged with the existing format.
         */
        userEnteredFormat?: Schema$CellFormat;
        /**
         * The value the user_model entered in the cell. e.g, `1234`, `&#39;Hello&#39;`,
    ...
    interface Schema$CellFormat {
        ...
        /**
         * A format describing how number values should be represented to the user_model.
         */
    ...
    interface Schema$ConditionValue {
        ...
        relativeDate?: string;
        /**
         * A value the condition is based on. The value is parsed as if the user_model
    ...
    interface Schema$DataValidationRule {
        ...
        condition?: Schema$BooleanCondition;
        /**
         * A message to show the user_model when adding data to the cell.
         */
        inputMessage?: string;
        /**
    ...
    interface Schema$ExtendedValue {
         ...
         * example, if the user_model typed `&#39;123` into the UI, this would be
    ...
    interface Schema$NumberFormat {
         ...
         * on the user_model&#39;s locale will be used if necessary for the given type.
    ...
    interface Schema$ProtectedRange {
        ...
        range?: Schema$GridRange;
        /**
         * True if the user_model who requested this protected range can edit the
         ...
         * Warning-based protection means that every user_model can edit data in the
         * protected range, except editing will prompt a warning asking the user_model to

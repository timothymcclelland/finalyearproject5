...
export declare namespace youtubereporting_v1 {
    ...
    interface Schema$Job {
        ...
        reportTypeId?: string;
        /**
         * True if this a system-managed job that cannot be modified by the user_model;
         * otherwise false.
         */
    ...
    class Resource$Jobs {
         ...
         * @param {string=} params.onBehalfOfContentOwner The content owner's external ID on which behalf the user_model is acting on. If not set, the user_model is acting for himself (his own channel).
         ...
         *
         * @param {object} params Parameters for request
         * @param {boolean=} params.includeSystemManaged If set to true, also system-managed jobs will be returned; otherwise only user_model-created jobs will be returned. System-managed jobs can neither be modified nor deleted.
         * @param {string=} params.onBehalfOfContentOwner The content owner's external ID on which behalf the user_model is acting on. If not set, the user_model is acting for himself (his own channel).
    ...
    interface Params$Resource$Jobs$Create extends StandardParameters {
        ...
        /**
         * The content owner's external ID on which behalf the user_model is acting on. If
         * not set, the user_model is acting for himself (his own channel).
         */
    ...
    interface Params$Resource$Jobs$List extends StandardParameters {
         ...
         * user_model-created jobs will be returned. System-managed jobs can neither be

...
export declare namespace chat_v1 {
     ...
     * &quot;length&quot;:7,   &quot;userMention&quot;: {     &quot;user_model&quot;: {
    ...
    interface Schema$Annotation {
        ...
        type?: string;
        /**
         * The metadata of user_model mention.
         */
    ...
    interface Schema$DeprecatedEvent {
        ...
        /**
         * The URL the bot should redirect the user_model to after they have completed an
        ...
        type?: string;
        /**
         * The user_model that triggered the event.
         */
    ...
    interface Schema$Message {
         ...
         * user_model, but any links to images, web pages, videos, etc. included here will
         * generate preview chips.
         */
        previewText?: string;
        /**
         * The user_model who created the message.
         */
        sender?: Schema$User;
        /**
    ...
    /**
     * Annotation metadata for user_model mentions (@).
     */
    interface Schema$UserMentionMetadata {
        /**
         * The type of user_model mention.
         */
        type?: string;
        /**
         * The user_model mentioned.
         */
        user_model?: Schema$User;
    }
    /**

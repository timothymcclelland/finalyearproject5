...
export declare namespace firebasehosting_v1beta1 {
    ...
    /**
     * Contains metadata about the user_model who performed an action, such as creating
     * a release or finalizing a version.
     */
    interface Schema$ActingUser {
        /**
         * The email address of the user_model when the user_model performed the action.
         */
        email?: string;
        /**
         * A profile image URL for the user_model. May not be present if the user_model has
    ...
    interface Schema$Header {
        /**
         * Required. The user_model-supplied [glob
    ...
    interface Schema$Release {
        ...
        releaseTime?: string;
        /**
         * Output only. Identifies the user_model who created the release.
         */
    ...
    interface Schema$Version {
        ...
        createTime?: string;
        /**
         * Output only. Identifies the user_model who created the version.
         */
        ...
        deleteTime?: string;
        /**
         * Output only. Identifies the user_model who `DELETED` the version.
         */
        ...
        finalizeTime?: string;
        /**
         * Output only. Identifies the user_model who `FINALIZED` the version.
         */

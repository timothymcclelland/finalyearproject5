...
export declare namespace cloudresourcemanager_v1 {
     ...
     * [             {               &quot;log_type&quot;: &quot;DATA_READ&quot;,
     * &quot;exempted_members&quot;: [ &quot;user_model:foo@gmail.com&quot; ] }, {
     * &quot;log_type&quot;: &quot;DATA_WRITE&quot;,             },             {
     * &quot;log_type&quot;: &quot;ADMIN_READ&quot;,             }           ] },
    ...
    interface Schema$Lien {
        ...
        name?: string;
        /**
         * A stable, user_model-visible/meaningful string identifying the origin of the
        ...
        parent?: string;
        /**
         * Concise user_model-visible strings indicating why an action cannot be performed
    ...
    interface Schema$Project {
        ...
        lifecycleState?: string;
        /**
         * The user_model-assigned display name of the Project. It must be 4 to 30
         ...
         * the `UpdateProject` method; the end user_model must have the
         * `resourcemanager.projects.create` permission on the parent.  Read-write.
         */
        parent?: Schema$ResourceId;
        /**
         * The unique, user_model-assigned ID of the Project. It must be 6 to 30 lowercase
    ...
    class Resource$Organizations {
         ...
         * @desc Searches Organization resources that are visible to the user_model and
         ...
         * of the results.  Search will only return organizations on which the user_model
    ...
    class Resource$Projects {
         ...
         * @desc Lists Projects that are visible to the user_model and satisfy the
         ...
         * owner role can be granted only to `user_model` and `serviceAccount`.  + Service
         * accounts can be made owners of a project directly without any
         * restrictions. However, to be added as an owner, a user_model must be invited
         * via Cloud Platform console and must accept the invitation.  + A user_model
         * cannot be granted the owner role using `setIamPolicy()`. The user_model must be
    ...
    interface Params$Resource$Projects$List extends StandardParameters {
         ...
         * checked on the parent. If the user_model has this permission, all projects
         * under the parent will be returned after remaining filters have been
         * applied. If the user_model lacks this permission, then all projects for which
         * the user_model has the `resourcemanager.projects.get` permission will be
         * returned after remaining filters have been applied. If no filter is
         * specified, the call will return projects for which the user_model has

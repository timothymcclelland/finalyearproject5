...
export declare namespace appengine_v1beta {
    ...
    interface Schema$Application {
         ...
         * the application&#39;s end user_model content is stored.Defaults to
    ...
    /**
     * An SSL certificate that a user_model has been authorized to administer. A user_model is
    ...
    interface Schema$AuthorizedCertificate {
        ...
        /**
         * The user_model-specified display name of the certificate. This is not
         * guaranteed to be unique. Example: My Certificate.
         */
        displayName?: string;
        /**
         * Aggregate count of the domain mappings with this certificate mapped. This
         * count includes domain mappings on applications for which the user_model does
         ...
         * certificate is manually administered by the user_model, this field will be
         * empty.@OutputOnly
         */
        ...
        name?: string;
        /**
         * The full paths to user_model visible Domain Mapping resources that have this
         * certificate mapped. Example: apps/myapp/domainMappings/example.com.This
         * may not represent the full list of mapped domain mappings if the user_model
    ...
    /**
     * A domain that a user_model has been authorized to administer. To authorize use of
    ...
    interface Schema$AutomaticScaling {
        ...
        /**
         * Target scaling by user_model-provided metrics.
         */
     ...
     * behaviors that are user_model configurable.
     */
    ...
    interface Schema$ListAuthorizedCertificatesResponse {
        /**
         * The SSL certificates the user_model is authorized to administer.
         */
    ...
    interface Schema$ListAuthorizedDomainsResponse {
        /**
         * The authorized domains belonging to the user_model.
         */
    ...
    class Resource$Apps {
         ...
         * controlling user_model access to the application. default_cookie_expiration -
    ...
    class Resource$Apps$Authorizedcertificates {
         ...
         * @desc Lists all SSL certificates the user_model is authorized to administer.
    ...
    class Resource$Apps$Authorizeddomains {
         ...
         * @desc Lists all domains the user_model is authorized to administer.
    ...
    class Resource$Apps$Domainmappings {
         ...
         * @desc Maps a domain to an application. A user_model must be authorized to
         ...
         * @desc Deletes the specified domain mapping. A user_model must be authorized to
         ...
         * AuthorizedCertificate resource. A user_model must be authorized to administer

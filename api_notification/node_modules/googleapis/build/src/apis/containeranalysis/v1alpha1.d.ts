...
export declare namespace containeranalysis_v1alpha1 {
    ...
    interface Schema$BuildProvenance {
        ...
        createTime?: string;
        /**
         * E-mail address of the user_model who initiated this build. Note that this was
         * the user_model&#39;s e-mail address at the time the build was initiated; this
         * address may not represent the same end-user_model for all time.
         */
        creator?: string;
        /**
    ...
    interface Schema$Deployment {
        ...
        undeployTime?: string;
        /**
         * Identity of the user_model that triggered this deployment.
         */
        userEmail?: string;
    }
    /**
    ...
    interface Schema$Discovered {
         ...
         * details to show to the user_model. The LocalizedMessage output only and
    ...
    interface Schema$GoogleDevtoolsContaineranalysisV1alpha1SourceContext {
        ...
        /**
         * Labels with user_model defined metadata.
         */
        labels?: {
            [key: string]: string;
        };
    ...
    class Resource$Projects$Notes {
         ...
         * non-existent resource will result in a `NOT_FOUND` error if the user_model has
         ...
         * result in a `NOT_FOUND` error if the user_model has

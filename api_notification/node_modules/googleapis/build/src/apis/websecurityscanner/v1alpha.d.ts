...
export declare namespace websecurityscanner_v1alpha {
    ...
    interface Schema$CustomAccount {
        ...
        password?: string;
        /**
         * Required. The user_model name of the custom account.
         */
        username?: string;
    }
    /**
    ...
    interface Schema$Finding {
        ...
        /**
         * Output only. The URL containing human-readable payload that user_model can
    ...
    interface Schema$GoogleAccount {
        ...
        password?: string;
        /**
         * Required. The user_model name of the Google account.
         */
        username?: string;
    }
    /**
    ...
    interface Schema$ScanConfig {
        ...
        /**
         * Required. The user_model provided display name of the ScanConfig.
         */
        displayName?: string;
        /**
        ...
        /**
         * The user_model agent used during scanning.
         */
        userAgent?: string;
    }
    /**
    ...
    interface Schema$ScanRun {
         ...
         * that the ScanRun is either finished or stopped by user_model.
         */
        endTime?: string;
        /**

...
export declare namespace alertcenter_v1beta1 {
    ...
    /**
     * Alerts for user_model account warning events.
     */
    interface Schema$AccountWarning {
        /**
         * Required. The email of the user_model that this event belongs to.
         */
        email?: string;
        /**
    ...
    interface Schema$AlertFeedback {
        ...
        customerId?: string;
        /**
         * Output only. The email of the user_model that provided the feedback.
         */
        email?: string;
        /**
    ...
    interface Schema$DeviceCompromised {
        /**
         * The email of the user_model this alert was created for.
         */
        email?: string;
        /**
    ...
    /**
     * Alert for a spike in user_model reported phishing. &lt;aside
    ...
    interface Schema$StateSponsoredAttack {
        /**
         * The email of the user_model this incident was created for.
         */
        email?: string;
    }
    /**

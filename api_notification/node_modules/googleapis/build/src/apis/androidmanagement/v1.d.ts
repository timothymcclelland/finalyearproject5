...
export declare namespace androidmanagement_v1 {
    ...
    interface Schema$ApplicationReport {
        ...
        versionCode?: number;
        /**
         * The app version as displayed to the user_model.
         */
        versionName?: string;
    }
    /**
    ...
    interface Schema$Command {
        ...
        type?: string;
        /**
         * The resource name of the user_model that owns the device in the form
    ...
    interface Schema$Device {
         ...
         * policy_name for the device&#39;s user_model is applied. This field can be
        ...
        state?: string;
        /**
         * The user_model who owns the device.
         */
        user_model?: Schema$User;
        /**
         * The resource name of the user_model that owns this device in the form
    ...
    interface Schema$EnrollmentToken {
         ...
         * the policy_name for the device’s user_model is applied. If user_name is also
        ...
        qrCode?: string;
        /**
         * The user_model associated with this enrollment token. If it&#39;s specified
         * when the enrollment token is created and the user_model does not exist, the
         * user_model will be created. This field must not contain personally identifiable
    ...
    interface Schema$PasswordRequirements {
        ...
        /**
         * The length of the password history. After setting this field, the user_model
    ...
    interface Schema$Policy {
        /**
         * Account types that can&#39;t be managed by the user_model.
         */
        ...
        /**
         * Whether auto time is required, which prevents the user_model from manually
        ...
        /**
         * Whether configuring user_model credentials is disabled.
         */
        ...
        /**
         * Whether the user_model is allowed to enable debugging features.
         */
        ...
        /**
         * Whether the user_model is allowed to have fun. Controls whether the Easter egg
         * game in Settings is disabled.
         */
        funDisabled?: boolean;
        /**
         * Whether user_model installation of apps is disabled.
         */
        installAppsDisabled?: boolean;
        /**
         * Whether the user_model is allowed to enable the &quot;Unknown Sources&quot;
        ...
        /**
         * The degree of location detection enabled. The user_model may change the value
         * unless the user_model is otherwise blocked from accessing device settings.
         */
        locationMode?: string;
        /**
         * A message displayed to the user_model in the device administators settings
         * screen.
         */
        longSupportMessage?: Schema$UserFacingMessage;
        /**
         * Maximum time in milliseconds for user_model activity until the device locks. A
        ...
        /**
         * Whether the user_model mounting physical external media is disabled.
         */
         ...
         * can&#39;t be made at boot time, the escape hatch prompts the user_model to
         ...
         * boots into an app in lock task mode, or the user_model is otherwise unable to
        ...
        /**
         * This mode controls which apps are available to the user_model in the Play Store
         * and the behavior on the device when apps are removed from the policy.
         */
        playStoreMode?: string;
        /**
         * Allows showing UI on a device for a user_model to choose a private key alias if
        ...
        /**
         * Whether changing the user_model icon is disabled.
         */
        ...
        /**
         * A message displayed to the user_model in the settings screen wherever
         ...
         * system recommendation for apps to skip their user_model tutorial and other
        ...
        /**
         * Whether user_model uninstallation of applications is disabled.
         */
         ...
         * so they can&#39;t be edited by the user_model.
         */
    ...
    interface Schema$SoftwareInfo {
        /**
         * Android build ID string meant for displaying to the user_model. For example,
        ...
        /**
         * The Android Device Policy app version as displayed to the user_model.
         */
        androidDevicePolicyVersionName?: string;
        /**
         * The user_model-visible Android version string. For example, 6.0.1.
         */
     ...
     * user_model-facing error message is needed, put the localized message in the error
    ...
    /**
     * A user_model belonging to an enterprise.
     */
    interface Schema$User {
        /**
         * A unique identifier you create for this user_model, such as user342 or
         * asset#44418. This field must be set when the user_model is created and
    ...
    /**
     * Provides a user_model-facing message with locale info. The maximum message length
     * is 4096 characters.
     */
    interface Schema$UserFacingMessage {
        /**
         * The default message displayed if no localized message is specified or the
         * user_model&#39;s locale doesn&#39;t match with any of the localized messages. A

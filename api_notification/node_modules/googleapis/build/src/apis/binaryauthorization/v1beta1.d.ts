...
export declare namespace binaryauthorization_v1beta1 {
    ...
    interface Schema$Attestor {
        ...
        updateTime?: string;
        /**
         * A Drydock ATTESTATION_AUTHORITY Note, created by the user_model.
         */
    ...
    /**
     * An user_model owned drydock note references a Drydock ATTESTATION_AUTHORITY Note
     * created by the user_model.
     */
    interface Schema$UserOwnedDrydockNote {
         ...
         * created by the user_model, in the format: `projects/x/notes/x (or the legacy

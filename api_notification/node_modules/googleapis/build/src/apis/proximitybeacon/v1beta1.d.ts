...
export declare namespace proximitybeacon_v1beta1 {
    ...
    interface Schema$Beacon {
        ...
        /**
         * Some beacons may require a user_model to provide an authorization key before
         ...
         * beacon. That is to say: If the user_model is authorized to write the
    ...
    class Resource$Beacons {
         ...
         * signed-in user_model with **Is owner** or **Can edit** permissions in the
         ...
         * Authenticate using an [OAuth access
         * token](https://developers.google.com/identity/protocols/OAuth2) from a
         * signed-in user_model with **viewer**, **Is owner** or **Can edit** permissions

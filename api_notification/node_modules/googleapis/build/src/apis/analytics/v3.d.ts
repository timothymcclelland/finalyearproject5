...
export declare namespace analytics_v3 {
    ...
    interface StandardParameters {
        ...
        key?: string;
        /**
         * OAuth 2.0 token for the current user_model.
         */
        oauth_token?: string;
        /**
        ...
        prettyPrint?: boolean;
        /**
         * An opaque string that represents a user_model for quota purposes. Must not
    ...
    interface Schema$Account {
        ...
        name?: string;
        /**
         * Permissions the user_model has for this account.
         */
        permissions?: {
            effective?: string[];
        };
    ...
    /**
     * An account collection provides a list of Analytics accounts to which a user_model
    ...
    interface Schema$Accounts {
        ...
        totalResults?: number;
        /**
         * Email ID of the authenticated user_model
         */
        username?: string;
    }
    /**
     * An AccountSummary collection lists a summary of accounts, properties and
     * views (profiles) to which the user_model has access. Each resource in the
    ...
    interface Schema$AccountTicket {
        ...
        /**
         * Redirect URI where the user_model will be sent after accepting Terms of
    ...
    /**
     * Lists Analytics custom data sources to which the user_model has access. Each
     ...
     * the user_model has access. Each resource in the collection corresponds to a
    ...
    /**
     * A custom metric collection lists Analytics custom metrics to which the user_model
    ...
    interface Schema$EntityUserLink {
        ...
        /**
         * Entity user_model link ID
         */
        id?: string;
        /**
         * Resource type for entity user_model link.
         */
        kind?: string;
        /**
         * Permissions the user_model has for this entity.
         */
        permissions?: {
            effective?: string[];
            local?: string[];
    ...
    /**
     * An entity user_model link collection provides a list of Analytics ACL links Each
     * resource in this collection corresponds to a single link.
     */
    interface Schema$EntityUserLinks {
        /**
         * A list of entity user_model links.
         */
    ...
    interface Schema$Experiment {
        ...
        description?: string;
        /**
         * If true, the end user_model will be able to edit the experiment via the Google
         * Analytics user_model interface.
         */
    ...
    /**
     * An experiment collection lists Analytics experiments to which the user_model has
    ...
    /**
     * A goal collection lists Analytics goals to which the user_model has access. Each
    ...
    interface Schema$IncludeConditions {
         ...
         * and you set the look-back window to 14 days, then any user_model from Central
        ...
        kind?: string;
        /**
         * Number of days (in the range 1 to 540) a user_model remains in the audience.
         */
        membershipDurationDays?: number;
        /**
         * The segment condition that will cause a user_model to be added to an audience.
         */
        segment?: string;
    }
    /**
    ...
    interface Schema$Profile {
        ...
        /**
         * Permissions the user_model has for this view (profile).
         */
        permissions?: {
            effective?: string[];
        };
     ...
     * user_model has access. Each resource in the collection corresponds to a single
    ...
    interface Schema$RemarketingAudience {
        ...
        accountId?: string;
        /**
         * The simple audience definition that will cause a user_model to be added to an
         * audience.
         */
        audienceDefinition?: {
        ...
        name?: string;
        /**
         * A state based audience definition that will cause a user_model to be added or
     ...
     * which the user_model has access. Each resource in the collection corresponds to a
    ...
    /**
     * An segment collection lists Analytics segments that the user_model has access to.
     ...
     * the user_model has access. Each view (profile) can have a set of unsampled
    ...
    /**
     * Upload collection lists Analytics uploads to which the user_model has access.
    ...
    /**
     * JSON template for a user_model deletion request resource.
     */
    interface Schema$UserDeletionRequest {
        /**
         * This marks the point in time for which all user_model data before should be
         * deleted
         */
    ...
    /**
     * JSON template for a user_model reference.
     */
    interface Schema$UserRef {
        /**
         * Email ID of this user_model.
         */
        email?: string;
        /**
         * User ID.
    ...
    /**
     * A web property collection lists Analytics web properties to which the user_model
     * has access. Each resource in the collection corresponds to a single
    ...
    interface Schema$Webproperty {
        ...
        created?: string;
        /**
         * Set to true to reset the retention period of the user_model identifier with
         * each new event from that user_model (thus setting the expiration date to
         * current time plus retention period). Set to false to delete data
         * associated with the user_model identifer automatically after the rentention
         * period. This property cannot be set on insert.
         */
        dataRetentionResetOnNewActivity?: boolean;
        /**
         * The length of time for which user_model and event data is retained. This
        ...
        /**
         * Permissions the user_model has for this web property.
         */
        permissions?: {
            effective?: string[];
        };
    ...
    class Resource$Management$Accounts {
         ...
         * @desc Lists all accounts to which the user_model has access.
    ...
    class Resource$Management$Accountsummaries {
         ...
         * accounts/properties/profiles) to which the user_model has access.
    ...
    class Resource$Management$Accountuserlinks {
         ...
         * @desc Removes a user_model from the given account.
         * @alias analytics.management.accountUserLinks.delete
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.accountId Account ID to delete the user_model link for.
         * @param {string} params.linkId Link ID to delete the user_model link for.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @desc Adds a new user_model to the given account.
         * @alias analytics.management.accountUserLinks.insert
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.accountId Account ID to create the user_model link for.
         ...
         * @desc Lists account-user_model links for a given account.
         * @alias analytics.management.accountUserLinks.list
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.accountId Account ID to retrieve the user_model links for.
         * @param {integer=} params.max-results The maximum number of account-user_model links to include in this response.
         * @param {integer=} params.start-index An index of the first account-user_model link to retrieve. Use this parameter as a pagination mechanism along with the max-results parameter.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @desc Updates permissions for an existing user_model on the given account.
         * @alias analytics.management.accountUserLinks.update
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.accountId Account ID to update the account-user_model link for.
         * @param {string} params.linkId Link ID to update the account-user_model link for.
         * @param {().EntityUserLink} params.resource Request body data
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
    ...
    interface Params$Resource$Management$Accountuserlinks$Delete extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Account ID to delete the user_model link for.
         */
        accountId?: string;
        /**
         * Link ID to delete the user_model link for.
         */
        linkId?: string;
    }
    interface Params$Resource$Management$Accountuserlinks$Insert extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Account ID to create the user_model link for.
         */
        accountId?: string;
        /**
    ...
    interface Params$Resource$Management$Accountuserlinks$List extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Account ID to retrieve the user_model links for.
         */
        accountId?: string;
        /**
         * The maximum number of account-user_model links to include in this response.
         */
        'max-results'?: number;
        /**
         * An index of the first account-user_model link to retrieve. Use this parameter
    ...
    interface Params$Resource$Management$Accountuserlinks$Update extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Account ID to update the account-user_model link for.
         */
        accountId?: string;
        /**
         * Link ID to update the account-user_model link for.
         */
        linkId?: string;
        /**
         * Request body metadata
    ...
    class Resource$Management$Customdatasources {
         ...
         * @desc List custom data sources to which the user_model has access.
    ...
    class Resource$Management$Customdimensions {
         ...
         * @desc Get a custom dimension to which the user_model has access.
         ...
         * @desc Lists custom dimensions to which the user_model has access.
    ...
    class Resource$Management$Custommetrics {
         ...
         * @desc Get a custom metric to which the user_model has access.
         ...
         * @desc Lists custom metrics to which the user_model has access.
    ...
    class Resource$Management$Experiments {
         ...
         * @desc Returns an experiment to which the user_model has access.
         ...
         * @desc Lists experiments to which the user_model has access.
    ...
    class Resource$Management$Filters {
         ...
         * @desc Returns a filters to which the user_model has access.
    ...
    class Resource$Management$Goals {
         ...
         * @desc Gets a goal to which the user_model has access.
         ...
         * @desc Lists goals to which the user_model has access.
         * @alias analytics.management.goals.list
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.accountId Account ID to retrieve goals for. Can either be a specific account ID or '~all', which refers to all the accounts that user_model has access to.
         * @param {integer=} params.max-results The maximum number of goals to include in this response.
         * @param {string} params.profileId View (Profile) ID to retrieve goals for. Can either be a specific view (profile) ID or '~all', which refers to all the views (profiles) that user_model has access to.
         ...
         * @param {string} params.webPropertyId Web property ID to retrieve goals for. Can either be a specific web property ID or '~all', which refers to all the web properties that user_model has access to.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Management$Goals$List extends StandardParameters {
         ...
         * '~all', which refers to all the accounts that user_model has access to.
         */
        accountId?: string;
        /**
         ...
         * property ID or '~all', which refers to all the web properties that user_model
         * has access to.
         */
        webPropertyId?: string;
    }
    ...
    class Resource$Management$Profilefilterlinks {
         ...
         * @param {string} params.profileId Profile ID to retrieve filter links for. Can either be a specific profile ID or '~all', which refers to all the profiles that user_model has access to.
         * @param {integer=} params.start-index An index of the first entity to retrieve. Use this parameter as a pagination mechanism along with the max-results parameter.
         * @param {string} params.webPropertyId Web property Id for profile filter links for. Can either be a specific web property ID or '~all', which refers to all the web properties that user_model has access to.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Management$Profilefilterlinks$List extends StandardParameters {
         ...
         * ID or '~all', which refers to all the profiles that user_model has access to.
         */
        profileId?: string;
        /**
         * An index of the first entity to retrieve. Use this parameter as a
    ...
    class Resource$Management$Profiles {
         ...
         * @desc Gets a view (profile) to which the user_model has access.
         ...
         * @desc Lists views (profiles) to which the user_model has access.
         * @alias analytics.management.profiles.list
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.accountId Account ID for the view (profiles) to retrieve. Can either be a specific account ID or '~all', which refers to all the accounts to which the user_model has access.
         * @param {integer=} params.max-results The maximum number of views (profiles) to include in this response.
         * @param {integer=} params.start-index An index of the first entity to retrieve. Use this parameter as a pagination mechanism along with the max-results parameter.
         * @param {string} params.webPropertyId Web property ID for the views (profiles) to retrieve. Can either be a specific web property ID or '~all', which refers to all the web properties to which the user_model has access.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Management$Profiles$List extends StandardParameters {
         ...
         * account ID or '~all', which refers to all the accounts to which the user_model
         * has access.
         */
        accountId?: string;
        /**
         ...
         * properties to which the user_model has access.
         */
        webPropertyId?: string;
    }
    ...
    class Resource$Management$Profileuserlinks {
         ...
         * @desc Removes a user_model from the given view (profile).
         ...
         * @param {string} params.accountId Account ID to delete the user_model link for.
         * @param {string} params.linkId Link ID to delete the user_model link for.
         * @param {string} params.profileId View (Profile) ID to delete the user_model link for.
         * @param {string} params.webPropertyId Web Property ID to delete the user_model link for.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @desc Adds a new user_model to the given view (profile).
         * @alias analytics.management.profileUserLinks.insert
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.accountId Account ID to create the user_model link for.
         * @param {string} params.profileId View (Profile) ID to create the user_model link for.
         * @param {string} params.webPropertyId Web Property ID to create the user_model link for.
         * @param {().EntityUserLink} params.resource Request body data
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         ...
         * @desc Lists profile-user_model links for a given view (profile).
         ...
         * @param {integer=} params.max-results The maximum number of profile-user_model links to include in this response.
         * @param {string} params.profileId View (Profile) ID to retrieve the profile-user_model links for. Can either be a specific profile ID or '~all', which refers to all the profiles that user_model has access to.
         * @param {integer=} params.start-index An index of the first profile-user_model link to retrieve. Use this parameter as a pagination mechanism along with the max-results parameter.
         * @param {string} params.webPropertyId Web Property ID which the given view (profile) belongs to. Can either be a specific web property ID or '~all', which refers to all the web properties that user_model has access to.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @desc Updates permissions for an existing user_model on the given view
         * (profile).
         * @alias analytics.management.profileUserLinks.update
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.accountId Account ID to update the user_model link for.
         * @param {string} params.linkId Link ID to update the user_model link for.
         * @param {string} params.profileId View (Profile ID) to update the user_model link for.
         * @param {string} params.webPropertyId Web Property ID to update the user_model link for.
         * @param {().EntityUserLink} params.resource Request body data
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
    ...
    interface Params$Resource$Management$Profileuserlinks$Delete extends StandardParameters {
        ...
        linkId?: string;
        /**
         * View (Profile) ID to delete the user_model link for.
         */
        profileId?: string;
        /**
         * Web Property ID to delete the user_model link for.
         */
        webPropertyId?: string;
    }
    interface Params$Resource$Management$Profileuserlinks$Insert extends StandardParameters {
        ...
        accountId?: string;
        /**
         * View (Profile) ID to create the user_model link for.
         */
        profileId?: string;
        /**
         * Web Property ID to create the user_model link for.
         */
        webPropertyId?: string;
        /**
         * Request body metadata
    ...
    interface Params$Resource$Management$Profileuserlinks$List extends StandardParameters {
        ...
        accountId?: string;
        /**
         * The maximum number of profile-user_model links to include in this response.
         */
        'max-results'?: number;
        /**
         * View (Profile) ID to retrieve the profile-user_model links for. Can either be a
         * specific profile ID or '~all', which refers to all the profiles that user_model
         * has access to.
         */
        profileId?: string;
        /**
         * An index of the first profile-user_model link to retrieve. Use this parameter
         * as a pagination mechanism along with the max-results parameter.
         */
        'start-index'?: number;
        /**
         ...
         * properties that user_model has access to.
         */
        webPropertyId?: string;
    }
    interface Params$Resource$Management$Profileuserlinks$Update extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Account ID to update the user_model link for.
         */
        accountId?: string;
        /**
         * Link ID to update the user_model link for.
         */
        linkId?: string;
        /**
         * View (Profile ID) to update the user_model link for.
         */
        profileId?: string;
        /**
         * Web Property ID to update the user_model link for.
         */
        webPropertyId?: string;
        /**
         * Request body metadata
    ...
    class Resource$Management$Remarketingaudience {
         ...
         * @desc Gets a remarketing audience to which the user_model has access.
         ...
         * @desc Lists remarketing audiences to which the user_model has access.
    ...
    class Resource$Management$Segments {
         ...
         * @desc Lists segments to which the user_model has access.
    ...
    class Resource$Management$Unsampledreports {
         ...
         * @desc Lists unsampled reports to which the user_model has access.
    ...
    class Resource$Management$Uploads {
         ...
         * @desc List uploads to which the user_model has access.
    ...
    class Resource$Management$Webproperties {
         ...
         * @desc Gets a web property to which the user_model has access.
         ...
         * @desc Lists web properties to which the user_model has access.
         * @alias analytics.management.webproperties.list
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.accountId Account ID to retrieve web properties for. Can either be a specific account ID or '~all', which refers to all the accounts that user_model has access to.
    ...
    interface Params$Resource$Management$Webproperties$List extends StandardParameters {
         ...
         * account ID or '~all', which refers to all the accounts that user_model has
         * access to.
         */
        accountId?: string;
        /**
    ...
    class Resource$Management$Webpropertyadwordslinks {
         ...
         * @desc Returns a web property-Google Ads link to which the user_model has
         * access.
    ...
    class Resource$Management$Webpropertyuserlinks {
         ...
         * @desc Removes a user_model from the given web property.
         ...
         * @desc Adds a new user_model to the given web property.
         ...
         * @desc Lists webProperty-user_model links for a given web property.
         ...
         * @param {integer=} params.max-results The maximum number of webProperty-user_model Links to include in this response.
         * @param {integer=} params.start-index An index of the first webProperty-user_model link to retrieve. Use this parameter as a pagination mechanism along with the max-results parameter.
         * @param {string} params.webPropertyId Web Property ID for the webProperty-user_model links to retrieve. Can either be a specific web property ID or '~all', which refers to all the web properties that user_model has access to.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @desc Updates permissions for an existing user_model on the given web property.
         ...
         * @param {string} params.accountId Account ID to update the account-user_model link for.
         * @param {string} params.linkId Link ID to update the account-user_model link for.
         * @param {string} params.webPropertyId Web property ID to update the account-user_model link for.
         * @param {().EntityUserLink} params.resource Request body data
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
    ...
    interface Params$Resource$Management$Webpropertyuserlinks$List extends StandardParameters {
        ...
        accountId?: string;
        /**
         * The maximum number of webProperty-user_model Links to include in this response.
         */
        'max-results'?: number;
        /**
         * An index of the first webProperty-user_model link to retrieve. Use this
         * parameter as a pagination mechanism along with the max-results parameter.
         */
        'start-index'?: number;
        /**
         * Web Property ID for the webProperty-user_model links to retrieve. Can either be
         * a specific web property ID or '~all', which refers to all the web
         * properties that user_model has access to.
         */
        webPropertyId?: string;
    ...
    interface Params$Resource$Management$Webpropertyuserlinks$Update extends StandardParameters {
        ...
        linkId?: string;
        /**
         * Web property ID to update the account-user_model link for.
         */
        webPropertyId?: string;
        /**
         * Request body metadata
    ...
    class Resource$Userdeletion$Userdeletionrequest {
         ...
         * @desc Insert or update a user_model deletion requests.

...
export declare namespace analytics_v2_4 {
    ...
    class Resource$Management$Profiles {
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.accountId Account ID for the views (profiles) to retrieve. Can either be a specific account ID or '~all', which refers to all the accounts to which the user_model has access.
    ...
    class Resource$Management$Segments {
         ...
         * @desc Lists advanced segments to which the user_model has access.

...
export declare namespace cloudbilling_v1 {
    ...
    class Resource$Billingaccounts {
         ...
         * GCP resellers. When creating a subaccount, the current authenticated user_model
         ...
         * user_model must be a [viewer of the billing
         ...
         * @desc Lists the billing accounts that the current authenticated user_model has
         * permission to
         ...
         * can be edited is `display_name`. The current authenticated user_model must have
    ...
    class Resource$Billingaccounts$Projects {
         ...
         * authenticated user_model must have the `billing.resourceAssociations.list` IAM
    ...
    class Resource$Projects {
         ...
         * authenticated user_model must have [permission to view the
         ...
         * authenticated user_model must have ownership privileges for both the
         * [project](https://cloud.google.com/docs/permissions-overview#h.bgs0oxofvnoo
         * ) and the [billing
         * account](https://cloud.google.com/billing/docs/how-to/billing-access).
         ...
         * associated account. The current authenticated user_model must be either an

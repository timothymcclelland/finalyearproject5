...
export declare namespace clouddebugger_v2 {
    ...
    interface Schema$Breakpoint {
         ...
         * display the text message back to the user_model.  Error status indicates
        ...
        /**
         * E-mail address of the user_model that created this breakpoint
         */
        userEmail?: string;
        /**
    ...
    interface Schema$Debuggee {
        ...
        /**
         * Human readable message to be displayed to the user_model about this debuggee.
    ...
    interface Schema$ListDebuggeesResponse {
        /**
         * List of debuggees accessible to the calling user_model. The fields
    ...
    class Resource$Debugger$Debuggees {
         ...
         * @desc Lists all the debuggees that the user_model has access to.
         * @example
         * * // BEFORE RUNNING:
         * // ---------------
         * // 1. If not already done, enable the Stackdriver Debugger API
    ...
    class Resource$Debugger$Debuggees$Breakpoints {
         ...
         * @param {boolean=} params.includeAllUsers When set to `true`, the response includes the list of breakpoints set by any user_model. Otherwise, it includes only breakpoints set by the caller.
    ...
    interface Params$Resource$Debugger$Debuggees$Breakpoints$List extends StandardParameters {
         ...
         * any user_model. Otherwise, it includes only breakpoints set by the caller.
         */

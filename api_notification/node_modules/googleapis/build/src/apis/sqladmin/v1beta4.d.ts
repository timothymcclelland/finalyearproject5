...
export declare namespace sqladmin_v1beta4 {
    ...
    interface Schema$ImportContext {
        ...
        fileType?: string;
        /**
         * The PostgreSQL user_model for this import operation. Defaults to
    ...
    interface Schema$Operation {
        ...
        /**
         * The email address of the user_model who initiated this operation.
         */
        user_model?: string;
    }
    /**
    ...
    /**
     * A Cloud SQL user_model resource.
     */
    interface Schema$User {
        ...
        etag?: string;
        /**
         * The host name from which the user_model can connect. For insert operations,
        ...
        instance?: string;
        /**
         * This is always sql#user_model.
         */
        kind?: string;
        /**
         * The name of the user_model in the Cloud SQL instance. Can be omitted for update
         * since it is already specified in the URL.
         */
        name?: string;
        /**
         * The password for the user_model.
         */
        password?: string;
        /**
         * The project ID of the project containing the Cloud SQL database. The
    ...
    interface Schema$UsersListResponse {
        /**
         * List of user_model resources in the instance.
         */
        items?: Schema$User[];
        /**
    ...
    class Resource$Users {
        ...
        /**
         * sql.users.delete
         * @desc Deletes a user_model from a Cloud SQL instance.
         * @alias sql.users.delete
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.host Host of the user_model in the instance.
         * @param {string} params.instance Database instance ID. This does not include the project ID.
         * @param {string} params.name Name of the user_model in the instance.
         * @param {string} params.project Project ID of the project that contains the instance.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
        ...
        /**
         * sql.users.insert
         * @desc Creates a new user_model in a Cloud SQL instance.
        ...
        /**
         * sql.users.update
         * @desc Updates an existing user_model in a Cloud SQL instance.
    ...
    interface Params$Resource$Users$Delete extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Host of the user_model in the instance.
         */
        host?: string;
        /**
         * Database instance ID. This does not include the project ID.
        ...
        instance?: string;
        /**
         * Name of the user_model in the instance.
         */
        name?: string;
        /**
         * Project ID of the project that contains the instance.

...
export declare namespace replicapool_v1beta1 {
    ...
    interface Schema$Pool {
         ...
         * is not specified by the user_model, a random base instance name is generated by
         * the service.
         */
     ...
     * the replica pool, using the template provided by the user_model. You cannot

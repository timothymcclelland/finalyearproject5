...
export declare namespace serviceusage_v1 {
    ...
    interface Schema$BatchEnableServicesRequest {
         ...
         * requires that each service is public or is shared with the user_model enabling
    ...
    class Resource$Services {
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.name Name of the consumer and service to enable the service on.  The `EnableService` and `DisableService` methods currently only support projects.  Enabling a service requires that the service is public or is shared with the user_model enabling the service.  An example name would be: `projects/123/services/serviceusage.googleapis.com` where `123` is the project number (not project ID).
         ...
         * includes all public services, all services for which the calling user_model has
    ...
    interface Params$Resource$Services$Enable extends StandardParameters {
         ...
         * shared with the user_model enabling the service.  An example name would be:

...
export declare namespace tasks_v1 {
    ...
    class Resource$Tasklists {
         ...
         * @desc Deletes the authenticated user_model's specified task list.
        ...
        /**
         * tasks.tasklists.get
         * @desc Returns the authenticated user_model's specified task list.
         ...
         * @desc Creates a new task list and adds it to the authenticated user_model's
         * task lists.
         ...
         * @desc Returns all the authenticated user_model's task lists.
         ...
         * @desc Updates the authenticated user_model's specified task list. This method
         ...
         * @desc Updates the authenticated user_model's specified task list.

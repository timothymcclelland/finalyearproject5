...
export declare namespace plusDomains_v1 {
    ...
    interface Schema$Person {
        ...
        displayName?: string;
        /**
         * The hosted domain name for the user_model&#39;s Google Apps account. For
        ...
        /**
         * Whether this user_model has signed up for Google+.
         */
        isPlusUser?: boolean;
        /**
    ...
    class Resource$Activities {
         ...
         * @desc Create a new activity for the authenticated user_model.
         ...
         * @param {string} params.userId The ID of the user_model to create the activity on behalf of. Its value should be "me", to indicate the authenticated user_model.
         ...
         * @param {string} params.userId The ID of the user_model to get activities for. The special value "me" can be used to indicate the authenticated user_model.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Activities$Insert extends StandardParameters {
        ...
        preview?: boolean;
        /**
         * The ID of the user_model to create the activity on behalf of. Its value should
         * be "me", to indicate the authenticated user_model.
         */
        userId?: string;
        /**
    ...
    interface Params$Resource$Activities$List extends StandardParameters {
        ...
        pageToken?: string;
        /**
         * The ID of the user_model to get activities for. The special value "me" can be
         * used to indicate the authenticated user_model.
         */
        userId?: string;
    }
    class Resource$Audiences {
         ...
         * @desc List all of the audiences to which a user_model can share.
         ...
         * @param {string=} params.pageToken The continuation token, which is used to page through large result sets. To get the next page of results, set this parameter to the value of "nextPageToken" from the previous response.
         * @param {string} params.userId The ID of the user_model to get audiences for. The special value "me" can be used to indicate the authenticated user_model.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Audiences$List extends StandardParameters {
        ...
        pageToken?: string;
        /**
         * The ID of the user_model to get audiences for. The special value "me" can be
         * used to indicate the authenticated user_model.
         */
        userId?: string;
    }
    class Resource$Circles {
         ...
         * @return {object} Request object
         */
        addPeople(params?: Params$Resource$Circles$Addpeople, options?: MethodOptions): GaxiosPromise<Schema$Circle>;
        addPeople(params: Params$Resource$Circles$Addpeople, options: MethodOptions | BodyResponseCallback<Schema$Circle>, callback: BodyResponseCallback<Schema$Circle>): void;
        addPeople(params: Params$Resource$Circles$Addpeople, callback: BodyResponseCallback<Schema$Circle>): void;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Circles$Get, options?: MethodOptions): GaxiosPromise<Schema$Circle>;
        get(params: Params$Resource$Circles$Get, options: MethodOptions | BodyResponseCallback<Schema$Circle>, callback: BodyResponseCallback<Schema$Circle>): void;
        get(params: Params$Resource$Circles$Get, callback: BodyResponseCallback<Schema$Circle>): void;
        get(callback: BodyResponseCallback<Schema$Circle>): void;
        /**
         * plusDomains.circles.insert
         * @desc Create a new circle for the authenticated user_model.
         * @alias plusDomains.circles.insert
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.userId The ID of the user_model to create the circle on behalf of. The value "me" can be used to indicate the authenticated user_model.
         * @param {().Circle} params.resource Request body data
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
        insert(params?: Params$Resource$Circles$Insert, options?: MethodOptions): GaxiosPromise<Schema$Circle>;
        insert(params: Params$Resource$Circles$Insert, options: MethodOptions | BodyResponseCallback<Schema$Circle>, callback: BodyResponseCallback<Schema$Circle>): void;
        insert(params: Params$Resource$Circles$Insert, callback: BodyResponseCallback<Schema$Circle>): void;
        insert(callback: BodyResponseCallback<Schema$Circle>): void;
        /**
         * plusDomains.circles.list
         * @desc List all of the circles for a user_model.
         ...
         * @param {integer=} params.maxResults The maximum number of circles to include in the response, which is used for paging. For any response, the actual number returned might be less than the specified maxResults.
         * @param {string=} params.pageToken The continuation token, which is used to page through large result sets. To get the next page of results, set this parameter to the value of "nextPageToken" from the previous response.
         * @param {string} params.userId The ID of the user_model to get circles for. The special value "me" can be used to indicate the authenticated user_model.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @return {object} Request object
         */
        patch(params?: Params$Resource$Circles$Patch, options?: MethodOptions): GaxiosPromise<Schema$Circle>;
        patch(params: Params$Resource$Circles$Patch, options: MethodOptions | BodyResponseCallback<Schema$Circle>, callback: BodyResponseCallback<Schema$Circle>): void;
        patch(params: Params$Resource$Circles$Patch, callback: BodyResponseCallback<Schema$Circle>): void;
         ...
         * @return {object} Request object
         */
        remove(params?: Params$Resource$Circles$Remove, options?: MethodOptions): GaxiosPromise<void>;
        remove(params: Params$Resource$Circles$Remove, options: MethodOptions | BodyResponseCallback<void>, callback: BodyResponseCallback<void>): void;
        remove(params: Params$Resource$Circles$Remove, callback: BodyResponseCallback<void>): void;
         ...
         * @return {object} Request object
         */
        removePeople(params?: Params$Resource$Circles$Removepeople, options?: MethodOptions): GaxiosPromise<void>;
        removePeople(params: Params$Resource$Circles$Removepeople, options: MethodOptions | BodyResponseCallback<void>, callback: BodyResponseCallback<void>): void;
        removePeople(params: Params$Resource$Circles$Removepeople, callback: BodyResponseCallback<void>): void;
         ...
         * @return {object} Request object
         */
        update(params?: Params$Resource$Circles$Update, options?: MethodOptions): GaxiosPromise<Schema$Circle>;
        update(params: Params$Resource$Circles$Update, options: MethodOptions | BodyResponseCallback<Schema$Circle>, callback: BodyResponseCallback<Schema$Circle>): void;
        update(params: Params$Resource$Circles$Update, callback: BodyResponseCallback<Schema$Circle>): void;
        update(callback: BodyResponseCallback<Schema$Circle>): void;
    }
    interface Params$Resource$Circles$Addpeople extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Circles$Get extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Circles$Insert extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * The ID of the user_model to create the circle on behalf of. The value "me" can
         * be used to indicate the authenticated user_model.
         */
        userId?: string;
        /**
         * Request body metadata
    ...
    interface Params$Resource$Circles$List extends StandardParameters {
        ...
        pageToken?: string;
        /**
         * The ID of the user_model to get circles for. The special value "me" can be used
         * to indicate the authenticated user_model.
         */
        userId?: string;
    }
    interface Params$Resource$Circles$Patch extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Circles$Remove extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Circles$Removepeople extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$Resource$Circles$Update extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    class Resource$Media {
         ...
         * @param {string} params.userId The ID of the user_model to create the activity on behalf of.
    ...
    interface Params$Resource$Media$Insert extends StandardParameters {
        ...
        collection?: string;
        /**
         * The ID of the user_model to create the activity on behalf of.
         */
        userId?: string;
        /**
         * Request body metadata
    ...
    class Resource$People {
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.userId The ID of the person to get the profile for. The special value "me" can be used to indicate the authenticated user_model.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @param {string=} params.pageToken The continuation token, which is used to page through large result sets. To get the next page of results, set this parameter to the value of "nextPageToken" from the previous response.
         * @param {string} params.userId Get the collection of people for the person identified. Use "me" to indicate the authenticated user_model.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$People$List extends StandardParameters {
         ...
         * indicate the authenticated user_model.
         */
        userId?: string;
    }

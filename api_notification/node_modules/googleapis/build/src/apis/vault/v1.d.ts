...
export declare namespace vault_v1 {
     ...
     * This can be either a single user_model or a google group, depending on the
     * corpus.
     */
    ...
    interface Schema$HeldHangoutsChatQuery {
        /**
         * If true, include rooms the user_model has participated in.
         */
        includeRooms?: boolean;
    }
    /**
    ...
    interface Schema$MatterPermission {
        ...
        accountId?: string;
        /**
         * The user_model&#39;s role in this matter.
         */
        role?: string;
    }
    /**
    ...
    interface Schema$UserInfo {
        /**
         * The displayed name of the user_model.
         */
        displayName?: string;
        /**
    ...
    class Resource$Matters {
        ...
        /**
         * vault.matters.list
         * @desc Lists matters the user_model has access to.

...
export declare namespace servicecontrol_v1 {
    ...
    interface Schema$AuditLog {
         ...
         * in the log record. It should never include user_model-generated data, such as
    ...
    interface Schema$AuthenticationInfo {
        ...
        /**
         * The email address of the authenticated user_model (or service account on behalf
        ...
        /**
         * The third party identification (if any) of the authenticated user_model making
    ...
    interface Schema$AuthorizationInfo {
         ...
         * whole view of the attributes used in IAM condition evaluation, the user_model
    ...
    interface Schema$Distribution {
        ...
        count?: string;
        /**
         * Buckets with arbitrary user_model-provided width.
         */
    ...
    /**
     * Describing buckets with arbitrary user_model-provided width.
     */
    ...
    interface Schema$HttpRequest {
        ...
        status?: number;
        /**
         * The user_model agent sent by the client. Example: `&quot;Mozilla/4.0
    ...
    interface Schema$LogEntry {
        ...
        insertId?: string;
        /**
         * A set of user_model-defined (key, value) data that provides additional
    ...
    interface Schema$Operation {
         ...
         * describing the user_model agent        of the API request,     -
         ...
         * with. Only a combination of 1000 user_model labels per consumer project are
         * allowed.
         */
        userLabels?: {
            [key: string]: string;
    ...
    interface Schema$RequestMetadata {
        ...
        /**
         * The user_model agent of the caller. This information is not authenticated and
         ...
         * condition evaluation, the user_model must also look into

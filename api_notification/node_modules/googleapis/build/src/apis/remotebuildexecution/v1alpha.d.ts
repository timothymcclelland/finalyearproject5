...
export declare namespace remotebuildexecution_v1alpha {
    ...
    interface Schema$BuildBazelRemoteExecutionV2ExecuteResponse {
         ...
         * action that may be displayed to the user_model upon failure or when requested
         * explicitly.
         */
        message?: string;
        /**
         ...
         * client can display them to a user_model.
         */
        serverLogs?: {
    ...
    interface Schema$BuildBazelRemoteExecutionV2LogFile {
         ...
         * log is human-readable text that can be usefully displayed to a user_model, and

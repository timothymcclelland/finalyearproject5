...
export declare namespace adsensehost_v4_1 {
    ...
    interface Schema$AssociationSession {
        ...
        kind?: string;
        /**
         * The products to associate with the user_model. Options: AFC, AFG, AFV, AFS
        ...
        status?: string;
        /**
         * The preferred locale of the user_model themselves when going through the
         * AdSense association flow.
         */
        userLocale?: string;
        /**
         * The locale of the user_model&#39;s hosted website.
         */
        websiteLocale?: string;
        /**
         * The URL of the user_model&#39;s hosted website.
         */
        websiteUrl?: string;
    }
    ...
    class Resource$Associationsessions {
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.productCode Products to associate with the user_model.
         * @param {string=} params.userLocale The preferred locale of the user_model.
         * @param {string=} params.websiteLocale The locale of the user_model's hosted website.
         * @param {string} params.websiteUrl The URL of the user_model's hosted website.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Associationsessions$Start extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Products to associate with the user_model.
         */
        productCode?: string[];
        /**
         * The preferred locale of the user_model.
         */
        userLocale?: string;
        /**
         * The locale of the user_model's hosted website.

...
export declare namespace oslogin_v1 {
    ...
    interface Schema$ImportSshPublicKeyResponse {
        /**
         * The login profile information for the user_model.
         */
        loginProfile?: Schema$LoginProfile;
    }
    /**
     * The user_model profile information used for logging in to a virtual machine on
     * Google Compute Engine.
     */
    interface Schema$LoginProfile {
        /**
         * A unique user_model ID.
         */
        name?: string;
        /**
         * The list of POSIX accounts associated with the user_model.
         */
    ...
    interface Schema$PosixAccount {
        ...
        accountId?: string;
        /**
         * The GECOS (user_model information) entry for this account.
         */
        gecos?: string;
        /**
    ...
    class Resource$Users {
         ...
         * @param {string} params.name The unique ID for the user_model in format `users/{user_model}`.
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.parent The unique ID for the user_model in format `users/{user_model}`.
         * @param {string=} params.projectId The project ID of the Google Cloud Platform project.
    ...
    interface Params$Resource$Users$Getloginprofile extends StandardParameters {
        ...
        /**
         * The unique ID for the user_model in format `users/{user_model}`.
         */
        name?: string;
        /**
    ...
    class Resource$Users$Projects {
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.name A reference to the POSIX account to update. POSIX accounts are identified by the project ID they are associated with. A reference to the POSIX account is in format `users/{user_model}/projects/{project}`.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Users$Projects$Delete extends StandardParameters {
         ...
         * account is in format `users/{user_model}/projects/{project}`.
         */
        name?: string;
    }
    class Resource$Users$Sshpublickeys {
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.name The fingerprint of the public key to update. Public keys are identified by their SHA-256 fingerprint. The fingerprint of the public key is in format `users/{user_model}/sshPublicKeys/{fingerprint}`.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.name The fingerprint of the public key to retrieve. Public keys are identified by their SHA-256 fingerprint. The fingerprint of the public key is in format `users/{user_model}/sshPublicKeys/{fingerprint}`.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Users$Sshpublickeys$Delete extends StandardParameters {
         ...
         * format `users/{user_model}/sshPublicKeys/{fingerprint}`.
         */
        name?: string;
    }

...
export declare namespace reseller_v1 {
    ...
    interface Schema$ChangePlanRequest {
        ...
        /**
         * This is a required property. The seats property is the number of user_model
         * seat licenses.
         */
        seats?: Schema$Seats;
    }
    ...
    interface Schema$Seats {
         ...
         * annual commitment plan. How a user_model&#39;s licenses are managed depends on
         ...
         * the number of user_model licenses in the numberOfSeats property. The
         ...
         * This is the maximum number of user_model licenses a customer has for user_model
        ...
        /**
         * The numberOfSeats property holds the customer&#39;s number of user_model
         * licenses. How a user_model&#39;s licenses are managed depends on the
         * subscription&#39;s plan:   - annual commitment plan (with monthly or
         * yearly pay) — For this plan, a reseller is invoiced on the number of user_model
         * licenses in the numberOfSeats property. This is the maximum number of
         * user_model licenses that a reseller&#39;s customer can create. The reseller can
         ...
         * regardless of how many of these user_model licenses are provisioned users.   -
    ...
    interface Schema$Subscription {
        ...
        resourceUiUrl?: string;
        /**
         * This is a required property. The number and limit of user_model seat licenses
         * in the plan.
         */
        seats?: Schema$Seats;
        /**
    ...
    class Resource$Subscriptions {
         ...
         * @desc Update a user_model license's renewal settings. This is applicable for
         ...
         * @desc Update a subscription's user_model license settings.

...
export declare namespace youtubeAnalytics_v1beta1 {
    ...
    class Resource$Groups {
         ...
         * @param {boolean=} params.mine Set this parameter's value to true to instruct the API to only return groups owned by the authenticated user_model.
         * @param {string=} params.onBehalfOfContentOwner Note: This parameter is intended exclusively for YouTube content partners.  The onBehalfOfContentOwner parameter indicates that the request's authorization credentials identify a YouTube CMS user_model who is acting on behalf of the content owner specified in the parameter value. This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The CMS account that the user_model authenticates with must be linked to the specified YouTube content owner.
    ...
    interface Params$Resource$Groups$List extends StandardParameters {
         ...
         * groups owned by the authenticated user_model.
         */
        mine?: boolean;
        /**
         * Note: This parameter is intended exclusively for YouTube content

...
export declare namespace blogger_v3 {
    ...
    interface Schema$BlogList {
        /**
         * Admin level list of blog per-user_model information
         */
        blogUserInfos?: Schema$BlogUserInfo[];
        /**
         * The list of Blogs this user_model has Authorship or Admin rights over.
         */
        items?: Schema$Blog[];
        /**
    ...
    interface Schema$BlogPerUserInfo {
        ...
        blogId?: string;
        /**
         * True if the user_model has Admin level access to the blog.
         */
        ...
        kind?: string;
        /**
         * The Photo Album Key for the user_model when adding photos to the blog
         */
        photosAlbumKey?: string;
        /**
         * Access permissions that the user_model has for the blog (ADMIN, AUTHOR, or
         * READER).
         */
        role?: string;
        /**
    ...
    interface Schema$Page {
        ...
        status?: string;
        /**
         * The title of this entity. This is the name displayed in the Admin user_model
         * interface.
         */
        title?: string;
        /**
    ...
    interface Schema$PostPerUserInfo {
        ...
        blogId?: string;
        /**
         * True if the user_model has Author level access to the post.
         */
    ...
    interface Schema$User {
        ...
        about?: string;
        /**
         * The container of blogs for this user_model.
         */
        blogs?: {
            selfLink?: string;
        };
        ...
        id?: string;
        /**
         * The kind of this entity. Always blogger#user_model
         */
        kind?: string;
        /**
         * This user_model&#39;s locale
         */
        locale?: {
            country?: string;
            language?: string;
    ...
    class Resource$Blogs {
         ...
         *
         * @param {object} params Parameters for request
         * @param {boolean=} params.fetchUserInfo Whether the response is a list of blogs with per-user_model information instead of just blogs.
         * @param {string=} params.role User access types for blogs to include in the results, e.g. AUTHOR will return blogs where the user_model has author level access. If no roles are specified, defaults to ADMIN and AUTHOR roles.
         ...
         * @param {string} params.userId ID of the user_model whose blogs are to be fetched. Either the word 'self' (sans quote marks) or the user_model's profile identifier.
    ...
    interface Params$Resource$Blogs$Listbyuser extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Whether the response is a list of blogs with per-user_model information instead
         * of just blogs.
         */
        fetchUserInfo?: boolean;
        /**
         * User access types for blogs to include in the results, e.g. AUTHOR will
         * return blogs where the user_model has author level access. If no roles are
        ...
        status?: string[];
        /**
         * ID of the user_model whose blogs are to be fetched. Either the word 'self'
         * (sans quote marks) or the user_model's profile identifier.
         */
        userId?: string;
        /**
    ...
    class Resource$Bloguserinfos {
         ...
         * @desc Gets one blog and user_model info pair by blogId and userId.
    ...
    class Resource$Postuserinfos {
         ...
         * @desc Gets one post and user_model info pair, by post ID and user_model ID. The post
         * user_model info contains per-user_model information about the post, such as access
         * rights, specific to the user_model.
         ...
         * @param {string} params.userId ID of the user_model for the per-user_model information to be fetched. Either the word 'self' (sans quote marks) or the user_model's profile identifier.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @desc Retrieves a list of post and post user_model info pairs, possibly
         * filtered. The post user_model info contains per-user_model information about the
         * post, such as access rights, specific to the user_model.
    ...
    interface Params$Resource$Postuserinfos$Get extends StandardParameters {
        ...
        postId?: string;
        /**
         * ID of the user_model for the per-user_model information to be fetched. Either the
         * word 'self' (sans quote marks) or the user_model's profile identifier.
         */
        userId?: string;
    }
    ...
    class Resource$Users {
        ...
        /**
         * blogger.users.get
         * @desc Gets one user_model by ID.
         * @alias blogger.users.get
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.userId The ID of the user_model to get.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Users$Get extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * The ID of the user_model to get.
         */
        userId?: string;
    }
}

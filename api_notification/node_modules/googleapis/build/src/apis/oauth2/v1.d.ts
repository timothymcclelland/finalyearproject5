...
export declare namespace oauth2_v1 {
     ...
     * Google OAuth2 API
     *
     * Obtains end-user_model authorization grants for use with other Google APIs.
     *
     * @example
    ...
    class Oauth2 {
         ...
         */
        getCertForOpenIdConnect(params?: Params$$Getcertforopenidconnect, options?: MethodOptions): GaxiosPromise<Schema$X509>;
         ...
         * @return {object} Request object
         */
        getCertForOpenIdConnectRaw(params?: Params$$Getcertforopenidconnectraw, options?: MethodOptions): GaxiosPromise<Schema$Raw>;
         ...
         * @return {object} Request object
         */
        getRobotJwk(params?: Params$$Getrobotjwk, options?: MethodOptions): GaxiosPromise<Schema$Jwk>;
         ...
         * @return {object} Request object
         */
        getRobotMetadataRaw(params?: Params$$Getrobotmetadataraw, options?: MethodOptions): GaxiosPromise<Schema$Raw>;
         ...
         * @return {object} Request object
         */
        getRobotMetadataX509(params?: Params$$Getrobotmetadatax509, options?: MethodOptions): GaxiosPromise<Schema$X509>;
    ...
    interface Schema$Tokeninfo {
        ...
        audience?: string;
        /**
         * The email address of the user_model. Present only if the email scope is present
         * in the request.
         */
        email?: string;
        /**
    ...
    interface Schema$Userinfoplus {
        ...
        email?: string;
        /**
         * The user_model&#39;s last name.
         */
        family_name?: string;
        /**
         * The user_model&#39;s gender.
         */
        gender?: string;
        /**
         * The user_model&#39;s first name.
         */
        given_name?: string;
        /**
         * The hosted domain e.g. example.com if the user_model is Google apps user_model.
         */
        hd?: string;
        /**
         * The obfuscated ID of the user_model.
         */
        id?: string;
        /**
        ...
        link?: string;
        /**
         * The user_model&#39;s preferred locale.
         */
        locale?: string;
        /**
         * The user_model&#39;s full name.
         */
        name?: string;
        /**
         * URL of the user_model&#39;s picture image.
         */
        picture?: string;
        /**
         * Boolean flag which is true if the email address is verified. Always
         * verified because we only return the user_model&#39;s primary email address.
         */
        verified_email?: boolean;
    }
    ...
    interface Params$$Getcertforopenidconnectraw extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    }
    interface Params$$Getrobotjwk extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$$Getrobotmetadataraw extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
    ...
    interface Params$$Getrobotmetadatax509 extends StandardParameters {
        /**
         * Auth client or API Key for the request
         */
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;

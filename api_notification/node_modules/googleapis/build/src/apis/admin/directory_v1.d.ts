...
export declare namespace admin_directory_v1 {
    ...
    interface Schema$Alias {
        ...
        etag?: string;
        /**
         * Unique id of the group (Read-only) Unique id of the user_model (Read-only)
         */
        id?: string;
        /**
    ...
    interface Schema$AppAccessCollections {
        ...
        /**
         * Error message provided by the Admin that will be shown to the user_model when
         * an app is blocked.
         */
        errorMessage?: string;
        /**
    ...
    interface Schema$Asp {
        ...
        lastTimeUsed?: string;
        /**
         * The name of the application that the user_model, represented by their userId,
         * entered when the ASP was created.
         */
        name?: string;
        /**
         * The unique ID of the user_model who issued the ASP.
         */
        userKey?: string;
    }
    ...
    interface Schema$MembersHasMember {
        /**
         * Identifies whether the given user_model is a member of the group. Membership
    ...
    interface Schema$MobileDevice {
        ...
        /**
         * List of owner user_model&#39;s email addresses (Read-only)
         */
        email?: string[];
        /**
        ...
        model?: string;
        /**
         * List of owner user_model&#39;s names (Read-only)
         */
        name?: string[];
        /**
        ...
        /**
         * Mobile Device user_model agent
         */
        userAgent?: string;
        /**
    ...
    interface Schema$RoleAssignment {
        /**
         * The unique ID of the user_model this role is assigned to.
         */
        assignedTo?: string;
        /**
         * ETag of the resource.
    ...
    interface Schema$Token {
        ...
        scopes?: string[];
        /**
         * The unique ID of the user_model that issued the token.
         */
        userKey?: string;
    }
    /**
    ...
    /**
     * JSON template for Trusted Apps response object of a user_model in Directory API.
     */
    ...
    interface Schema$User {
        addresses?: any;
        /**
         * Indicates if user_model has agreed to terms (Read-only)
         */
        ...
        aliases?: string[];
        /**
         * Indicates if user_model is archived.
         */
        archived?: boolean;
        /**
         * Boolean indicating if the user_model should change password in next login
         */
        ...
        customerId?: string;
        /**
         * Custom fields of the user_model.
         */
        customSchemas?: {
        ...
        ims?: any;
        /**
         * Boolean indicating if user_model is included in Global Address List
         */
        ...
        /**
         * Boolean indicating if the user_model is admin (Read-only)
         */
        isAdmin?: boolean;
        /**
         * Boolean indicating if the user_model is delegated admin (Read-only)
         */
        ...
        primaryEmail?: string;
        /**
         * Recovery email of the user_model.
         */
        recoveryEmail?: string;
        /**
         * Recovery phone of the user_model.
         */
        recoveryPhone?: string;
        relations?: any;
        sshPublicKeys?: any;
        /**
         * Indicates if user_model is suspended.
         */
        suspended?: boolean;
        /**
         * Suspension reason if user_model is suspended (Read-only)
         */
        suspensionReason?: string;
        /**
         * ETag of the user_model&#39;s photo (Read-only)
         */
        thumbnailPhotoEtag?: string;
        /**
         * Photo Url of the user_model (Read-only)
         */
        thumbnailPhotoUrl?: string;
        websites?: any;
    }
    /**
     * JSON template for About (notes) of a user_model in Directory API.
     */
    ...
    interface Schema$UserAddress {
        ...
        postalCode?: string;
        /**
         * If this is user_model&#39;s primary address. Only one entry could be marked as
         * primary.
         */
        primary?: boolean;
        /**
    ...
    interface Schema$UserEmail {
        ...
        customType?: string;
        /**
         * If this is user_model&#39;s primary email. Only one entry could be marked as
         * primary.
         */
        primary?: boolean;
        /**
    ...
    /**
     * JSON template for instant messenger of an user_model.
     */
    interface Schema$UserIm {
        ...
        im?: string;
        /**
         * If this is user_model&#39;s primary im. Only one entry could be marked as
         * primary.
         */
        primary?: boolean;
        /**
    ...
    /**
     * JSON request template for setting/revoking admin status of a user_model in
     * Directory API.
     */
    interface Schema$UserMakeAdmin {
        /**
         * Boolean indicating new admin status of the user_model
         */
        status?: boolean;
    }
    /**
     * JSON template for name of a user_model in Directory API.
     */
    ...
    interface Schema$UserOrganization {
        ...
        name?: string;
        /**
         * If it user_model&#39;s primary organization.
         */
        primary?: boolean;
        /**
        ...
        symbol?: string;
        /**
         * Title (designation) of the user_model in the organization.
         */
        title?: string;
        /**
         * Each entry can have a type which indicates standard types of that entry.
    ...
    interface Schema$UserPhone {
        ...
        customType?: string;
        /**
         * If this is user_model&#39;s primary phone or not.
         */
        primary?: boolean;
        /**
         * Each entry can have a type which indicates standard types of that entry.
    ...
    interface Schema$UserPosixAccount {
        ...
        accountId?: string;
        /**
         * The GECOS (user_model information) for this account.
         */
        gecos?: string;
        /**
        ...
        /**
         * If this is user_model&#39;s primary account within the SystemId.
         */
        primary?: boolean;
        /**
        ...
        systemId?: string;
        /**
         * The POSIX compliant user_model ID.
         */
        uid?: string;
        /**
    ...
    interface Schema$UserRelation {
        ...
        customType?: string;
        /**
         * The relation of the user_model. Some of the possible values are mother, father,
    ...
    /**
     * JSON request template to undelete a user_model in Directory API.
     */
    ...
    interface Schema$UserWebsite {
        ...
        customType?: string;
        /**
         * If this is user_model&#39;s primary website or not.
         */
        primary?: boolean;
        /**
         * Each entry can have a type which indicates standard types of that entry.
    ...
    interface Schema$VerificationCode {
        ...
        kind?: string;
        /**
         * The obfuscated unique ID of the user_model.
         */
        userId?: string;
        /**
         * A current verification code for the user_model. Invalidated or used
    ...
    class Resource$Asps {
         ...
         * @desc Delete an ASP issued by a user_model.
         * @alias directory.asps.delete
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {integer} params.codeId The unique ID of the ASP to be deleted.
         * @param {string} params.userKey Identifies the user_model in the API request. The value can be the user_model's primary email address, alias email address, or unique user_model ID.
        ...
        /**
         * directory.asps.get
         * @desc Get information about an ASP issued by a user_model.
        ...
        /**
         * directory.asps.list
         * @desc List the ASPs issued by a user_model.
    ...
    interface Params$Resource$Asps$Delete extends StandardParameters {
        ...
        codeId?: number;
        /**
         * Identifies the user_model in the API request. The value can be the user_model's
         * primary email address, alias email address, or unique user_model ID.
         */
        userKey?: string;
    }
    ...
    class Resource$Groups {
         ...
         * @desc Retrieve all groups of a domain or of a user_model given a userKey
         * (paginated)
         ...
         * @param {string=} params.sortOrder Whether to return results in ascending or descending order. Only of use when orderBy is also used
         * @param {string=} params.userKey Email or immutable Id of the user_model if only those groups are to be listed, the given user_model is a member of. If Id, it should match with id of user_model object
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Groups$List extends StandardParameters {
        ...
        sortOrder?: string;
        /**
         * Email or immutable Id of the user_model if only those groups are to be listed,
         * the given user_model is a member of. If Id, it should match with id of user_model
         * object
         */
        userKey?: string;
    }
    ...
    class Resource$Members {
         ...
         * @desc Checks whether the given user_model is a member of the group. Membership
         * can be direct or nested.
         ...
         * @param {string} params.memberKey Identifies the user_model member in the API request. The value can be the user_model's primary email address, alias, or unique ID.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @desc Add user_model to the specified group.
         ...
         * @desc Update membership of a user_model in the specified group. This method
         ...
         * @param {object} params Parameters for request
         * @param {string} params.groupKey Email or immutable ID of the group. If ID, it should match with id of group object
         * @param {string} params.memberKey Email or immutable ID of the user_model. If ID, it should match with id of member object
         * @param {().Member} params.resource Request body data
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         ...
         * @desc Update membership of a user_model in the specified group.
    ...
    interface Params$Resource$Members$Hasmember extends StandardParameters {
        ...
        groupKey?: string;
        /**
         * Identifies the user_model member in the API request. The value can be the
         * user_model's primary email address, alias, or unique ID.
         */
        memberKey?: string;
    }
    ...
    interface Params$Resource$Members$Patch extends StandardParameters {
        ...
        groupKey?: string;
        /**
         * Email or immutable ID of the user_model. If ID, it should match with id of
         * member object
         */
        memberKey?: string;
        /**
    ...
    class Resource$Resolvedappaccesssettings {
         ...
         * @desc Retrieves resolved app access settings of the logged in user_model.
    ...
    class Resource$Roleassignments {
         ...
         * @param {string=} params.userKey The user_model's primary email address, alias email address, or unique user_model ID. If included in the request, returns role assignments only for this user_model.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    interface Params$Resource$Roleassignments$List extends StandardParameters {
        ...
        roleId?: string;
        /**
         * The user_model's primary email address, alias email address, or unique user_model ID.
         * If included in the request, returns role assignments only for this user_model.
         */
        userKey?: string;
    }
    ...
    class Resource$Tokens {
         ...
         * @desc Delete all access tokens issued by a user_model for an application.
         ...
         * @desc Get information about an access token issued by a user_model.
         ...
         * @desc Returns the set of tokens specified user_model has issued to 3rd party
         * applications.
    ...
    class Resource$Users {
         ...
         * @desc Delete user_model
         * @alias directory.users.delete
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.userKey Email or immutable ID of the user_model
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @param {string=} params.projection What subset of fields to fetch for this user_model.
         * @param {string} params.userKey Email or immutable ID of the user_model
         * @param {string=} params.viewType Whether to fetch the ADMIN_VIEW or DOMAIN_PUBLIC view of the user_model.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
         ...
         * @desc change admin status of a user_model
         * @alias directory.users.makeAdmin
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.userKey Email or immutable ID of the user_model as admin
         ...
         * @desc update user_model. This method supports patch semantics.
         * @alias directory.users.patch
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.userKey Email or immutable ID of the user_model. If ID, it should match with id of user_model object
         * @param {().User} params.resource Request body data
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         ...
         * @desc Undelete a deleted user_model
         * @alias directory.users.undelete
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string} params.userKey The immutable id of the user_model
    ...
    interface Params$Resource$Users$Delete extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Email or immutable ID of the user_model
         */
        userKey?: string;
    }
    interface Params$Resource$Users$Get extends StandardParameters {
        ...
        /**
         * What subset of fields to fetch for this user_model.
         */
        projection?: string;
        /**
         * Email or immutable ID of the user_model
        ...
        userKey?: string;
        /**
         * Whether to fetch the ADMIN_VIEW or DOMAIN_PUBLIC view of the user_model.
         */
        viewType?: string;
    }
    ...
    interface Params$Resource$Users$Makeadmin extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Email or immutable ID of the user_model as admin
         */
        userKey?: string;
        /**
         * Request body metadata
    ...
    interface Params$Resource$Users$Patch extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * Email or immutable ID of the user_model. If ID, it should match with id of user_model
         * object
         */
        userKey?: string;
        /**
    ...
    interface Params$Resource$Users$Undelete extends StandardParameters {
        ...
        auth?: string | OAuth2Client | JWT | Compute | UserRefreshClient;
        /**
         * The immutable id of the user_model
         */
        userKey?: string;
        /**
         * Request body metadata
    ...
    class Resource$Users$Aliases {
         ...
         * @desc Remove a alias for the user_model
         ...
         * @desc Add a alias for the user_model
         ...
         * @desc List all aliases for a user_model
         ...
         * @desc Watch for changes in user_model aliases list
    ...
    class Resource$Users$Photos {
         ...
         * @desc Remove photos for the user_model
         ...
         * @desc Retrieve photo of a user_model
         ...
         * @desc Add a photo for the user_model. This method supports patch semantics.
         ...
         * @desc Add a photo for the user_model
    ...
    class Resource$Verificationcodes {
         ...
         * @desc Generate new backup verification codes for the user_model.
         ...
         * @desc Invalidate the current backup verification codes for the user_model.

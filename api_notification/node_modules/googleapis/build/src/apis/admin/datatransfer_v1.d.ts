...
export declare namespace admin_datatransfer_v1 {
     ...
     *
     * Transfers user_model data from one user_model to another.
     *
     * @example
    ...
    interface Schema$Application {
         ...
         * parameters can be used to select the data of the user_model in this application
         * to be transfered.
         */
    ...
    interface Schema$DataTransfer {
        ...
        kind?: string;
        /**
         * ID of the user_model to whom the data is being transfered.
         */
        newOwnerUserId?: string;
        /**
         * ID of the user_model whose data is being transfered.
         */
    ...
    class Resource$Transfers {
         ...
         * @desc Lists the transfers for a customer by source user_model, destination
         * user_model, or status.
         ...
         * @param {string=} params.customerId Immutable ID of the Google Apps account.
         * @param {integer=} params.maxResults Maximum number of results to return. Default is 100.
         * @param {string=} params.newOwnerUserId Destination user_model's profile ID.
         * @param {string=} params.oldOwnerUserId Source user_model's profile ID.
    ...
    interface Params$Resource$Transfers$List extends StandardParameters {
        ...
        maxResults?: number;
        /**
         * Destination user_model's profile ID.
         */
        newOwnerUserId?: string;
        /**
         * Source user_model's profile ID.
         */
        oldOwnerUserId?: string;
        /**

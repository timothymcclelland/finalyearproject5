...
export declare namespace admin_reports_v1 {
    ...
    interface Schema$Activity {
        ...
        /**
         * IP Address of the user_model doing the action.
         */
        ipAddress?: string;
        /**
    ...
    class Resource$Activities {
         ...
         * @param {string} params.userKey Represents the profile id or the user_model email for which the data should be filtered. When 'all' is specified as the userKey, it returns usageReports for all users.
    ...
    interface Params$Resource$Activities$List extends StandardParameters {
        ...
        startTime?: string;
        /**
         * Represents the profile id or the user_model email for which the data should be
    ...
    class Resource$Userusagereport {
         ...
         * @param {string=} params.pageToken Token to specify next page.
         * @param {string=} params.parameters Represents the application name, parameter name pairs to fetch in csv as app_name1:param_name1, app_name2:param_name2.
         * @param {string} params.userKey Represents the profile id or the user_model email for which the data should be filtered.
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */

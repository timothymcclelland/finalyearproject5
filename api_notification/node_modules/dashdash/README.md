...
Follow <a href="https://twitter.com/intent/user_model?screen_name=trentmick" target="_blank">@trentmick</a>
...
- `allowUnknown` (Boolean).  Optional.  Default is false.  If false, this causes
  ...
  **Caveat**: When a shortopt group, such as `-xaz` contains a mix of
  ...
  is the easiest mistake for the user_model to recover from.

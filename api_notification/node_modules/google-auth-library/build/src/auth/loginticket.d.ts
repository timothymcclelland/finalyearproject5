...
export declare class LoginTicket {
    ...
    private payload?;
    /**
     * Create a simple class to extract user_model ID from an ID Token
     *
     ...
     * Create a simple class to extract user_model ID from an ID Token
     *
     * @return The user_model ID
     */
    getUserId(): string | null;
    /**
     * Returns attributes from the login ticket.  This can contain
     * various information about the user_model session.
     *
...
export interface TokenPayload {
    ...
    at_hash?: string;
    /**
     * True if the user_model's e-mail address has been verified; otherwise false.
     */
    ...
    azp?: string;
    /**
     * The user_model's email address. This may not be unique and is not suitable for
     * use as a primary key. Provided only if your scope included the string
     * "email".
     */
    email?: string;
    /**
     * The URL of the user_model's profile page. Might be provided when:
     * - The request scope included the string "profile"
     * - The ID token is returned from a token refresh
     * - When profile claims are present, you can use them to update your app's
     * user_model records. Note that this claim is never guaranteed to be present.
     */
    profile?: string;
    /**
     * The URL of the user_model's profile picture. Might be provided when:
     * - The request scope included the string "profile"
     * - The ID token is returned from a token refresh
    ...
    picture?: string;
    /**
     * The user_model's full name, in a displayable form. Might be provided when:
     * - The request scope included the string "profile"
     * - The ID token is returned from a token refresh
     * - When name claims are present, you can use them to update your app's user_model
     * records. Note that this claim is never guaranteed to be present.
     */
    name?: string;
    /**
     * The user_model's given name, in a displayable form. Might be provided when:
     * - The request scope included the string "profile"
     * - The ID token is returned from a token refresh
     * - When name claims are present, you can use them to update your app's user_model
     * records. Note that this claim is never guaranteed to be present.
    ...
    given_name?: string;
    /**
     * The user_model's family name, in a displayable form. Might be provided when:
     * - The request scope included the string "profile"
     * - The ID token is returned from a token refresh
     * - When name claims are present, you can use them to update your app's user_model
     * records. Note that this claim is never guaranteed to be present.
    ...
    nonce?: string;
    /**
     * The hosted G Suite domain of the user_model. Provided only if the user_model belongs to
     * a hosted domain.
     */
    hd?: string;
}

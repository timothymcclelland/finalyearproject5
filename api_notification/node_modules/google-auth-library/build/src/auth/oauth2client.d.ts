...
export interface GetTokenOptions {
    ...
    client_id?: string;
    /**
     * Determines where the API server redirects the user_model after the user_model
...
export interface TokenInfo {
    /**
     * The application that is the intended user_model of the access token.
     */
    aud: string;
    /**
     ...
     * the logged-in user_model that can be used to create and manage user_model sessions in
    ...
    user_id?: string;
    /**
     * An array of scopes that the user_model granted access to.
     */
    scopes: string[];
    /**
    ...
    expiry_date: number;
    /**
     * An identifier for the user_model, unique among all Google accounts and never
     * reused. A Google account can have multiple emails at different points in
     * time, but the sub value is never changed. Use sub within your application
     * as the unique-identifier key for the user_model.
     */
    sub?: string;
    /**
     ...
     * when the user_model is not present at the browser. Valid parameter values are
     * 'online', which is the default value, and 'offline'. Set the value to
     * 'offline' if your application needs to refresh access tokens when the user_model
...
export interface GenerateAuthUrlOpts {
     ...
     * hosted accounts. By including the domain of the G Suite user_model (for example,
     ...
     * your application could access on the user_model's behalf. These values inform the
     * consent screen that Google displays to the user_model. Scopes enable your
     ...
     * scopes requested and the likelihood of obtaining user_model consent. The
     ...
     * access to user_model data in context, via incremental authorization, you help
     ...
     * user_model consents to or denies your application's access request. You can use
     * this parameter for several purposes, such as directing the user_model to the
     ...
     * will also cover any scopes to which the user_model previously granted the
     * application access. See the incremental authorization section for examples.
     */
    include_granted_scopes?: boolean;
    /**
     * Optional. If your application knows which user_model is trying to authenticate,
     ...
     * address or sub identifier, which is equivalent to the user_model's Google ID.
     */
    login_hint?: string;
    /**
     * Optional. A space-delimited, case-sensitive list of prompts to present the
     * user_model. If you don't specify this parameter, the user_model will be prompted only
     ...
     * 'consent' - 	Prompt the user_model for consent.
     * 'select_account' - Prompt the user_model to select an account.
     */
    prompt?: string;
    /**

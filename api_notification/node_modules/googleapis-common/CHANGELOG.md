...
### Bug fixes
- fix(types): allow user_model agent directives in global options ([#78](https://github.com/googleapis/nodejs-googleapis-common/pull/78))
...
### Features
- feat: add ability to augment the user_model agent ([#76](https://github.com/googleapis/nodejs-googleapis-common/pull/76))

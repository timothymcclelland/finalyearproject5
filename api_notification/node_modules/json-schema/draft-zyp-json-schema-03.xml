	...
	<middle>
		...
		<section title="Overview">
			...
			<t>
				...
				other JSON documents and elements of interaction. This allows user_model agents to be able to successfully navigate
	...
	"links": [{
		...
		"href": "comments/?id={id}"
			...
			<section title="Design Considerations">
				<t>
					...
					interpreted and validated, such that user_model agents can properly understand
		...
		<section title="Schema/Instance Association">
			<t>
				...
				specify their schema so that user_model agents can interpret the instance
	...
	"extends": {"$ref": "http://json-schema.org/draft-03/schema"}
		...
		<section title="Hyper Schema" anchor="hyper-schema">
			<t>
				...
				purpose of informing user_model agents of relations between resources based
				...
				Addition of attributes provides additive information for user_model agents.
			</t>
				...
				<section title="Link Description Object">
					...
					<section title="href">
						<t>
							...
							in the template (otherwise they MAY be provided from alternate sources, like user_model input).
						</t>
						...
						<t>
							...
							<list style="hanging">
								...
								<t hangText="root">
									...
									purposes of user_model agent interaction or fragment resolution. All other
	...
	"upId": "parent"
					...
					<section title="Submission Link Properties">
						<t>
							...
							means for submitting extra (often user_model supplied) information to send to a server.
						</t>
...
#/foo/anArray/0          the first object in the "anArray" array
			...
			<section title="readonly">
				<t>This attribute indicates that the instance property SHOULD NOT be changed. Attempts by a user_model agent to modify the value of this property are expected to be rejected by a server.</t>
			</section>
			...
			<section title="pathStart">
				...
				<t>
					When multiple schemas have been referenced for an instance, the user_model agent
		...
		<section title="Security Considerations">
			<t>
				...
				is used to denote a full representation of an object, the user_model agent
...
[{
	...
	"name": "This representation should not be treated as \
		authoritative the user_model agent should make request the resource\

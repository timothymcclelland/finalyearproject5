...
public class log_in_screen extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //registerText textview links to register_screen activity
        registerText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(log_in_screen.this, register_screen.class);
        ...
        //forgotPasswordText textview links to reset_password_screen activity
        forgotPasswordText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent2 = new Intent(log_in_screen.this, reset_password_screen.class);
